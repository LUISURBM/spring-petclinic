...
import org.profamilia.hc.view.backing.comun.ColposcopiaBean;
...
public class MenuProcedimientoColposcopiaBean extends BaseBean {

    private DatosBasicosUsuarioBean datosBasicosUsuario;

    private MotivoBean motivoConsulta;

    private AntecedentesColposcopiaBean antecedentes;
    ...
    private ColposcopiaBean colposcopia; 
    ...
    private boolean renderRegistroColposcopia; 
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_COLPOSCOPIA);
        datosBasicosUsuario.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_COLPOSCOPIA);
        cuestionarioCovid.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        motivoConsulta.setFinalidadSelect(IConstantes.FINALIDAD_PROCEDIMIENTO_DIAGNOSTICO);
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_COLPOSCOPIA);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_COLPOSCOPIA);
        }

        motivoConsulta.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        // ANTECEDENTES GENERALES
            antecedentes = 
                    (AntecedentesColposcopiaBean)FacesUtils.getManagedBean("antecedentesColposcopiaBean");
            antecedentes.setTipoServicio(TIPO_CONSULTA);
            antecedentes.setTipoHistoria(HISTORIA_PROCEDIMIENTO_COLPOSCOPIA);
            antecedentes.setNumeroConsulta(numeroConsulta);
            antecedentes.setMenuBean("menuProcedimientoColposcopiaBean");
            antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_COLPOSCOPIA);
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_COLPOSCOPIA);
        encuestaViolenciaUsuario.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuProcedimientoColposcopiaBean");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_REGISTRAR_COLPOSCOPIA);
           registrarEscalaValoracionCaidasBean.init();
           renderRegistroColposcopia = registrarEscalaValoracionCaidasBean.esValido();  
        
        
        colposcopia = (ColposcopiaBean)FacesUtils.getManagedBean("colposcopiaBean");
        colposcopia.setTipoServicio(TIPO_CONSULTA);
        colposcopia.setNumeroConsulta(numeroConsulta);
        colposcopia.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_COLPOSCOPIA);
        colposcopia.setMenuBean("menuProcedimientoColposcopiaBean");
        colposcopia.inicializarColposcopia();
        renderImpresionDiagnostica = colposcopia.esValido();
                ...
                impresionDiagnosticaUsuarioBean.setRenderColposcopia(true);
                ...
                impresionDiagnosticaUsuarioBean.setCodigoRelacionado3("");
                impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_COLPOSCOPIA);
                impresionDiagnosticaUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
                impresionDiagnosticaUsuarioBean.setDesHabilitarDiagnosticoPrincipal(false);
        ...
        recomedacionUsuarioBean.setTipoHistoria(IConstantes.HISTORIA_PROCEDIMIENTO_COLPOSCOPIA);
        recomedacionUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        anatomiaPatologicaUsuarioBean.setAntecedente(null);
        anatomiaPatologicaUsuarioBean.setConsecutivo(1);
        anatomiaPatologicaUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        // CONDUCTA - FORMULA MEDICA
              ...
              vademecumUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        examImagenUsuarioBean.setAntecedente(null);
        examImagenUsuarioBean.setCie10Principal(cie10Principal);
        examImagenUsuarioBean.setConsecutivo(1);
        examImagenUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuProcedimientoColposcopiaBean");
    ...
    public String irPausarConsultaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irDatosColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irMotivoColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_COLPOSCOPIA;
    }
    
    public String irCuestionarioCovidColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_COLPOSCOPIA;
        }
     ...
     * @return
     */
    public String irAntecedentesGeneralesColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irAntecedentesColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irEncuestaViolenciaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irAnatPatologicaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irControlSinCostoColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irFormulaMedicaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_COLPOSCOPIA;
    }
    
    /**
     * @return
     */
    public String irVademecumMedicoColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VADEMCUM_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irRemHospitalizacionColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irIncapacidadColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irInterConsultaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irOrdenCirugiaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irReferenciaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irReservaSangreColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irRecomedacionColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irCertMedicoColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irCertAsistenciaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irExamElectrofisiologicoColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irExamImagenColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irExamLaboratorioColposcopia() {
        inicializarUsuario();

        return BeanNavegacion.RUTA_IR_LABORATORIO_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irCerrarConsultaColposcopia() {
        if (cerrarConsultaUsuarioBean != null) {
            cerrarConsultaUsuarioBean.inicalizarCerrarConsultaBean();
        }
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irResumenHistoriaEspecificaColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_COLPOSCOPIA;
    }

    /**
     * @return
     */
    public String irRegistroColposcopia(){
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REGISTRAR_COLPOSCOPIA; 
    }
         ...
         * @return
         */
        public String irImpDiagnosticaColposcopia() {

            inicializarUsuario();
            return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_COLPOSCOPIA;
        }
     ...
     * @return
     */
    public String irAntecedentesGinecologicosColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irResumenHistoriaColposcopia() {

        inicializarUsuario();

        CerrarConsultaUsuarioBean cerrarConsultaColposcopia = 
            (CerrarConsultaUsuarioBean)FacesUtils.getManagedBean("cerrarConsultaUsuarioBean");
        cerrarConsultaColposcopia.inicalizarCerrarConsultaBean();
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_COLPOSCOPIA;
    }
    ...
    /**
     * @param renderRegistroColposcopia
     */
    public void setRenderRegistroColposcopia(boolean renderRegistroColposcopia) {
        this.renderRegistroColposcopia = renderRegistroColposcopia;
    }

    /**
     * @return
     */
    public boolean isRenderRegistroColposcopia() {
        return renderRegistroColposcopia;
    }
	...
	public String irServiciosAdmisionColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_COLPOSCOPIA;
    }
     ...
     * @return
     */
    public String irEscalaValoracionCaidasColposcopia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_COLPOSCOPIA;
    }
}
