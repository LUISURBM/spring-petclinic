...
import org.profamilia.hc.view.backing.comun.AntecedentePrenatalUsuarioBean;
...
public class MenuHistoriaPrenatalBean extends BaseBean {

    private DatosBasicosUsuarioBean datosBasicosUsuario;

    private MotivoBean motivoConsulta;

    private AntecedentePrenatalUsuarioBean antecedentesPrenatal;

    private AntecedentesGinecologicosUsuarioBean antecedentesGinecologicos;
    
    private AntecedentesGinecoObstetricosBean antecedentesObstetricos; 
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_PRENATAL);
        datosBasicosUsuario.setMenuBean("menuHistoriaPrenatal");
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_PRENATAL);
        cuestionarioCovid.setMenuBean("menuHistoriaPrenatal");
        ...
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_ESPECIFICOS_PRENATAL);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_ESPECIFICOS_PRENATAL);
        }

        motivoConsulta.setMenuBean("menuHistoriaPrenatal");
        ...
        antecedentesPrenatal = 
                (AntecedentePrenatalUsuarioBean)FacesUtils.getManagedBean("antecedentePrenatalUsuarioBean");
        antecedentesPrenatal.setTipoServicio(TIPO_CONSULTA);
        antecedentesPrenatal.setConsulta(datosBasicosUsuario.getConsulta());
        antecedentesPrenatal.setUsuario(datosBasicosUsuario.getUsuario());
        antecedentesPrenatal.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_PRENATAL);
        antecedentesPrenatal.setMenuBean("menuHistoriaPrenatal");
        antecedentesPrenatal.inicializarAntecedentes();
        renderAntecedentesGinecologicos = antecedentesPrenatal.esValido();
        ...
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_OBSTETRICOS_PRENATAL);
        antecedentesGinecologicos.setMenuBean("menuHistoriaPrenatal");
        ...
        if(antecedenteObject != null){
            fechaUltimaRegla = antecedenteObject.getHagdfur();
        }
        ...
        antecedentesObstetricos = 
                (AntecedentesGinecoObstetricosBean)FacesUtils.getManagedBean("antecedentesGinecoObstetricosBean");
        ...
        antecedentesObstetricos.setNextAction(BeanNavegacion.RUTA_IR_GESTACION_PRENATAL);
        antecedentesObstetricos.setMenuBean("menuHistoriaPrenatal");
        antecedentesObstetricos.inicializarAntecedentesGinecoObstetricos();
        renderGestacionPrenatal = antecedentesObstetricos.esValido();
        ...
        gestacionBean.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_PRENATAL);
        gestacionBean.setMenuBean("menuHistoriaPrenatal");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_PRENATAL);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaPrenatal");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuHistoriaPrenatal");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_PRENATAL);
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_PRENATAL);
        examenFisicoUsuario.setMenuBean("menuHistoriaPrenatal");
        ...
        if (examenFisicoUsuario != null && 
            ...
            if(examenFisicoUsuario.getControl().getHcpthallaextre()!= null){
                hallazgos =  hallazgos + " ORL: " + examenFisicoUsuario.getControl().getHcpthallaextre() + "\n.";    
            }
            
            if(examenFisicoUsuario.getControl().getHcpthallaorl()!= null){
                hallazgos = hallazgos + "Cardio Pulmonar: " + examenFisicoUsuario.getControl().getHcpthallaorl() + "\n.";    
            }
            
            if(examenFisicoUsuario.getControl().getHcpthallcarpul()!= null){
                hallazgos = hallazgos + "Extremidades: " + examenFisicoUsuario.getControl().getHcpthallcarpul()+ "\n.";      
            }
            
            if(examenFisicoUsuario.getControl().getHcpthallsisner()!= null){
                hallazgos = hallazgos + "Sistema nervioso central" +examenFisicoUsuario.getControl().getHcpthallsisner()+ "\n.";    
            }
        ...
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_TAMIZAJE_PRENATAL);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        tamizajeBean.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_PRENATAL);
        tamizajeBean.setMenuBean("menuHistoriaPrenatal");
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        formulaMedicaUsuarioBean.inicializardFormulaMedica();
                ...
                vademecumUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaPrenatal");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaPrenatal");
    ...
    public String irPausarConsultaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_PRENATAL;
    }
    ...
    public String irDatosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_PRENATAL;
    }
    ...
    public String irMotivoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_PRENATAL;
    }
    
    public String irCuestionarioCovidPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_PRENATAL;
        }
    ...
    public String irAntecedentesEspecificosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_ESPECIFICOS_PRENATAL;
    }
    ...
    public String irAntecedentesGinecologicosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_PRENATAL;
    }
    ...
    public String irAntecedentesObstetricosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_OBSTETRICOS_PRENATAL;
    }
    ...
    public String irExamenFisicoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_PRENATAL;
    }
    ...
    public String irEncuestaViolenciaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_PRENATAL;
    }
    ...
    public String irImpDiagnosticaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_PRENATAL;
    }
    ...
    public String irGestacionPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_GESTACION_PRENATAL;
    }
    ...
    public String irTamizajePrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_TAMIZAJE_PRENATAL;
    }
    ...
    public String irAnatPatologicaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_PRENATAL;
    }
    ...
    public String irControlSinCostoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_PRENATAL;
    }
    ...
    public String irFormulaMedicaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_PRENATAL;
    }
    ...
    public String irVademecumMedicoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VADEMECUM_PRENATAL;
    }
    ...
    public String irRemHospitalizacionPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_PRENATAL;
    }
    ...
    public String irIncapacidadPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_PRENATAL;
    }
    ...
    public String irInterConsultaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_PRENATAL;
    }
    ...
    public String irOrdenCirugiaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_PRENATAL;
    }
    ...
    public String irReferenciaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_PRENATAL;
    }
    ...
    public String irReservaSangrePrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_PRENATAL;
    }
    ...
    public String irRecomedacionPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_PRENATAL;
    }
    ...
    public String irCertMedicoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_PRENATAL;
    }
    ...
    public String irCertAsistenciaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_PRENATAL;
    }
    ...
    public String irExamElectrofisiologicoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_PRENATAL;
    }
    ...
    public String irExamImagenPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_PRENATAL;
    }
    ...
    public String irExamLaboratorioPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_PRENATAL;
    }
    ...
    public String irCerrarConsultaPrenatal() {
        ...
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_PRENATAL;
    }
    ...
    public String irResumenHistoriaEspecificaPrenatal() {
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_PRENATAL;
    }
    ...
    public String irResumenHistoriaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_PRENATAL;
    }
     ...
     * @return
     */
    public String irEscalaValoracionCaidasPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_PRENATAL;
    }
}
