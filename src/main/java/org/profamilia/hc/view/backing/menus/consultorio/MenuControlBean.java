...
public class MenuControlBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL);
        datosBasicosUsuario.setMenuBean("menuControlBean");
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_CONTROL);
        cuestionarioCovid.setMenuBean("menuControlBean");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuControlBean");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO);
        ...
        // Antecedentes
         ...
         if (!primeraConsulta) {
             ...
             antecedentes.setTipoHistoria(HISTORIA_CONTROL);
             antecedentes.setUsuario(datosBasicosUsuario.getUsuario());
             antecedentes.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO);
             antecedentes.setMenuBean("menuControlBean");
         ...
         if (primeraConsulta) {
             ...
             antecedentesGenerales.setTipoHistoria(HISTORIA_CONTROL);
             ...
             antecedentesGenerales.setMenuBean("menuControlBean");
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO);
        examenFisicoUsuario.setMenuBean("menuControlBean");
        ...
        control.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL);
        control.setMenuBean("menuControlBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuControlBean");
        ...
        dispositivos.setMenuBean("menuControlBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuControlBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuControlBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuControlBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuControlBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuControlBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuControlBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuControlBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuControlBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuControlBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuControlBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuControlBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuControlBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuControlBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuControlBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuControlBean");
        ...
        if(motivo != null && motivo.getHmcncausaexte() != null)
         ...
         autorizacionServicioUsuarioBean.setMenuBean("menuControlBean");
    ...
    public String irDatosControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_CONTROL;
    }
