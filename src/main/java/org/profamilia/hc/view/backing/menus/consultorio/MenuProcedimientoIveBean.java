...
public class MenuProcedimientoIveBean extends BaseBean {
	...
	renderServiciosAdmision =false;
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVIDPROCEDIMIENTO_IVE);
        datosBasicosUsuario.setMenuBean("menuProcedimientoIveBean");
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_PROCEDIMIENTOS_IVE);
        cuestionarioCovid.setMenuBean("menuProcedimientoIveBean");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuProcedimientoIveBean");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_PROCEDIMIENTO_IVE);
        ...
        procedimientoBean.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_PROCEDIMIENTO_IVE);
        procedimientoBean.setMenuBean("menuProcedimientoIveBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        // CONDUCTA - FORMULA MEDICA
             ...
             vademecumUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuProcedimientoIveBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuProcedimientoIveBean");
    ...
    public String irPausarConsultaProcedimientosIve() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_PROCEDIMIENTOS_IVE;
    }
    ...
    public String irDatosProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_PROCEDIMIENTO_IVE;
    }
    
    public String irCuestionarioCovidProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVIDPROCEDIMIENTO_IVE;
        }
    ...
    public String irProcedimientosConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PROCEDIMIENTO_IVE;
    }
    ...
    public String irAnatPatologicaProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_PROCEDIMIENTO_IVE;
    }
    ...
    public String irControlSinCostoProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_PROCEDIMIENTO_IVE;
    }
    ...
    public String irFormulaMedicaProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_PROCEDIMIENTO_IVE;
    }
    ...
    public String irVademecumMedicoProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VADEMCUM_PROCEDIMIENTO_IVE;
    }
    ...
    public String irRemHospitalizacionProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_PROCEDIMIENTO_IVE;
    }
    ...
    public String irIncapacidadProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_PROCEDIMIENTO_IVE;
    }
    ...
    public String irInterConsultaProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_PROCEDIMIENTO_IVE;
    }
    ...
    public String irOrdenCirugiaProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_PROCEDIMIENTO_IVE;
    }
    ...
    public String irReferenciaProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_PROCEDIMIENTO_IVE;
    }
    ...
    public String irReservaSangreProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_PROCEDIMIENTO_IVE;
    }
    ...
    public String irRecomedacionProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_PROCEDIMIENTO_IVE;
    }
    ...
    public String irCertMedicoProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_PROCEDIMIENTO_IVE;
    }
    ...
    public String irCertAsistenciaProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_PROCEDIMIENTO_IVE;
    }
    ...
    public String irExamElectrofisiologicoProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_PROCEDIMIENTO_IVE;
    }
    ...
    public String irExamImagenProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_PROCEDIMIENTO_IVE;
    }
    ...
    public String irExamLaboratorioProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_PROCEDIMIENTO_IVE;
    }
    
    /**
     * @return
     */
    public String irOrdenMedicamentosProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDEN_MEDICAMENTOS_PROCEDIMIENTO_IVE; 
    }

    /**
     * @return
     */
    public String irOrdenLiquidosProcedimientoConsultorio() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDEN_LIQUIDOS_PROCEDIMIENTO_IVE;
    }
    
    public String irRegistrarOtrasOrdenesProcedimientoConsultorio() {
        return BeanNavegacion.RUTA_IR_OTRAS_ORDENES_PROCEDIMIENTO_IVE;
    }
    ...
    public String irCerrarConsultaProcedimientoConsultorio() {
        ...
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_PROCEDIMIENTO_IVE;
    }
	...
	public String irServiciosAdmisionProcedimientosIve() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_PROCEDIMIENTOS_IVE;
    }
     ...
     * @return
     */
    public String irEscalaValoracionCaidasProcedimientosIve() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_PROCEDIMIENTOS_IVE;
    }
}
