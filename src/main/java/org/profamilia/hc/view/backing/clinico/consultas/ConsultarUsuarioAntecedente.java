...
public class ConsultarUsuarioAntecedente extends BaseBean {
    ...
    ConsultarAntecedentesBean cosultaAntecedentes;


    public ConsultarUsuarioAntecedente() {
    }
    ...
    public String consultarAntecedente() {
        ...
        if (usuarioClon != null) {
            cosultaAntecedentes = 
                    (ConsultarAntecedentesBean)FacesUtils.getManagedBean("consultarAntecedentesBean");

            if (cosultaAntecedentes != null) {
                cosultaAntecedentes.setUsuario(usuarioClon);
                cosultaAntecedentes.consultarAntecedente();
                boolean wexiste = cosultaAntecedentes.isWexito();
                if (wexiste) {
                    return BeanNavegacion.RUTA_MOSTRAR_ANTECEDENTES;
                } else {
                    FacesUtils.addErrorMessage(IConstantes.MSG_NO_ANTECEDENTES);
    ...
    public String consultarUsuario() {
        ...
        if (existenCriterios) {
            ...
            if (lstUsuarios == null || lstUsuarios.isEmpty()) {
                FacesUtils.addErrorMessage(IConstantes.MSG_NO_RESULTADOS);
            }
        } else {
