...
import org.profamilia.hc.view.backing.procedimiento.InformeCitopuncionSeno;
...
public class MenuInformeCitopuncionBean extends BaseBean {

    private DatosBasicosUsuarioBean datosBasicosUsuario;

    private InformeCitopuncionSeno informe;
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_INFORME_CITOPUNCION);
        datosBasicosUsuario.setMenuBean("menuInformeCitopuncionBean");
        renderInforme = datosBasicosUsuario.esValido();


        informe = 
                (InformeCitopuncionSeno)FacesUtils.getManagedBean("informeCitopuncionSenoBean");
        ...
        //informe.setNextAction(BeanNavegacion.RUTA_IR_CERRAR_CITOPUNCION);
        informe.setMenuBean("menuInformeCitopuncionBean");
        informe.inicializarCitopuncion();
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuInformeCitopuncionBean");
    ...
    public String irPausarConsultaCitopuncion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_CITOPUNCION;
    }

    /**
     * @return
     */
    public String irDatosCitopuncion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_CITOPUNCION;
    }
     ...
     * @return
     */
    public String irInformeCitopuncion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INFORME_CITOPUNCION;
    }
     ...
     * @return
     */
    public String irCerrarCitopuncion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERRAR_CITOPUNCION;
    }
     ...
     * @return
     */
    public String irResumenHistoriaEspecificaCitopuncion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_CITOPUNCION;
    }

    /**
     * @return
     */
    public String irResumenHistoriaCitopuncion() {
        inicializarUsuario();
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_CITOPUNCION;
    }
