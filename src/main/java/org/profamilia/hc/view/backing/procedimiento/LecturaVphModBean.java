 ...
 //======================================================================================================================
 public class LecturaVphModBean extends BaseBean implements JRDataSource {
     ...
     public void init() {
         ...
         if (citologia != null) {
             try {
             lectura = this.serviceLocator.getClinicoService().getLecturaCitologiaVph(citologia.getCcinconsec());
             if(lectura.getCcvcgenoneg().equals("N")){
                 mostrarGenotipificacion = true;
             }
     ...
     public String aceptar() {
         ...
         if (wexito) {
             try {
                 this.serviceLocator.getClinicoService().saveLecturaVphModificacion(lectura);
                 Cfadmision admision;
                 String nomContrato;
                 if (citologia != null) {
                     admision = 
                             this.serviceLocator.getClinicoService().getAdmision(citologia.getCcinnumdoc().longValue());
                     nomContrato = 
                             admision.getCancontra().toString() + " " + this.serviceLocator.getCirugiaService().getNombreContrato(admision.getCancontra().toString());

                     List<Chcorreo> lstCorreo = new ArrayList<Chcorreo>();
                     lstCorreo = 
                             this.serviceLocator.getClinicoService().getCorreosByParam(citologia.getCcinnumdoc().longValue());
