...
public class ConsultarUsuarioNotaComplementariaEnfermeriaBean extends BaseBean {
    ...
    ConsultarFoliosNotaComplementariaEnfermeriaBean cosultaFolios;

    private boolean existenCriterios;


    public ConsultarUsuarioNotaComplementariaEnfermeriaBean() {
    }
    ...
    public String consultarNotaMedica() {
        ...
        if (usuarioClon != null) {
            cosultaFolios = 
                    (ConsultarFoliosNotaComplementariaEnfermeriaBean)FacesUtils.getManagedBean("consultarFoliosNotaComplementariaEnfermeriaBean");

            if (cosultaFolios != null) {
                cosultaFolios.setUsuario(usuarioClon);
                return BeanNavegacion.RUTA_CONSULTAR_FOLIOS_NOTA_COMPLEMENTARIA;
            }
        }
        return null;
    }
