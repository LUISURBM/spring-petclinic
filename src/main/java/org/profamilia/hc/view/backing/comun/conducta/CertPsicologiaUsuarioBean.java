//=======================================================================
// ARCHIVO CertMedicoUsuarioBean.java
// FECHA CREACI�N: 02/08/2010
// AUTOR: Jos� Andr�s Riano
// Descripci�n: Datos correspondientes al certificado medico.
//=======================================================================
...
public class CertPsicologiaUsuarioBean extends BaseBean implements JRDataSource {
    ...
    public CertPsicologiaUsuarioBean() {
    }

    //ACTIONS 

    public void init() {
        inicializarCertificadoMedico();
    }

    public void inicializarCertificadoMedico() {
    ...
    public void generarCertificado() {
        ...
        if (numeroConsulta != null && tipoServicio != null && 
            ...
            id.setHcmctipocert(IConstantes.CERTIFICADO_MEDICO);
        ...
        try {
           ...
           URL url = FacesUtils.getFacesContext().getExternalContext().getResource("/reports/certificadoPsicologia.jasper");
            ...
            if (url != null) {
                ...
                PdfServletUtils.showPdfDocument(bytes, 
                                                "certificadoPsicologia" + Calendar.getInstance().getTimeInMillis() + 
                                                ".pdf", false);
