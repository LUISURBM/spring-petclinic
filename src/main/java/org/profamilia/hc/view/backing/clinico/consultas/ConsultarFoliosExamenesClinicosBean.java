...
import org.profamilia.hc.view.backing.clinico.consultorio.RegistrarExamenesClinicosBean;
...
public class ConsultarFoliosExamenesClinicosBean extends BaseBean {

    private Chusuario usuario;

    /** Almacena el bean de Registrar Folios */

    RegistrarExamenesClinicosBean registrarExamenes;
    ...
    public ConsultarFoliosExamenesClinicosBean() {
    }
    ...
    public void consultarFoliosUsuario() {
        if (usuario.getHuslnumero() != null) {
            try {
                lstFolios = 
                        this.getServiceLocator().getClinicoService().getFoliosUsuarioExamenesClinicos(usuario.getHuslnumero());
            } catch (ModelException e) {
                e.printStackTrace();
            }
    ...
    public String registrarExamenClinico(){
        ...
        registrarExamenes = (RegistrarExamenesClinicosBean)FacesUtils.getManagedBean("registrarExamenesClinicosBean");
        if (consulta != null && registrarExamenes != null) {
            registrarExamenes.setConsulta(consulta);

        }
        return BeanNavegacion.RUTA_REGISTRAR_EXAMENES_CLINICOS;
        }
