...
public class ConsultarUsuarioInformePsicologicoBean extends BaseBean {
    ...
    ConsultarFoliosInformePsicologicoBean cosultaFolios;

    private boolean existenCriterios;


    public ConsultarUsuarioInformePsicologicoBean() {
    }
    ...
    public String consultarNotaMedica() {
        ...
        if (usuarioClon != null) {
            cosultaFolios = 
                    (ConsultarFoliosInformePsicologicoBean)FacesUtils.getManagedBean("consultarFoliosInformePsicologicoBean");

            if (cosultaFolios != null) {
                cosultaFolios.setUsuario(usuarioClon);
                return BeanNavegacion.RUTA_CONSULTAR_FOLIOS_INFORME_PSICOLOGICO;
            }
        }
        return null;
    }
