...
import org.profamilia.hc.view.backing.procedimiento.InformeMarcacionSenoBean;
...
public class MenuInformeMarcacionSenoBean extends BaseBean {
    ...
    private InformeMarcacionSenoBean informe;
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_MARCACION_SENO);
        datosBasicosUsuario.setMenuBean("menuInformeMarcacionSenoBean");
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_INFORME_MARCACION_SENO);
        cuestionarioCovid.setMenuBean("menuInformeMarcacionSenoBean");
        cuestionarioCovid.inicializarCuestionario();
        renderInforme= cuestionarioCovid.esValido();

        informe = 
                (InformeMarcacionSenoBean)FacesUtils.getManagedBean("informeMarcacionSenoBean");
        ...
        //informe.setNextAction(BeanNavegacion.RUTA_IR_CERRAR_MARCACION_SENO);
        informe.setMenuBean("menuInformeMarcacionSenoBean");
        informe.inicializarMarcacion();
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuInformeMarcacionSenoBean");
    ...
    public String irPausarConsultaMarcacionSeno() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_MARCACION_SENO;
    }

    /**
     * @return
     */
    public String irDatosMarcacionSeno() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_MARCACION_SENO;
    }

    /**
     * @return
     */
    public String irInformeMarcacionSeno() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INFORME_MARCACION_SENO;
    }
    
    public String irCuestionarioCovidMarcacionSeno() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_MARCACION_SENO;
        }
     ...
     * @return
     */
    public String irCerrarMarcacionSeno() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERRAR_MARCACION_SENO;
    }
     ...
     * @return
     */
    public String irResumenHistoriaEspecificaMarcacion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_MARCACION;
    }

    /**
     * @return
     */
    public String irResumenHistoriaMarcacion() {
        inicializarUsuario();
