...
public class ConsultarUsuarioConsultaSinFacturaBean extends BaseBean {
    ...
    RegistrarConsultaSinFacturaBean registrarCirugia;

    //-----------------------------------------------------------------------
    //  METODO CONSTRUCTOR
    //-----------------------------------------------------------------------

    public ConsultarUsuarioConsultaSinFacturaBean() {
    ...
    public void changeAfiliacion() {
        ...
        if (usuario != null && usuario.getHusetipoafilia().equals("X")) {
            mostrarAfiliacion = false;
                   ...
                   usuario.getHusetipoafilia().equals("C")) {
            mostrarAfiliacion = true;
    ...
    public String registrarConsultaSinFactura() {
        ...
        if (wexito && usuario != null) {
            ...
            try {
                ...
                registrarCirugia = 
                        (RegistrarConsultaSinFacturaBean)FacesUtils.getManagedBean("registrarConsultaSinFacturaBean");
                ...
                if (registrarCirugia != null) {
                    ...
                    navegationRule = 
                            BeanNavegacion.RUTA_IR_REGISTRAR_CONSULTA_SIN_FACTURA;
                }
            } catch (ModelException e) {
