...
public class MenuHistoriaAnticoncepcionTemporalBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_ANTICONCEPCION);
        datosBasicosUsuario.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
...
this.serviceLocator.getClinicoService().getParametrosRipsXClinica(datosBasicosUsuario.getConsulta());
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_ANTICONCEPCION);
        cuestionarioCovid.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_ANTICONCEPCION);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ANTICONCEPCION);
        }

        motivoConsulta.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        if (primeraConsulta) {
            ...
            antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION);
            antecedentesGenerales.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
            antecedentesGenerales.inicializarAntecedentes();
            if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
                antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION);
            ...
            antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION);
            antecedentes.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
            antecedentes.inicializarAntecedentes();
            if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
                antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION);
        ...
        antecedentesTemporales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_ANTICONCEPCION);
        antecedentesTemporales.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        antecedentesGinecologicos.setTipoHistoria(IConstantes.HISTORIA_ANTICONCEPCION_TEMPORAL);
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION);
        antecedentesGinecologicos.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_ANTICONCEPCION_TEMPORAL);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_ANTICONCEPCION);
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ANTICONCEPCION);
        examenFisicoUsuario.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        impresionDiagnosticaUsuarioBean.setCodigoRelacionado3("");
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_ANTICONCEPCION);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        if (rips != null) {
        ...
        metodos.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_ANTICONCEPCION);
        metodos.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        dispositivos.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        // CONDUCTA - FORMULA MEDICA
               ...
               vademecumUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        if (datosBasicosUsuario.getConsulta() != null) {
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        // CONDUCTA - AUTORIZACION DE SERVICIOS
         ...
         autorizacionServicioUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionTemporalBean");
    ...
    public String irDatosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_ANTICONCEPCION;
    }
    ...
    public String irMotivoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_ANTICONCEPCION;
    }


    public String irCuestionarioCovidAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_ANTICONCEPCION;
        }
    ...
    public String irAntecedentesGeneralesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ANTICONCEPCION;
    }
    ...
    public String irAntecedentesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_ANTICONCEPCION;
    }
    ...
    public String irAntecedentesTemporalesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION;
    }
    ...
    public String irAntecedentesGinecologicosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_ANTICONCEPCION;
    }
    ...
    public String irExamenFisicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_ANTICONCEPCION;
    }
    ...
    public String irEncuestaViolenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION;
    }
    ...
    public String irImpDiagnosticaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ANTICONCEPCION;
    }
    ...
    public String irMetodoPlanificacion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_ANTICONCEPCION;
    }
    ...
    public String irAnatPatologicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_ANTICONCEPCION;
    }


    public String irAplicacionRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_ANTICONCEPCION;
    }
    ...
    public String irControlSinCostoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_ANTICONCEPCION;
    }
    ...
    public String irFormulaMedicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_ANTICONCEPCION;
    }
    ...
    public String irVademecumMedicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VADEMCUM_ANTICONCEPCION;
    }
    ...
    public String irRemHospitalizacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_ANTICONCEPCION;
    }
    ...
    public String irIncapacidadAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_ANTICONCEPCION;
    }
    ...
    public String irInterConsultaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_ANTICONCEPCION;
    }
    ...
    public String irOrdenCirugiaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_ANTICONCEPCION;
    }
    ...
    public String irReferenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_ANTICONCEPCION;
    }
    ...
    public String irAutorizacionServicioAnticoncepcion(){
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_AUTORIZACION_SERVICIO_ANTICONCEPCION;
    }
    ...
    public String irReservaSangreAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_ANTICONCEPCION;
    }
    ...
    public String irRecomedacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_ANTICONCEPCION;
    }
    ...
    public String irCertMedicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_ANTICONCEPCION;
    }
    ...
    public String irCertAsistenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_ANTICONCEPCION;
    }
    ...
    public String irExamElectrofisiologicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO__ANTICONCEPCION;
    }
    ...
    public String irExamImagenAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_ANTICONCEPCION;
    }
    ...
    public String irExamLaboratorioAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_ANTICONCEPCION;
    }
    ...
    public String irCerrarConsultaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_ANTICONCEPCION;
    }
...
*/
    ...
    public String irPausarConsultaAnticoncepcionTemporal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_ANTICONCEPCION_TEMPORAL;
    }
	
	public String irServiciosAdmisionAnticoncepcionTemporal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_ANTICONCEPCION_TEMPORAL;
    }
     ...
     * @return
     */
    public String irEscalaValoracionCaidasAnticoncepcionTemporal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_ANTICONCEPCION_TEMPORAL;
    }
