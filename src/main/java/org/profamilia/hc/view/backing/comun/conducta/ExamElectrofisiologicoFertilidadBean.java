...
public class ExamElectrofisiologicoFertilidadBean extends BaseBean implements JRDataSource {
    ...
    public ExamElectrofisiologicoFertilidadBean() {
    }
    ...
    public void generarRemision() {
        ...
        if (lstRemision.size() != 0) {
            ...
            try {
               ...
               URL url = FacesUtils.getFacesContext().getExternalContext().getResource("/reports/RemisionFertilidad.jasper");
               URL url_profamilia = FacesUtils.getFacesContext().getExternalContext().getResource(IMAGE_PROFAMILIA_FERTILIDAD); 
