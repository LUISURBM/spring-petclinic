...
public class RecomedacionUsuarioBean extends BaseBean implements JRDataSource {
    ...
    private List lstConductaEntrega;
    ...
    public RecomedacionUsuarioBean() {
    }
    ...
    public void inicializarRecomedaciones() {
        ...
        lstConductaEntrega = new ArrayList();
        renderColposcopia=false;
        
        if(tipoHistoria != null && tipoHistoria == IConstantes.HISTORIA_PROCEDIMIENTO_COLPOSCOPIA){
    ...
    public void obtenerDatosReporteConsulta() {
        ...
        if (conducta != null) {
            DESCRIPCION_RECOMENDACIONES = formatearCampoCLOB(conducta.getHcncobservacio());
        }
    ...
    public void aceptarPlantilla() {
        ...
        if (buscador != null && buscador.getPlantillaSelect() != null) {
            ...
            conducta.setHcncobservacio(buscador.getPlantillaSelect().getHplcdescripcio());
    ...
    public void setLstConductaEntrega(List lstConductaEntrega) {
        this.lstConductaEntrega = lstConductaEntrega;
    }

    public List getLstConductaEntrega() {
        if (lstConductaEntrega.size() == 0) {
            ArrayList<Cndesccito> lstConductaAux = null;
            try {

                lstConductaAux = 
                            (ArrayList<Cndesccito>)this.getServiceLocator().getClinicoService().getListaDescripcionesCitologia("chconducta", 
                                                                                                                               "hcnccondentr");
            } catch (ModelException e) {
                e.printStackTrace();
            }
            ...
            if (lstConductaAux != null && !lstConductaAux.isEmpty()) {
                ...
                lstConductaEntrega.add(new SelectItem("", 
                                               "Seleccione una opcion ..."));
                Iterator it = lstConductaAux.iterator();
                int i = 0;
                while (it.hasNext()) {
                    it.next();
                    lstConductaEntrega.add(new SelectItem((lstConductaAux.get(i).getCdicvalor()), 
                                                   lstConductaAux.get(i).getCdicdescri()));
                    i++;
                }
            }
        }
        return lstConductaEntrega;
    }
