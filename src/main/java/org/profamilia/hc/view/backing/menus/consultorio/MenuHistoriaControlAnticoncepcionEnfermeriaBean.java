...
public class MenuHistoriaControlAnticoncepcionEnfermeriaBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL_ANTICONCEPCION_ENFERMERIA);
        datosBasicosUsuario.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
...
this.serviceLocator.getClinicoService().getParametrosRipsXClinica(datosBasicosUsuario.getConsulta());
     ...
     cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_CONTROL_ANTICONCEPCION_ENFERMERIA);
     cuestionarioCovid.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
     ...
     renderMotivo= cuestionarioCovid.esValido();
        ...
        if (rips != null) {
            if (rips.getCrsncauext() != null) {
                motivoConsulta.setCausaSelect(rips.getCrsncauext().toString());
            }
            if (rips.getCrsnfinali() != null) {
                motivoConsulta.setFinalidadSelect(rips.getCrsnfinali().toString());
            }
        }

        motivoConsulta.setModoconsulta(true);
        motivoConsulta.setEnfermedadOpcional(true);
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_CONTROL_ANTICONCEPCION_ENFERMERIA);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_CONTROL_ANTICONCEPCION_ENFERMERIA);
        }

        motivoConsulta.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        ...
        antecedentes.setTipoHistoria(HISTORIA_CONTROL_ANTICONCEPCION_TEMPORAL);
        antecedentes.setUsuario(datosBasicosUsuario.getUsuario());
        antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_CONTROL_ANTICONCEPCION_ENFERMERIA);
        antecedentes.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        antecedentes.inicializarAntecedentes();
        if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
            antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_CONTROL_ANTICONCEPCION_ENFERMERIA);
        ...
        antecedentesGenerales.setTipoHistoria(HISTORIA_CONTROL_ANTICONCEPCION_TEMPORAL);
        antecedentesGenerales.setNumeroConsulta(numeroConsulta);
        antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_CONTROL_ANTICONCEPCION_ENFERMERIA);
        antecedentesGenerales.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        antecedentesGenerales.inicializarAntecedentes();
        if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
            antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_CONTROL_ANTICONCEPCION_ENFERMERIA);
        ...
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_CONTROL_ANTICONCEPCION_ENFERMERIA);
        antecedentesGinecologicos.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_CONTROL_ANTICONCEPCION_ENFERMERIA);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_CONTROL_ANTICONCEPCION_ENFERMERIA);
        examenFisicoUsuario.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        ...
        impresionDiagnosticaUsuarioBean.setCodigoRelacionado3("");
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_CONTROL_ANTICONCEPCION_ENFERMERIA);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        ...
        metodos.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_ANTICONCEPCION_ENFERMERIA);
        metodos.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        ...
        dispositivos.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
     ...
     anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     controlSinCostoUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     formulaMedicaUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     hospitalizacionUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     if (datosBasicosUsuario.getConsulta() != null) {
     ...
     interConsultaUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     if (datosBasicosUsuario.getConsulta() != null) {
         Long tipoDocuentoAdmision = 
             datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
         if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
     ...
     incapacidadUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     referenciaUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     reservaSangreUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     certMedicoUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     certAsistenciaUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     examImagenUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     ...
     examLaboratorioUsuarioBean.setMenuBean("menuHistoriaControlEnfermeriaBean");
     if (datosBasicosUsuario.getConsulta() != null) {
         Long tipoDocuentoAdmision = 
             datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
         if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
     ...
     examLaboratorioUsuarioBean.inicializarExamLaboratorio();
        ...
        formulaMedicaUsuarioBean.setCodigoCIE10(cie10Principal);
        formulaMedicaUsuarioBean.setConsecutivo(1);
        formulaMedicaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
        formulaMedicaUsuarioBean.inicializardFormulaMedica();
                ...
                vademecumUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
     vademecumUsuarioBean.setRenderAlertaIve(false);
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionEnfermeriaBean");
    ...
    public String irPausarConsultaControlAnticoncepcionEnfermeria() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irDatosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irMotivoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    
    public String irCuestionarioCovidAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL_ANTICONCEPCION_ENFERMERIA;
        }
    ...
    public String irAntecedentesGeneralesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAntecedentesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAntecedentesGinecologicosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irExamenFisicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irEncuestaViolenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irImpDiagnosticaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irMetodoPlanificacion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAplicacionRetiro() {
        ...
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irRecomedacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irCerrarConsultaControlAnticoncepcion() {
        inicializarUsuario();
        if (cerrarConsultaUsuarioBean != null) {
            cerrarConsultaUsuarioBean.inicalizarCerrarConsultaBean();
        }
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    /**
       ...
       public String irFormulaMedicaAnticoncepcion() {
           inicializarUsuario();
           return BeanNavegacion.RUTA_IR_FORMULAMEDICA_CONTROL_ANTICONCEPCION_ENFERMERIA;
       }
    ...
    public String irVademecumMedicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VADEMCUM_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAnatPatologicaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irControlSinCostoControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irRemHospitalizacionControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irIncapacidadControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irInterConsultaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irOrdenCirugiaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irReferenciaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irReservaSangreControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irCertMedicoControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irCertAsistenciaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irExamElectrofisiologicoControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irExamImagenControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irExamLaboratorioControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_ANTICONCEPCION_CONTROL_ENFERMERIA;
    }
    ...
    public String irResumenHistoriaEspecificaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irResumenHistoriaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
...
*/
	...
	public String irServiciosAdmisionControlAnticoncepcionEnfermeria() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_CONTROL_ANTICONCEPCION_ENFERMERIA;
    }
