...
public class RepCovidAnticureposBean extends BaseBean implements JRDataSource {
    ...
    public RepCovidAnticureposBean() {
    }
    ...
    public void consultarRegistros() {
        try {
            generoReporte = false;
            listaRegistros = 
                    this.serviceLocator.getClinicoService().getRegistrosAnticuerposCovid(new Long(clinicaSelect),
                                                                                      numeroUsuario,
                                                                                      fechaInicial, 
                                                                                      fechaFinal);
/*            if (clinicaSelect != 0) {
                listaRegistros = 
                        this.serviceLocator.getClinicoService().getRegistrosAnticuerposCovid(Long.parseLong(clinicaSelect.toString()),
                                                                                          numeroUsuario,
                                                                                          fechaInicial, 
                                                                                          fechaFinal);
            } else {
                listaRegistros = 
                        this.serviceLocator.getClinicoService().getRegistrosAnticuerposCovid(0L,numeroUsuario, 
                                                                                          fechaInicial, 
                                                                                          fechaFinal);
            }
*/
    ...
    public Object getFieldValue(JRField jrField) {
        ...
        if (fieldName.equals("FECHA")) {
            ...
            entidad= serviceLocator.getClinicoService().getEntidadEpsxCodigo(b[8].toString());
            if(entidad!=null){
        ...
        Integer edad= usuario.calcularEdad(fen);
            ...
            if(b[9] != null && !"".equals(b[9].toString())){
                value = b[9].toString();
            }
            return value;
        } else if (fieldName.equals("CERCOEPID")) {
            value = (String)b[10];
            return value;
            ...
            return value;
                ...
                value = (String)b[12];
                return value;
            } else if (fieldName.equals("SINTOMASPACI")) {
                value = (String)b[13];
                return value;
            } else if (fieldName.equals("FECHA_SINTOMAS")) {
                    value = b[14];
                    return value;
            } else if (fieldName.equals("DIAS_EVOLUCION")) {
                        value = b[15];
                        return value;
...
//                value = (String)b[20];
                value = "2020RD-0006148";
                return value;
            } else if (fieldName.equals("FECHFAB")) {
                value = b[21];
                return value;
            } else if (fieldName.equals("FECHVEN")) {
                value = b[22];
                return value;
            ...
            String cargoProfesional;
                 profe= serviceLocator.getClinicoService().getProfesionalPorUsuario((String)b[26], this.getClinica().getCclncodigo());
                 if(profe !=null){
    ...
    public void generarArchivoCsv() {
        ...
        if (listaRegistros == null || listaRegistros.isEmpty()) {
            ...
            try {
                String nombreArchivo = "RegistrosAnticuerposCovid19";
                URL url = 
                    FacesUtils.getFacesContext().getExternalContext().getResource("/reports/reporteAnticuerposCovid.jasper");
