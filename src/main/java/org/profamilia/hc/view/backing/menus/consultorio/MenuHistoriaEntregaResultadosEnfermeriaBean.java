...
public class MenuHistoriaEntregaResultadosEnfermeriaBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO_ENFERMERIA);
        datosBasicosUsuario.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        // Antecedentes
         ...
         if (!primeraConsulta) {
             ...
             antecedentes.setTipoHistoria(HISTORIA_ENTREGA_RESULTADO);
             antecedentes.setUsuario(datosBasicosUsuario.getUsuario());
             antecedentes.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO_ENFERMERIA);
             antecedentes.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
         ...
         if (primeraConsulta) {
             ...
             antecedentesGenerales.setTipoHistoria(HISTORIA_ENTREGA_RESULTADO);
             antecedentesGenerales.setNumeroConsulta(numeroConsulta);
             antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO_ENFERMERIA);
             antecedentesGenerales.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO_ENFERMERIA);
        examenFisicoUsuario.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        control.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_ENTREGA_RESULTADOS_ENFERMERIA);
        control.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        control.setControlrender(false);
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        dispositivos.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaEntregaResultadosEnfermeriaBean");
    ...
    public String irPausarConsultaEntregaResultados() {
        inicializarUsuario();
     ...
     * @return
     */
    public String irDatosEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irMotivoEntregaResultados() {
        inicializarUsuario();

        return BeanNavegacion.RUTA_IR_MOTIVO_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irAntecedentesGeneralesEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ENTREGA_RESULTADOS_ENFERMERIA; 
    }
     ...
     * @return
     */
    public String irAntecedentesEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irExamenFisicoEntregaResultados() {

        inicializarUsuario();

        return BeanNavegacion.RUTA_IR_EXAMEN_FISICO_ENTREGA_RESULTADOS_ENFERMERIA;
    }

    /**
     * @return
     */
    public String irImpDiagnosticaEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ENTREGA_RESULTADOS_ENFERMERIA;
    }


    public String irEntregaResultadosUsuario() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irAnatPatologicaEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_ENTREGA_RESULTADOS_ENFERMERIA;
    }
    ...
    public String irAplicacionRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_ENTREGA_RESULTADOS_ENFERMERIA;
    }

    /**
     * @return
     */
    public String irControlSinCostoEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irFormulaMedicaEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_ENTREGA_RESULTADOS_ENFERMERIA;
    }
         ...
         * @return
         */
        public String irVademecumMedicoEntregaResultados() {
            inicializarUsuario();
            return BeanNavegacion.RUTA_IR_VADEMCUM_ENTREGA_RESULTADOS_ENFERMERIA;
        }

    /**
     * @return
     */
    public String irRemHospitalizacionEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_ENTREGA_RESULTADOS_ENFERMERIA;
    }
    
    /**
     * @return
     */
     public String irAutorizacionServicioEntregaResultados(){
         inicializarUsuario();
         return BeanNavegacion.RUTA_IR_AUTORIZACION_SERVICIO_ENTREGA_RESULTADOS_ENFERMERIA;
     }
     ...
     * @return
     */
    public String irIncapacidadEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irInterConsultaEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irOrdenCirugiaEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irReferenciaEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_ENTREGA_RESULTADOS_ENFERMERIA;
    }

    /**
     * @return
     */
    public String irReservaSangreEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irRecomedacionEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irCertMedicoEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_ENTREGA_RESULTADOS_ENFERMERIA;
    }

    /**
     * @return
     */
    public String irCertAsistenciaEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_ENTREGA_RESULTADOS_ENFERMERIA;
    }

    /**
     * @return
     */
    public String irExamElectrofisiologicoEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_ENTREGA_RESULTADOS_ENFERMERIA;
    }

    /**
     * @return
     */
    public String irExamImagenEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_ENTREGA_RESULTADOS_ENFERMERIA;
    }

    /**
     * @return
     */
    public String irExamLaboratorioEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_ENTREGA_RESULTADOS_ENFERMERIA;
    }


    public String irCerrarConsultaEntregaResultados() {
        if (cerrarConsultaUsuarioBean != null) {
            cerrarConsultaUsuarioBean.inicalizarCerrarConsultaBean();
        }
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_ENTREGA_RESULTADOS_ENFERMERIA;
    }

    /**
     * @return
     */
    public String irResumenHistoriaEspecificaEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_ESPECIFICO_ENTREGA_RESULTADOS_ENFERMERIA;
    }
     ...
     * @return
     */
    public String irResumenHistoriaEntregaResultados() {
        inicializarUsuario();
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_ENTREGA_RESULTADOS_ENFERMERIA;
    }
    ...
    public ExpandableTreeModel getTrnhistoria() {
        ...
        TreeNodeBase itemNode2 = 
            new TreeNodeBase("itemNode2", "EntregaResultados", false);
	...
	public String irServiciosAdmisionEntregaResultados() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_ENTREGA_RESULTADOS_ENFERMERIA;
    }
    ...
    public String irOrdenLiquidosEntregaResultados() {
        return BeanNavegacion.RUTA_IR_ORDEN_LIQUIDOS_ENTREGA_RESULTADOS_ENFERMERIA;
    }
    
    public String irOrdenMedicamentosEntregaResultados() {
        return BeanNavegacion.RUTA_IR_ORDEN_MEDICAMENTOS_ENTREGA_RESULTADOS_ENFERMERIA;
    }
