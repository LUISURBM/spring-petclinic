...
public class ExamImagenUsuarioBean extends BaseBean implements JRDataSource {
    ...
    public void generarRemision() {
        ...
        if (lstRemision.size() != 0) {
            ...
            try {
                ...
                URL url = 
                    FacesUtils.getFacesContext().getExternalContext().getResource("/reports/RemisionImagenes.jasper");
                URL url_profamilia = 
