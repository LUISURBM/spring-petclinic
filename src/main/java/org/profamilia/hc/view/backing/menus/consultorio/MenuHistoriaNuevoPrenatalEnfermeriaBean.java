...
public class MenuHistoriaNuevoPrenatalEnfermeriaBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_NUEVO_PRENATAL_ENFERMERIA);
        datosBasicosUsuario.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_NUEVO_PRENATAL_ENFERMERIA);
        cuestionarioCovid.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_NUEVO_PRENATAL_ENFERMERIA);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_NUEVO_PRENATAL_ENFERMERIA);
        }

        motivoConsulta.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        // ANTECEDENTES GENERALES
         ...
         antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_NUEVO_PRENATAL_ENFERMERIA);
         antecedentes.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBeanBean");
        ...
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_OBSTETRICOS_NUEVO_PRENATAL_ENFERMERIA);
        antecedentesGinecologicos.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        antecedentesObstetricos.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_FAMILIARES_NUEVO_PRENATAL_ENFERMERIA);
        antecedentesObstetricos.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        && antecedentesObstetricos.getAntecedente().getHaonnumparto() != null){
            numeroPartos =  antecedentesObstetricos.getAntecedente().getHaonnumparto(); 
                ...
                antecedentesFamiliares.setNextAction(BeanNavegacion.RUTA_IR_GESTACION_NUEVO_PRENATAL_ENFERMERIA);
                antecedentesFamiliares.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        gestacionBean.setNextAction(BeanNavegacion.RUTA_IR_VALORACION_BIOPSICOSOCIAL_NUEVO_PRENATAL_ENFERMERIA);
        gestacionBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        valoracionBiopsicosocialBean.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_NUEVO_PRENATAL_ENFERMERIA);
        valoracionBiopsicosocialBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_TAMIZAJE_NUEVO_PRENATAL_ENFERMERIA);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        tamizajeBean.setNextAction(BeanNavegacion.RUTA_IR_EXAMEN_FISICO_GENERAL_NUEVO_PRENATAL_ENFERMERIA);
        tamizajeBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        tamizajeBean.inicializarTamizaje();
        renderExamenFisico = tamizajeBean.esValido();
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_NUEVO_PRENATAL_ENFERMERIA);
        examenFisicoUsuario.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        examenFisicoUsuarioPrenatal.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_NUEVO_PRENATAL_ENFERMERIA);
        examenFisicoUsuarioPrenatal.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_NUEVO_PRENATAL_ENFERMERIA);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        formulaMedicaUsuarioBean.inicializardFormulaMedica();
                ...
                vademecumUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaNuevoPrenatalEnfermeriaBean");
    ...
    public String irDatosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irMotivoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_NUEVO_PRENATAL_ENFERMERIA;
    }
    
    public String irCuestionarioCovidPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_NUEVO_PRENATAL_ENFERMERIA;
        }
    ...
    public String irAntecedentesEspecificosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_FAMILIARES_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irAntecedentesGinecologicosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irAntecedentesObstetricosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_OBSTETRICOS_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irExamenFisicoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irEncuestaViolenciaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irImpDiagnosticaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irGestacionPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_GESTACION_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irTamizajePrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_TAMIZAJE_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irAnatPatologicaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irControlSinCostoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irFormulaMedicaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irVademecumMedicoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VADEMECUM_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irRemHospitalizacionPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irIncapacidadPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irInterConsultaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irOrdenCirugiaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irReferenciaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irReservaSangrePrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irRecomedacionPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irCertMedicoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irCertAsistenciaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irExamElectrofisiologicoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irExamImagenPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irExamLaboratorioPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irCerrarConsultaPrenatal() {
        ...
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irResumenHistoriaEspecificaPrenatal() {
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irAutorizacionServiciosPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_AUTORIZACION_SERVICIOS_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irResumenHistoriaPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irAntecedentesGeneralesPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irValoracionBiopsicosocialNuevoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VALORACION_BIOPSICOSOCIAL_NUEVO_PRENATAL_ENFERMERIA;
    }
    ...
    public String irExamenFisicoGeneralNuevoPrenatal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMEN_FISICO_GENERAL_NUEVO_PRENATAL_ENFERMERIA;
    }
