...
public class MenuHistoriaControlAnticoncepcionBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL_ANTICONCEPCION);
        datosBasicosUsuario.setMenuBean("menuHistoriaControlAnticoncepcionBean");
...
this.serviceLocator.getClinicoService().getParametrosRipsXClinica(datosBasicosUsuario.getConsulta());
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_CONTROL_ANTICONCEPCION);
        cuestionarioCovid.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_CONTROL_ANTICONCEPCION);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_CONTROL_ANTICONCEPCION);
        }

        motivoConsulta.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_CONTROL_ANTICONCEPCION);
        antecedentes.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        antecedentes.inicializarAntecedentes();
        if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
            antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_CONTROL_ANTICONCEPCION);
        ...
        antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_CONTROL_ANTICONCEPCION);
        antecedentesGenerales.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        antecedentesGenerales.inicializarAntecedentes();
        if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
            antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_CONTROL_ANTICONCEPCION);
        ...
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_CONTROL_ANTICONCEPCION);
        antecedentesGinecologicos.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_CONTROL_ANTICONCEPCION_TEMPORAL);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_CONTROL_ANTICONCEPCION);
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_CONTROL_ANTICONCEPCION);
        examenFisicoUsuario.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        impresionDiagnosticaUsuarioBean.setCodigoRelacionado3("");
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_CONTROL_ANTICONCEPCION);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        metodos.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_ANTICONCEPCION);
        metodos.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        dispositivos.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        // CONDUCTA - FORMULA MEDICA
            ...
            vademecumUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        if (datosBasicosUsuario.getConsulta() != null) {
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaControlAnticoncepcionBean");
    ...
    public String irPausarConsultaControlAnticoncepcionTemporal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_CONTROL_ANTICONCEPCION_TEMPORAL;
    }
    ...
    public String irDatosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irMotivoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_CONTROL_ANTICONCEPCION;
    }
    
    public String irCuestionarioCovidAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL_ANTICONCEPCION;
        }
    ...
    public String irAntecedentesGeneralesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irAntecedentesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irAntecedentesGinecologicosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irExamenFisicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irEncuestaViolenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irImpDiagnosticaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irMetodoPlanificacion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irAnatPatologicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irAplicacionRetiro() {
        ...
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irControlSinCostoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irFormulaMedicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irVademecumMedicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VADEMCUM_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irRemHospitalizacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irIncapacidadAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irInterConsultaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irOrdenCirugiaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irReferenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irReservaSangreAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irRecomedacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irCertMedicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irCertAsistenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irExamElectrofisiologicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irExamImagenAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irExamLaboratorioAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irCerrarConsultaControlAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irResumenHistoriaEspecificaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_CONTROL_ANTICONCEPCION;
    }
    ...
    public String irResumenHistoriaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_CONTROL_ANTICONCEPCION;
    }
...
*/
	...
	public String irServiciosAdmisionControlAnticoncepcionTemporal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_CONTROL_ANTICONCEPCION_TEMPORAL;
    }
     ...
     * @return
     */
    public String irEscalaValoracionCaidasControlAnticoncepcionTemporal() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_CONTROL_ANTICONCEPCION_TEMPORAL;
    }
