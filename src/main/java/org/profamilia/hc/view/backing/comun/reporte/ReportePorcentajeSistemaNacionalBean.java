...
public class ReportePorcentajeSistemaNacionalBean extends BaseBean implements JRDataSource {
    ...
    public ReportePorcentajeSistemaNacionalBean() {
    }
     ...
     */
     public Object getFieldValue(JRField jrField){
         ...
         if(fieldName.equals("CODIGO_MEDICO")) {
             ...
             value = CLINICA;
         } else if(fieldName.equals("FECHA_FACTURACION")) {
    ...
    public void obtenerDatosReporte(int indexAux){
        ...
        if(aux != null){
            ...
            if(aux[10]!= null){
                FECHA_FACTURACION = (Date)aux[10];
            }
               
            if(aux[12]!= null){
                CLINICA = (String)aux[12];
            }
               
            if(aux[13]!= null){
                NUMERO_DOCUMENTO = (BigDecimal)aux[13];
            }
    ...
    public void generarReporte()
    {
        ...
        if(tipoSelect!= null){
           if(tipoSelect.equals("R")){
                ...
                nombSalida = "reportePorcentajeResumido";
            }else if(tipoSelect.equals("D")){
                urlAux = "/reports/reporteDetalladoNacionalManual.jasper";
                nombSalida = "reportePorcentajeDetallado";
            }
        }

        try {
            lstReporte = this.serviceLocator.getClinicoService().getReportePorcentajeManual(fechaInicial,fechaFinal,wcodclin, wcodmed, numeroSala, wservicio);
