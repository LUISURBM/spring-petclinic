...
public class MenuHistoriaAnticoncepcionInsercion extends BaseBean {
    ...
    private boolean renderInsercionMetodo; 
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_INSERCION);
        datosBasicosUsuario.setMenuBean("menuHistoriaAnticoncepcionInsercion");
...
this.serviceLocator.getClinicoService().getParametrosRipsXClinica(datosBasicosUsuario.getConsulta());
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_ANTICONCEPCION_INSERCION);
        cuestionarioCovid.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_ANTICONCEPCION_INSERCION);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ANTICONCEPCION_INSERCION);
        }

        motivoConsulta.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        if (primeraConsulta) {
            ...
            antecedentesGenerales.setTipoHistoria(HISTORIA_ANTICONCEPCION_INSERCION);
            antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_INSERCION);
            antecedentesGenerales.setMenuBean("menuHistoriaAnticoncepcionInsercion");
            antecedentesGenerales.inicializarAntecedentes();
            if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
                antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_INSERCION);
            ...
            antecedentes.setTipoHistoria(HISTORIA_ANTICONCEPCION_INSERCION);
            antecedentes.setUsuario(datosBasicosUsuario.getUsuario());
            antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_INSERCION);
            antecedentes.setMenuBean("menuHistoriaAnticoncepcionInsercion");
            antecedentes.inicializarAntecedentes();
            if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
                antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_INSERCION);
        ...
        antecedentesTemporales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_ANTICONCEPCION_INSERCION);
        antecedentesTemporales.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        antecedentesGinecologicos.setTipoHistoria(IConstantes.HISTORIA_ANTICONCEPCION_INSERCION);
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_INSERCION);
        antecedentesGinecologicos.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_ANTICONCEPCION_INSERCION);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_ANTICONCEPCION_INSERCION);
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ANTICONCEPCION_INSERCION);
        examenFisicoUsuario.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        impresionDiagnosticaUsuarioBean.setCodigoRelacionado3("");
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_ANTICONCEPCION_INSERCION);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        if (rips != null) {
        ...
        metodos.setNextAction(BeanNavegacion.RUTA_IR_APLICACION_RETITO_ANTICONCEPCION_INSERCION);
        metodos.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        metodos.inicializarMetodo();
        renderInsercionMetodo = metodos.esValido();
        ...
        dispositivos.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_ANTICONCEPCION_INSERCION);
        dispositivos.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        formulaMedicaUsuarioBean.inicializardFormulaMedica();
                ...
                vademecumUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        if (datosBasicosUsuario.getConsulta() != null) {
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        // CONDUCTA - AUTORIZACION DE SERVICIOS
         ...
         autorizacionServicioUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionInsercion");
    ...
    public String irPausarConsultaAnticoncepcionInsercion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irDatosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irMotivoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_ANTICONCEPCION_INSERCION;
    }
    
    public String irCuestionarioCovidAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_INSERCION;
        }
    ...
    public String irAntecedentesGeneralesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irAntecedentesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irAntecedentesTemporalesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irAntecedentesGinecologicosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irExamenFisicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irEncuestaViolenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irImpDiagnosticaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irMetodoPlanificacion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irAnatPatologicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_ANTICONCEPCION_INSERCION;
    }


    public String irAplicacionRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irControlSinCostoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irFormulaMedicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_ANTICONCEPCION_INSERCION;
    }
        ...
        public String irVademecumMedicoAnticoncepcion() {
            inicializarUsuario();
            return BeanNavegacion.RUTA_IR_VADEMCUM_ANTICONCEPCION_INSERCION;
        }
    ...
    public String irRemHospitalizacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irIncapacidadAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irInterConsultaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irOrdenCirugiaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irReferenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_ANTICONCEPCION_INSERCION;
    }
    /**
     * 
     * @return
    ...
    public String irAutorizacionServicioAnticoncepcion(){
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_AUTORIZACION_SERVICIO_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irReservaSangreAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irRecomedacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irCertMedicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irCertAsistenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irExamElectrofisiologicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO__ANTICONCEPCION_INSERCION;
    }
    ...
    public String irExamImagenAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irExamLaboratorioAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irCerrarConsultaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irResumenHistoriaEspecificaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_ESPECIFICO_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irResumenHistoriaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_ANTICONCEPCION_INSERCION;
    }
    ...
    /**
     * @param renderInsercionMetodo
     */
    public void setRenderInsercionMetodo(boolean renderInsercionMetodo) {
        this.renderInsercionMetodo = renderInsercionMetodo;
    }

    /**
     * @return
     */
    public boolean isRenderInsercionMetodo() {
        return renderInsercionMetodo;
    }
...
*/
	...
	public String irServiciosAdmisionAnticoncepcionInsercion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_ANTICONCEPCION_INSERCION;
    }
    ...
    public String irEscalaValoracionCaidasAnticoncepcionInsercion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_ANTICONCEPCION_INSERCION;
    }
}
