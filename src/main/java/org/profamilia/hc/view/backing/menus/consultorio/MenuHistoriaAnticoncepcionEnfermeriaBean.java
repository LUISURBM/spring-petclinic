...
public class MenuHistoriaAnticoncepcionEnfermeriaBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_ANTICONCEPCION_ENFERMERIA);
        datosBasicosUsuario.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
...
this.serviceLocator.getClinicoService().getParametrosRipsXClinica(datosBasicosUsuario.getConsulta());
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_ANTICONCEPCION_ENFERMERIA);
        cuestionarioCovid.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_ANTICONCEPCION_ENFERMERIA);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ANTICONCEPCION_ENFERMERIA);
        }

        motivoConsulta.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        if (primeraConsulta) {
            ...
            antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_ENFERMERIA);
            antecedentesGenerales.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
            antecedentesGenerales.inicializarAntecedentes();
            if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
                antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_ENFERMERIA);
            ...
            antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_ENFERMERIA);
            antecedentes.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
            antecedentes.inicializarAntecedentes();
            if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
                antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_ENFERMERIA);
        ...
        antecedentesTemporales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_ANTICONCEPCION_ENFERMERIA);
        antecedentesTemporales.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_ENFERMERIA);
        antecedentesGinecologicos.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_ANTICONCEPCION_ENFERMERIA);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ANTICONCEPCION_ENFERMERIA);
        examenFisicoUsuario.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        impresionDiagnosticaUsuarioBean.setCodigoRelacionado3("");
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_ANTICONCEPCION_ENFERMERIA);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        if (rips != null) {
        ...
        metodos.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_ANTICONCEPCION_ENFERMERIA);
        metodos.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        dispositivos.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        // CONDUCTA - AUTORIZACION DE SERVICIOS
         ...
         autorizacionServicioUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        // CONDUCTA - FORMULA MEDICA
              ...
              formulaMedicaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        // CONDUCTA - FORMULA MEDICA
          ...
          vademecumUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaBean");
    ...
    public String irPausarConsultaAnticoncepcionEnfermeria() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irDatosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irMotivoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_ANTICONCEPCION_ENFERMERIA;
    }
    
    public String irCuestionarioCovidAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_ANTICONCEPCION_ENFERMERIA;
        }
    ...
    public String irAntecedentesGeneralesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAntecedentesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAntecedentesTemporalesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAntecedentesGinecologicosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irExamenFisicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irEncuestaViolenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irImpDiagnosticaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irMetodoPlanificacion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_METODO_PLANIFICACION_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAplicacionRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irRecomedacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irControlSinCostoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irFormulaMedicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irRemHospitalizacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irIncapacidadAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irInterConsultaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irAnatPatologicaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irOrdenCirugiaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irReferenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_ANTICONCEPCION_ENFERMERIA;
    }
    /**
     * 
     * @return
    ...
    public String irAutorizacionServicioAnticoncepcion(){
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_AUTORIZACION_SERVICIO_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irReservaSangreAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irCertMedicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irCertAsistenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irExamElectrofisiologicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irExamImagenAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irExamLaboratorioAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irCerrarConsultaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_ANTICONCEPCION_ENFERMERIA;
    }
    ...
    public String irResumenHistoriaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_ANTICONCEPCION_ENFERMERIA;
    }
...
*/
	...
	public String irServiciosAdmisionAnticoncepcionEnfermeria() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_ANTICONCEPCION_ENFERMERIA;
    }
