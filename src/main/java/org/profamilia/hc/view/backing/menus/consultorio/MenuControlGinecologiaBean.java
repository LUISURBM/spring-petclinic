...
public class MenuControlGinecologiaBean extends BaseBean {
    ...
    private boolean renderControlGinecologia;
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL_GINECOLOGIA);
        datosBasicosUsuario.setMenuBean("menuControlGinecologiaBean");
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_CONTROL_GINECOLOGIA);
        cuestionarioCovid.setMenuBean("menuControlGinecologiaBean");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuControlGinecologiaBean");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_GINECOLOGIA);
           registrarEscalaValoracionCaidasBean.init();
          renderControlGinecologia = registrarEscalaValoracionCaidasBean.esValido();
        ...
        // Antecedentes
         ...
         if (!primeraConsulta) {
             ...
             antecedentes.setTipoHistoria(HISTORIA_CONTROL_GINECOLOGIA);
             antecedentes.setUsuario(datosBasicosUsuario.getUsuario());
             antecedentes.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_GINECOLOGIA);
             antecedentes.setMenuBean("menuControlGinecologiaBean");
         ...
         if (primeraConsulta) {
             ...
             antecedentesGenerales.setTipoHistoria(HISTORIA_CONTROL_GINECOLOGIA);
             antecedentesGenerales.setNumeroConsulta(numeroConsulta);
             antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO);
             antecedentesGenerales.setMenuBean("menuControlGinecologiaBean");
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_GINECOLOGIA);
        examenFisicoUsuario.setMenuBean("menuControlGinecologiaBean");
        ...
        control.setTipoHistoria(HISTORIA_CONTROL_GINECOLOGIA);
        control.setNumeroConsulta(numeroConsulta);
        control.setConsecutivo(new Integer("1"));
        control.setLstPatologias(getLstPatologia());
        control.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_GINECOLOGIA);
        control.setMenuBean("menuControlGinecologiaBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        dispositivos.setMenuBean("menuControlGinecologiaBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        anatomiaPatologicaUsuarioBean.inicializarAnatomiaPatol();


        // CONDUCTA - CONTROL_GINECOLOGIA SIN COSTO
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuControlGinecologiaBean");
        ...
        if(motivo != null && motivo.getHmcncausaexte() != null)
         ...
         autorizacionServicioUsuarioBean.setMenuBean("menuControlGinecologiaBean");
    ...
    public String irPausarConsultaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_CONTROL_GINECOLOGIA;
    }
    
    public String irCuestionarioCovidControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL_GINECOLOGIA;
        }
     ...
     * @return
     */
    public String irDatosControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irMotivoControlGinecologia() {
        inicializarUsuario();

        return BeanNavegacion.RUTA_IR_MOTIVO_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irAntecedentesGeneralesControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_CONTROL_GINECOLOGIA; 
    }
     ...
     * @return
     */
    public String irAntecedentesControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irExamenFisicoControlGinecologia() {

        inicializarUsuario();

        return BeanNavegacion.RUTA_IR_EXAMEN_FISICO_CONTROL_GINECOLOGIA;
    }

    /**
     * @return
     */
    public String irImpDiagnosticaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_CONTROL_GINECOLOGIA;
    }


    public String irControlGinecologiaUsuario() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTROL_USUARIO_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irAnatPatologicaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_CONTROL_GINECOLOGIA;
    }
    ...
    public String irAplicacionRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_CONTROL_GINECOLOGIA;
    }

    /**
     * @return
     */
    public String irControlSinCostoControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irFormulaMedicaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_CONTROL_GINECOLOGIA;
    }
         ...
         * @return
         */
        public String irVademecumMedicoControlGinecologia() {
            inicializarUsuario();
            return BeanNavegacion.RUTA_IR_VADEMCUM_CONTROL_GINECOLOGIA;
        }

    /**
     * @return
     */
    public String irRemHospitalizacionControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_CONTROL_GINECOLOGIA;
    }
    
    /**
     * @return
     */
     public String irAutorizacionServicioControlGinecologia(){
         inicializarUsuario();
         return BeanNavegacion.RUTA_IR_AUTORIZACION_SERVICIOS_CONTROL_GINECOLOGIA;
     }
     ...
     * @return
     */
    public String irIncapacidadControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irInterConsultaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irOrdenCirugiaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irReferenciaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_CONTROL_GINECOLOGIA;
    }

    /**
     * @return
     */
    public String irReservaSangreControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irRecomedacionControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irCertMedicoControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_CONTROL_GINECOLOGIA;
    }

    /**
     * @return
     */
    public String irCertAsistenciaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_CONTROL_GINECOLOGIA;
    }

    /**
     * @return
     */
    public String irExamElectrofisiologicoControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_CONTROL_GINECOLOGIA;
    }

    /**
     * @return
     */
    public String irExamImagenControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_CONTROL_GINECOLOGIA;
    }

    /**
     * @return
     */
    public String irExamLaboratorioControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_CONTROL_GINECOLOGIA;
    }


    public String irCerrarConsultaControlGinecologia() {
        if (cerrarConsultaUsuarioBean != null) {
            cerrarConsultaUsuarioBean.inicalizarCerrarConsultaBean();
        }
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERRAR_CONTROL_GINECOLOGIA;
    }

    /**
     * @return
     */
    public String irResumenHistoriaEspecificaControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irResumenHistoriaControlGinecologia() {
        inicializarUsuario();
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_CONTROL_GINECOLOGIA;
    }
	...
	public String irServiciosAdmisionControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_CONTROL_GINECOLOGIA;
    }
    ...
    public String irOrdenLiquidosControlGinecologia() {
        return BeanNavegacion.RUTA_IR_ORDEN_LIQUIDOS_CONTROL_GINECOLOGIA;
    }
    
    public String irRegistrarOtrasOrdenesControlGinecologia() {
        return BeanNavegacion.RUTA_IR_OTRAS_ORDENES_CONTROL_GINECOLOGIA;
    }
    
    public String irOrdenMedicamentosControlGinecologia() {
        return BeanNavegacion.RUTA_IR_ORDEN_MEDICAMENTOS_CONTROL_GINECOLOGIA;
    }
     ...
     * @return
     */
    public String irEscalaValoracionCaidasControlGinecologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_CONTROL_GINECOLOGIA;
    }
    ...
    public void setRenderControlGinecologia(boolean renderControlGinecologia) {
        this.renderControlGinecologia = renderControlGinecologia;
    }

    public boolean isRenderControlGinecologia() {
        return renderControlGinecologia;
    }
