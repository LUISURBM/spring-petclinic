...
//=======================================================================
public class ReporteControlCitologiasBean extends BaseBean implements JRDataSource {
    ...
    public ReporteControlCitologiasBean() {
    }
    ...
    public void generarListaEntregaPDF() {
        index = -1;
        generoReporte_CE = false;
        try {
             listaCitologias = 
