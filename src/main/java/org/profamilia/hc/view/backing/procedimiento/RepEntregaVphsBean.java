//=======================================================================
// ARCHIVO RepEntregaVphsBean.java
...
//=======================================================================
//  CLASE RepEntregaVphsBean
//=======================================================================
public class RepEntregaVphsBean extends BaseBean implements JRDataSource {
    ...
    public Object getFieldValue(JRField jrField) {
        ...
        Object[] reporte = new Object[listaVphs.size()];
        reporte = (Object[])listaVphs.get(index);
            ...
            if (this.tipoReporte.equalsIgnoreCase("CE")) {
                ...
                if (listaVphs.isEmpty()) {
                    ...
                    try {
                       ...
                       URL url = FacesUtils.getFacesContext().getExternalContext().getResource("/reports/reporteVphsEntregas.jasper");
                ...
                if (listaVphs.isEmpty()) {
                    ...
                    try {
                       ...
                       URL url = FacesUtils.getFacesContext().getExternalContext().getResource("/reports/reporteSeguimientoVphs.jasper");
