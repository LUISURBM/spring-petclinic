//=======================================================================
// ARCHIVO InformeCitopuncionSeno.java
// FECHA CREACI�N: 09/06/2010
// AUTOR: Jos� Andr�s Riano
// Descripci�n: Datos correspondientes al Informe de Citopuncion
//=======================================================================
...
//=======================================================================
//  CLASE InformeCitopuncionSeno
//=======================================================================
public class InformeCitopuncionSeno extends BaseBean implements JRDataSource {
    ...
    public InformeCitopuncionSeno() {
    }

    public void init() {
        inicializarCitopuncion();
    }

    public void inicializarCitopuncion() {
        generoInforme = false;
        try {
            if (consulta != null) {
                informe = 
                        serviceLocator.getClinicoService().getInformeMamografia(consulta, 
                                                                                IConstantes.INFORME_CITOPUNCION_SENO);
            }
    ...
    public String generarCitopuncion() {
        ...
        if (consulta != null && consulta.getCconnumero() != null) {
            ...
            id.setHimctipoinform(IConstantes.INFORME_CITOPUNCION_SENO);
        ...
        if (informe == null || informe.getHimcinformamog() == null || 
            ...
            wexito = false;
            navigationRule = "";
            FacesUtils.addErrorMessage("body:formInformeCitopuncion:panelTabInformeCitopuncion:itInformeCitopuncion", 
        ...
        if (wexito) {
            ...
            try {
                obtenerDatosReporte();
               URL url = FacesUtils.getFacesContext().getExternalContext().getResource("/reports/informeCitopuncionSeno.jasper");
