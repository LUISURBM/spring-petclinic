...
public class ConsultarUsuarioPAPsicologiaBean extends BaseBean {
    ...
    ConsultarFoliosPAPsicologiaBean cosultaFolios;

    private boolean existenCriterios;


    public ConsultarUsuarioPAPsicologiaBean() {
    }
    ...
    public String consultarNotaMedica() {
        ...
        if (usuarioClon != null) {
            cosultaFolios = 
                    (ConsultarFoliosPAPsicologiaBean)FacesUtils.getManagedBean("consultarFoliosPAPsicologiaBean");

            if (cosultaFolios != null) {
                cosultaFolios.setUsuario(usuarioClon);
                return BeanNavegacion.RUTA_CONSULTAR_FOLIOS_PAPSICOLOGIA;
            }
        }
        return null;
    }
