//=======================================================================
// ARCHIVO RegistrarMedicamentosBean
// FECHA CREACI�N: 
// AUTOR: jariano, nlis
// Descripcion: 
//=======================================================================
...
//=================================================================
//  CLASE RegistrarMedicamentosBean
//=======================================================================
public class RegistrarMedicamentosBean extends BaseBean {
    //-----------------------------------------------------------------------
    ...
    public RegistrarMedicamentosBean() {
    }
    ...
    public String volver() {
        ...
        FacesUtils.resetManagedBean("registrarMedicamentosBean");
    ...
    public String administrarMedicamento() {
        ...
        if (controlBean != null && formulaSelect != null) {
            ...
            controlBean.setNavegationRule(BeanNavegacion.RUTA_IR_REGISTRO_MEDICAMENTOS);
            controlBean.setEsIngreso(false);
            controlBean.init();
        }
