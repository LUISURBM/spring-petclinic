...
public class MenuHistoriaUrologiaBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_UROLOGIA);
        
        
        
        datosBasicosUsuario.setMenuBean("menuHistoriaUrologiaBean");
       ...
       if(IConstantes.ACTIVAR_PAUSAR_CONSULTA){
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_UROLOGIA);
        cuestionarioCovid.setMenuBean("menuHistoriaUrologiaBean");
        ...
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_PARACLINICOS_UROLOGIA);
        motivoConsulta.setMenuBean("menuHistoriaUrologiaBean");
       ...
       /* if (datosBasicosUsuario != null && 
        ...
        //PARACLINICOS
            ...
            paraclinicos.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_UROLOGIA);
             if (primeraConsulta) {
              paraclinicos.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_UROLOGIA);
              }
            paraclinicos.setMenuBean("menuHistoriaUrologiaBean");
        ...
        if (!primeraConsulta) {
            ...
            antecedentes.setTipoHistoria(HISTORIA_UROLOGIA);
            antecedentes.setUsuario(datosBasicosUsuario.getUsuario());
            antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_UROLOGIA);
            antecedentes.setMenuBean("menuHistoriaUrologiaBean");
            if (sexo != null  && sexo.equals(SEXO_MASCULINO) ) {
                antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_UROLOGIA);
        ...
        if (primeraConsulta) {
            ...
            antecedentesGenerales.setTipoHistoria(HISTORIA_UROLOGIA);
            antecedentesGenerales.setNumeroConsulta(numeroConsulta);
            antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_UROLOGIA);
            antecedentesGenerales.setMenuBean("menuHistoriaUrologiaBean");
            if (sexo != null && sexo.equals(SEXO_MASCULINO)) {
                antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_UROLOGIA);
        ...
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_UROLOGIA);
        antecedentesGinecologicos.setMenuBean("menuHistoriaUrologiaBean");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_UROLOGIA);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaUrologiaBean");
        ...
        // ENCUESTA DE VIOLENCIA SIVIGILA
         ...
         encuestaViolenciaSivigila.setMenuBean("menuHistoriaUrologiaBean");
         if(datosBasicosUsuario != null && datosBasicosUsuario.getUsuario() != null &&datosBasicosUsuario.getUsuario().getHuslnumero()!= null )
        ...
        if (datosBasicosUsuario != null && 
            ...
            registrarEscalaValoracionCaidasBean.setMenuBean("menuHistoriaUrologiaBean");
            registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_UROLOGIA);
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_UROLOGIA);
        examenFisicoUsuario.setMenuBean("menuHistoriaUrologiaBean");
        ...
        impresionDiagnosticaUsuarioBean.setCodigoRelacionado3("");
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_UROLOGIA);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        impresionDiagnosticaUsuarioBean.setDesHabilitarDiagnosticoPrincipal(false);
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        vademecumUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        autorizacionServicioUsuarioBean.setCodigoDiagnostico2(impresionDiagnosticaUsuarioBean.getImpresion().getHidcdiagrela3());
         autorizacionServicioUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaUrologia Bean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaUrologiaBean");
     ...
     * @return
     */
    public String irDatosUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_UROLOGIA;
    }

    /**
     * @return
     */
    public String irMotivoUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_UROLOGIA;
    }




    public String irViolenciaSivigilaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_SIVIGILA_UROLOGIA;
    }
    /**
     * @return
     */
    public String irAntecedentesGeneralesUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_UROLOGIA;
    }
     ...
     * @return
     */
    public String irAntecedentesUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_UROLOGIA;
    }
    
    public String irCuestionarioCovidUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_UROLOGIA;
        }
     ...
     * @return
     */
    public String irAntecedentesGinecologicosUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_UROLOGIA;
    }
...
public String irParaclinicosUrologia (){
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PARACLINICOS_UROLOGIA;
}
     ...
     * @return
     */
    public String irExamenFisicoUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_UROLOGIA;
    }
     ...
     * @return
     */
    public String irEncuestaViolenciaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_UROLOGIA;
    }
     ...
     * @return
     */
    public String irImpDiagnosticaUrologia () {

        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_UROLOGIA;
    }

    /**
     * @return
     */
    public String irAnatPatologicaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_UROLOGIA;
    }

    /**
     * @return
     */
    public String irControlSinCostoUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_UROLOGIA;
    }
     ...
     * @return
     */
    public String irFormulaMedicaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_UROLOGIA;
    }
    
    /**
     * @return
     */
    public String irVademecumMedicoUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_VADEMCUM_UROLOGIA;
    }

    /**
     * @return
     */
    public String irRemHospitalizacionUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_UROLOGIA;
    }
     ...
     * @return
     */
    public String irIncapacidadUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_UROLOGIA;
    }
    
    public String irConfirmarInsumosUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONFIRMAR_INSUMOS_UROLOGIA;
    }
    
    public String irPausarConsultaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_UROLOGIA;
    }
     ...
     * @return
     */
    public String irInterConsultaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_UROLOGIA;
    }
     ...
     * @return
     */
    public String irOrdenCirugiaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_UROLOGIA;
    }
     ...
     * @return
     */
    public String irReferenciaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_UROLOGIA;
    }
     ...
     * @return
     */
     public String irAutorizacionServicioUrologia (){
         inicializarUsuario();
         return BeanNavegacion.RUTA_IR_AUTORIZACION_SERVICIOS_UROLOGIA;
     }
     ...
     * @return
     */
    public String irReservaSangreUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_UROLOGIA;
    }
     ...
     * @return
     */
    public String irRecomedacionUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_UROLOGIA;
    }
     ...
     * @return
     */
    public String irCertMedicoUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_UROLOGIA;
    }

    /**
     * @return
     */
    public String irCertAsistenciaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_UROLOGIA;
    }

    /**
     * @return
     */
    public String irExamElectrofisiologicoUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_UROLOGIA;
    }

    /**
     * @return
     */
    public String irExamImagenUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_UROLOGIA;
    }

    /**
     * @return
     */
    public String irExamLaboratorioUrologia () {
        inicializarUsuario();

        return BeanNavegacion.RUTA_IR_LABORATORIO_UROLOGIA;
    }
     ...
     * @return
     */
    public String irCerrarConsultaUrologia () {
        if (cerrarConsultaUsuarioBean != null) {
            cerrarConsultaUsuarioBean.inicalizarCerrarConsultaBean();
        }
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_UROLOGIA;
    }
     ...
     * @return
     */
    public String irOrdenMedicamentosUrologia () {
        return BeanNavegacion.RUTA_IR_ORDEN_MEDICAMENTOS_UROLOGIA; 
    }

    /**
     * @return
     */
    public String irOrdenLiquidosUrologia () {
        
        return BeanNavegacion.RUTA_IR_ORDEN_LIQUIDOS_UROLOGIA;
    }
    
    public String irRegistrarOtrasOrdenesUrologia () {
        return BeanNavegacion.RUTA_IR_OTRAS_ORDENES_UROLOGIA;
    }
     ...
     * @return
     */
    public String irResumenHistoriaEspecificaUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_UROLOGIA;
    }

    /**
     * @return
     */
    public String irResumenHistoriaUrologia () {

        inicializarUsuario();

        CerrarConsultaUsuarioBean cerrarConsultaUrologia  = 
            (CerrarConsultaUsuarioBean)FacesUtils.getManagedBean("cerrarConsultaUsuarioBean");
        cerrarConsultaUrologia .inicalizarCerrarConsultaBean();
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_UROLOGIA;
    }
     ...
     * @return
     */
    public String irEscalaValoracionCaidasUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_UROLOGIA;
    }
    ...
    public String irServiciosAdmisionUrologia () {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_UROLOGIA;
    }
    ...
    if(lstPatologia == null || lstPatologia.isEmpty()){
        lstPatologia = new ArrayList<SelectItem>();
            ...
            lstPatologia.add(new SelectItem("PR","Pr�stata"));
            lstPatologia.add(new SelectItem("PE","Pene"));
