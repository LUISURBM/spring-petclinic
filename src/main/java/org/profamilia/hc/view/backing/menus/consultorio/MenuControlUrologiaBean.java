...
public class MenuControlUrologiaBean extends BaseBean {
    ...
    private boolean renderControlUrologia;
   ...
   private List<SelectItem> lstPatologia;
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL_UROLOGIA);
        datosBasicosUsuario.setMenuBean("menuControlUrologiaBean");
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_CONTROL_UROLOGIA);
        cuestionarioCovid.setMenuBean("menuControlUrologiaBean");
        ...
        if (datosBasicosUsuario != null &&
           ...
           registrarEscalaValoracionCaidasBean.setMenuBean("menuControlUrologiaBean");
           registrarEscalaValoracionCaidasBean.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_UROLOGIA);
           registrarEscalaValoracionCaidasBean.init();
          renderControlUrologia = registrarEscalaValoracionCaidasBean.esValido();
        ...
        // Antecedentes
         ...
         if (!primeraConsulta) {
             ...
             antecedentes.setTipoHistoria(HISTORIA_CONTROL_UROLOGIA);
             antecedentes.setUsuario(datosBasicosUsuario.getUsuario());
             antecedentes.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_UROLOGIA);
             antecedentes.setMenuBean("menuControlUrologiaBean");
         ...
         if (primeraConsulta) {
             ...
             antecedentesGenerales.setTipoHistoria(HISTORIA_CONTROL_UROLOGIA);
             ...
             antecedentesGenerales.setMenuBean("menuControlUrologiaBean");
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_UROLOGIA);
        examenFisicoUsuario.setMenuBean("menuControlUrologiaBean");
        ...
        control.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_UROLOGIA);
        control.setMenuBean("menuControlUrologiaBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        dispositivos.setMenuBean("menuControlUrologiaBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuControlUrologiaBean");
        anatomiaPatologicaUsuarioBean.inicializarAnatomiaPatol();


        // CONDUCTA - CONTROL_UROLOGIA SIN COSTO
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuControlUrologiaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuControlUrologiaBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuControlUrologiaBean");
        ...
        if(motivo != null && motivo.getHmcncausaexte() != null)
         ...
         autorizacionServicioUsuarioBean.setMenuBean("menuControlUrologiaBean");
    ...
    public String irPausarConsultaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_CONTROL_UROLOGIA;
    }
    
    public String irCuestionarioCovidControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_CONTROL_UROLOGIA;
        }
     ...
     * @return
     */
    public String irDatosControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irMotivoControlUrologia() {
        inicializarUsuario();

        return BeanNavegacion.RUTA_IR_MOTIVO_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irAntecedentesGeneralesControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_CONTROL_UROLOGIA; 
    }
     ...
     * @return
     */
    public String irAntecedentesControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irExamenFisicoControlUrologia() {

        inicializarUsuario();

        return BeanNavegacion.RUTA_IR_EXAMEN_FISICO_CONTROL_UROLOGIA;
    }

    /**
     * @return
     */
    public String irImpDiagnosticaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_CONTROL_UROLOGIA;
    }


    public String irControlUrologiaUsuario() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTROL_USUARIO_UROLOGIA;
    }
     ...
     * @return
     */
    public String irAnatPatologicaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_CONTROL_UROLOGIA;
    }
    ...
    public String irAplicacionRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_CONTROL_UROLOGIA;
    }

    /**
     * @return
     */
    public String irControlSinCostoControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irFormulaMedicaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_CONTROL_UROLOGIA;
    }
         ...
         * @return
         */
        public String irVademecumMedicoControlUrologia() {
            inicializarUsuario();
            return BeanNavegacion.RUTA_IR_VADEMCUM_CONTROL_UROLOGIA;
        }

    /**
     * @return
     */
    public String irRemHospitalizacionControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_CONTROL_UROLOGIA;
    }
    
    /**
     * @return
     */
     public String irAutorizacionServicioControlUrologia(){
         inicializarUsuario();
         return BeanNavegacion.RUTA_IR_AUTORIZACION_SERVICIOS_CONTROL_UROLOGIA;
     }
     ...
     * @return
     */
    public String irIncapacidadControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irInterConsultaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irOrdenCirugiaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irReferenciaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_CONTROL_UROLOGIA;
    }

    /**
     * @return
     */
    public String irReservaSangreControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irRecomedacionControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irCertMedicoControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_CONTROL_UROLOGIA;
    }

    /**
     * @return
     */
    public String irCertAsistenciaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_CONTROL_UROLOGIA;
    }

    /**
     * @return
     */
    public String irExamElectrofisiologicoControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_CONTROL_UROLOGIA;
    }

    /**
     * @return
     */
    public String irExamImagenControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_CONTROL_UROLOGIA;
    }

    /**
     * @return
     */
    public String irExamLaboratorioControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_CONTROL_UROLOGIA;
    }


    public String irCerrarConsultaControlUrologia() {
        if (cerrarConsultaUsuarioBean != null) {
            cerrarConsultaUsuarioBean.inicalizarCerrarConsultaBean();
        }
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERRAR_CONTROL_UROLOGIA;
    }

    /**
     * @return
     */
    public String irResumenHistoriaEspecificaControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irResumenHistoriaControlUrologia() {
        inicializarUsuario();
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_CONTROL_UROLOGIA;
    }
	...
	public String irServiciosAdmisionControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_CONTROL_UROLOGIA;
    }
    ...
    public String irOrdenLiquidosControlUrologia() {
        return BeanNavegacion.RUTA_IR_ORDEN_LIQUIDOS_CONTROL_UROLOGIA;
    }
    
    public String irRegistrarOtrasOrdenesControlUrologia() {
        return BeanNavegacion.RUTA_IR_OTRAS_ORDENES_CONTROL_UROLOGIA;
    }
    
    public String irOrdenMedicamentosControlUrologia() {
        return BeanNavegacion.RUTA_IR_ORDEN_MEDICAMENTOS_CONTROL_UROLOGIA;
    }
     ...
     * @return
     */
    public String irEscalaValoracionCaidasControlUrologia() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ESCALA_VALORACION_CAIDAS_CONTROL_UROLOGIA;
    }
    ...
    public void setRenderControlUrologia(boolean renderControlUrologia) {
        this.renderControlUrologia = renderControlUrologia;
    }

    public boolean isRenderControlUrologia() {
        return renderControlUrologia;
    }
