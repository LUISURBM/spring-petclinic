...
public class ConfirmarCirugiaSinFacturaBean extends BaseBean {
    ...
    public ConfirmarCirugiaSinFacturaBean() {
    ...
    public void init() {
        ...
        if(numeroCirugia!= null){
            ...
            try {
                regcirpro = serviceLocator.getCirugiaService().getCirsinfacByNumero(numeroCirugia);
    ...
    public String confirmarCirugia() {
        ...
        navegationRule = ""; 
        if (regcirpro == null || regcirpro.getHrcnnumfac() == null || regcirpro.getHrcnnumfac().intValue() == 0) {
        ...
        if (wexito) {
            try {    
                regcirpro.setHrcnconfac(this.serviceLocator.getCirugiaService().getNumeroConsultaClinicaPorDocumento(regcirpro.getHrcnclinic().getCclncodigo(),IConstantes.CDOC_FACSAP,regcirpro.getHrcnnumfac(),regcirpro.getHrccservic().getCsvccodigo())); 
            } catch (ModelException e) {
                wexito = false;
                e.printStackTrace();
            }
        ...
        if (wexito) {
            ...
            try {    
                wconini = this.serviceLocator.getCirugiaService().getNumeroConsultaClinicaPorDocumento(regcirpro.getHrcnclinic().getCclncodigo(),IConstantes.CDOC_CISFAC,new BigDecimal(regcirpro.getHrcnnumero()),regcirpro.getHrccservic().getCsvccodigo()); 
            } catch (ModelException e) {
                wexito = false;
                e.printStackTrace();
            }
        ...
        if (wexito) {
           try {
               ...
               navegationRule = BeanNavegacion.RUTA_IR_LISTA_CIRUGIA_SIN_FACTURA;
           } catch (ModelException e) {
               navegationRule =  "";
