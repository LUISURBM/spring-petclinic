...
public class MenuHistoriaAnticoncepcionEnfermeriaRetiro extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_ENFERMERIA_RETIRO);
        datosBasicosUsuario.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
...
this.serviceLocator.getClinicoService().getParametrosRipsXClinica(datosBasicosUsuario.getConsulta());
        ...
        cuestionarioCovid.setNextAction(BeanNavegacion.RUTA_IR_MOTIVO_ANTICONCEPCION_ENFERMERIA_RETIRO);
        cuestionarioCovid.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_ANTICONCEPCION_ENFERMERIA_RETIRO);
        if (primeraConsulta) {
            motivoConsulta.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ANTICONCEPCION_ENFERMERIA_RETIRO);
        }

        motivoConsulta.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        if (primeraConsulta) {
            ...
            antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_ENFERMERIA_RETIRO);
            antecedentesGenerales.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
            antecedentesGenerales.inicializarAntecedentes();
            if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
                antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_ENFERMERIA_RETIRO);
            ...
            antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_ENFERMERIA_RETIRO);
            antecedentes.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
            antecedentes.inicializarAntecedentes();
            if (sexo != null && (sexo.equals(SEXO_MASCULINO) ||  sexo.equals(SEXO_TRANSEXUAL) || sexo.equals(SEXO_AMBIGUO) )) {
                antecedentes.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_ENFERMERIA_RETIRO);
        ...
        antecedentesTemporales.setNextAction(BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_ANTICONCEPCION_ENFERMERIA_RETIRO);
        antecedentesTemporales.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        if (antecedentesTemporales != null && 
            antecedentesTemporales.getCuestionario() != null) {
            fechaUltimoParto = 
                    antecedentesTemporales.getCuestionario().getHcpdfechaparto();
            fechaUltimaRegla = 
                    antecedentesTemporales.getCuestionario().getHcpdfechultmes();
        }
        ...
        antecedentesGinecologicos.setNextAction(BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_ENFERMERIA_RETIRO);
        antecedentesGinecologicos.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        encuestaViolenciaUsuario.setNextAction(BeanNavegacion.RUTA_IR_EXAMENFISICO_ANTICONCEPCION_ENFERMERIA_RETIRO);
        encuestaViolenciaUsuario.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ANTICONCEPCION_ENFERMERIA_RETIRO);
        examenFisicoUsuario.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        impresionDiagnosticaUsuarioBean.setCodigoRelacionado3("");
        impresionDiagnosticaUsuarioBean.setNextAction(BeanNavegacion.RUTA_IR_APLICACION_RETITO_ANTICONCEPCION_ENFERMERIA_RETIRO);
        impresionDiagnosticaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        if (rips != null) {
        ...
        dispositivos.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_ANTICONCEPCION_ENFERMERIA_RETIRO);
        dispositivos.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        recomedacionUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
       ...
       formulaMedicaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
       formulaMedicaUsuarioBean.inicializardFormulaMedica();
        ...
        // CONDUCTA - FORMULA MEDICA
            ...
            vademecumUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        if (datosBasicosUsuario.getConsulta() != null) {
        ...
        interConsultaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        referenciaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        // CONDUCTA - AUTORIZACION DE SERVICIOS
         ...
         autorizacionServicioUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        certMedicoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        examImagenUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuHistoriaAnticoncepcionEnfermeriaRetiro");
    ...
    public String irPausarConsultaAnticoncepcionEnfermeriaRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_PAUSAR_CONSULTA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irDatosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irMotivoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_MOTIVO_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    
    public String irCuestionarioCovidAnticoncepcionEnfermeriaRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CUESTIONARIO_COVID_ENFERMERIA_RETIRO;
        }
    ...
    public String irAntecedentesGeneralesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irAntecedentesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irAntecedentesTemporalesAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_TEMPORALES_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irAntecedentesGinecologicosAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GINECOLOGICOS_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irExamenFisicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_EXAMENFISICO_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irEncuestaViolenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ENCUESTA_VIOLENCIA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irImpDiagnosticaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irCerrarConsultaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_CERRAR_CONSULTA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irResumenHistoriaAnticoncepcion() {
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irAnatPatologicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }


    public String irAplicacionRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irControlSinCostoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irFormulaMedicaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
        ...
        public String irVademecumMedicoAnticoncepcion() {
            inicializarUsuario();
            return BeanNavegacion.RUTA_IR_VADEMCUM_ANTICONCEPCION_ENFERMERIA_RETIRO;
        }
    ...
    public String irRemHospitalizacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irIncapacidadAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irInterConsultaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irOrdenCirugiaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irReferenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irAutorizacionServicioAnticoncepcion(){
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_AUTORIZACION_SERVICIO_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irReservaSangreAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irRecomedacionAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irCertMedicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irCertAsistenciaAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irExamElectrofisiologicoAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irExamImagenAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
    ...
    public String irExamLaboratorioAnticoncepcion() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
...
*/
	...
	public String irServiciosAdmisionAnticoncepcionEnfermeriaRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_ANTICONCEPCION_ENFERMERIA_RETIRO;
    }
