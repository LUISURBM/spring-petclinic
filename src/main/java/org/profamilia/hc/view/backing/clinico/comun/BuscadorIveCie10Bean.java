...
public class BuscadorIveCie10Bean extends BaseBean {
    ...
    private boolean wbloquearZ;

    private int firstRow;

    public BuscadorIveCie10Bean() {
    }
    ...
    public void consultarCie10() {
        ...
        try {
            listCIE10 = 
                    this.getServiceLocator().getClinicoService().getCriteriosIveCie10(cie10,wbloquearZ);
    ...
    public void setWbloquearZ(boolean wbloquearZ) {
        this.wbloquearZ = wbloquearZ;
    }

    public boolean isWbloquearZ() {
        return wbloquearZ;
    }
}
