...
public class MenuControlEntregaResultadoBean extends BaseBean {
    ...
    public void init() {
        ...
        datosBasicosUsuario.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO);
        datosBasicosUsuario.setMenuBean("menuControlEntregaResultadoBean");
        ...
        // Antecedentes
         ...
         if (!primeraConsulta) {
             ...
             antecedentes.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO);
             antecedentes.setMenuBean("menuControlEntregaResultadoBean");
         ...
         if (primeraConsulta) {
             ...
             antecedentesGenerales.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO);
             antecedentesGenerales.setMenuBean("menuControlEntregaResultadoBean");
        ...
        examenFisicoUsuario.setNextAction(BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO);
        examenFisicoUsuario.setMenuBean("menuControlEntregaResultadoBean");
        ...
        control.setNextAction(BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_ENTREGA_RESULTADO);
        control.setMenuBean("menuControlEntregaResultadoBean");
        ...
        recomedacionUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        dispositivos.setMenuBean("menuControlEntregaResultadoBean");
        ...
        anatomiaPatologicaUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        controlSinCostoUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        formulaMedicaUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        hospitalizacionUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        ordenCirugiaUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        interConsultaUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        incapacidadUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        referenciaUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        reservaSangreUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        certMedicoUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        certAsistenciaUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        examElectrofisiologicoUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        examImagenUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        ...
        examLaboratorioUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
        if (datosBasicosUsuario.getConsulta() != null) {
            Long tipoDocuentoAdmision = 
                datosBasicosUsuario.getConsulta().getCcontipdoc().getCtdnnumero().longValue();
            if (tipoDocuentoAdmision == IConstantes.TIPO_DOCUMENTO_ADMISION) {
        ...
        cerrarConsultaUsuarioBean.setMenuBean("menuControlEntregaResultadoBean");
    ...
    public String irDatosControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_DATOS_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irMotivoControl() {
        ...
        return BeanNavegacion.RUTA_IR_MOTIVO_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irAntecedentesGeneralesControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_GENERALES_CONTROL_ENTREGA_RESULTADO; 
    }
    ...
    public String irAntecedentesControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANTECEDENTES_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irExamenFisicoControl() {
        ...
        return BeanNavegacion.RUTA_IR_EXAMEN_FISICO_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irImpDiagnosticaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMPRESION_DIAGNOSTICA_CONTROL_ENTREGA_RESULTADO;
    }


    public String irControlUsuario() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTROL_USUARIO_ENTREGA_RESULTADO;
    }
    ...
    public String irAnatPatologicaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ANATOMIAPATOLOGICA_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irAplicacionRetiro() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_APLICACION_RETITO_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irControlSinCostoControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CONTOLSINCOSTO_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irFormulaMedicaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_FORMULAMEDICA_CONTROL_ENTREGA_RESULTADO;
    }
        ...
        public String irVademecumMedicoControl() {
            inicializarUsuario();
            return BeanNavegacion.RUTA_IR_VADEMCUM_CONTROL_ENTREGA_RESULTADO;
        }
    ...
    public String irRemHospitalizacionControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_HOSPITALZACION_CONTROL_ENTREGA_RESULTADO;
    }
     ...
     */
     public String irAutorizacionServicioControl(){
         inicializarUsuario();
         return BeanNavegacion.RUTA_IR_AUTORIZACION_SERVICIOS_CONTROL_ENTREGA_RESULTADO;
     }
    ...
    public String irIncapacidadControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INCAPACIDAD_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irInterConsultaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_INTERCONSULTA_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irOrdenCirugiaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ORDENCIRUGIA_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irReferenciaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_REFERENCIA_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irReservaSangreControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESERVA_SANGRE_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irRecomedacionControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RECOMENDACIONES_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irCertMedicoControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADOMEDICO_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irCertAsistenciaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERTIFICADO_ASISTENCIA_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irExamElectrofisiologicoControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_ELECTROFISIOLOGICO_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irExamImagenControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_IMAGENES_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irExamLaboratorioControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_LABORATORIO_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irCerrarConsultaControl() {
        ...
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_CERRAR_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irResumenHistoriaEspecificaControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_ESPECIFICA_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irResumenHistoriaControl() {
        ...
        return BeanNavegacion.RUTA_IR_RESUMEN_HISTORIA_CONTROL_ENTREGA_RESULTADO;
    }
	...
	public String irServiciosAdmisionControl() {
        inicializarUsuario();
        return BeanNavegacion.RUTA_IR_SERVICIOS_ADMISION_CONTROL_ENTREGA_RESULTADO;
    }
    ...
    public String irOrdenLiquidosControl() {
        return BeanNavegacion.RUTA_IR_ORDEN_LIQUIDOS_CONTROL_ENTREGA_RESULTADO;
    }
    
    public String irOrdenMedicamentosControl() {
        return BeanNavegacion.RUTA_IR_ORDEN_MEDICAMENTOS_CONTROL_ENTREGA_RESULTADO;
    }
