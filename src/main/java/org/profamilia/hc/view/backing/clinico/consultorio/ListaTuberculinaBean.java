...
//=======================================================================
public class ListaTuberculinaBean extends BaseBean {
    ...
    public String atenderUsuario() {
        ...
        if (servicio.getCsvntiphis().equals(IConstantes.HISTORIA_TOMA_TUBERCULINA)) {

            FacesUtils.resetManagedBean("menuTuberculinaBean");
            ...
            DatosBasicosUsuarioBean datosBasicosUsuario = 
             ...
             if (usuario != null) {
                ...
                datosBasicosUsuario.setTipoHistoria(HISTORIA_TOMA_TUBERCULINA);
                datosBasicosUsuario.inicializarUsuario();
            }

            rutaNavegacion = BeanNavegacion.RUTA_IR_DATOS_TUBERCULINA; 
        }
    ...
    public void changeConsultas() {
        if (fechaActual != null && getClinica() != null) {
            ...
            try {
                this.lstUsuarios = 
                        this.serviceLocator.getClinicoService().getConsultasTuberculinaDia(fechaActual, 
