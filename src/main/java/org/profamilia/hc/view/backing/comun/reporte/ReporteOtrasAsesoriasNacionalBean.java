...
public class ReporteOtrasAsesoriasNacionalBean extends BaseBean implements JRDataSource {
    ...
    public ReporteOtrasAsesoriasNacionalBean() {
    }
     ...
     */
     public void aceptar() {
         ...
         index = -1;
         try {
             lstAsesoria =   this.serviceLocator.getClinicoService().getListaOtrasAsesorias(fechaInicial,fechaFinal,null);
         ...
         if (lstAsesoria == null || lstAsesoria.isEmpty()) {
             ...
             try {
                 ...
                 URL url = 
                     FacesUtils.getFacesContext().getExternalContext().getResource("/reports/ReportAsesoriaNormalNacional.jasper");
                 ...
                 if (url != null) {
                     ...
                     JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(lstAsesoria);
