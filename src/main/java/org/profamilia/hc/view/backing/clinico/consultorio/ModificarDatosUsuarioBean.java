 ...
 * @author nlis
 */
public class ModificarDatosUsuarioBean extends BaseBean {
    ...
    public ModificarDatosUsuarioBean() {
    }
    ...
    public void setPaisSelect(ValueChangeEvent valueChangeEvent) {
        setPaisSelect((String)valueChangeEvent.getNewValue());
    ...
    public String guardarUsuario() {
        ...
        if (paisSelect != null) {
            usuario.setHuscpaisresi(paisSelect);
        }
