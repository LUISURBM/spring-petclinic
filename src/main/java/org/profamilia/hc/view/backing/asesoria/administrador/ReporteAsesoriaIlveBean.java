...
public class ReporteAsesoriaIlveBean extends BaseBean implements JRDataSource {
    ...
    public ReporteAsesoriaIlveBean() {
        init();
    }
    ...
    public String generarAsesoriaIlve() {
        ...
        try {
            lstReporte = 
                    this.serviceLocator.getClinicoService().getReporteAsesoraIlve(wcodclin, 
                                                                                  fechaInicial, 
                                                                                  fechaFinal);
        } catch (ModelException e) {
        ...
        if (lstReporte == null || lstReporte.isEmpty()) {
            ...
            try {
                ...
                URL url = 
                    FacesUtils.getFacesContext().getExternalContext().getResource("/reports/reporteAsesoriasIlve.jasper");
