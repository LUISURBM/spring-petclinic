...
public class ConsultarUsuarioNotaMedicaBean extends BaseBean {
    ...
    ConsultarFoliosNotaBean cosultaFolios;

    private boolean existenCriterios;


    public ConsultarUsuarioNotaMedicaBean() {
    }
    ...
    public String consultarNotaMedica() {
        ...
        if (usuarioClon != null) {
            cosultaFolios = 
                    (ConsultarFoliosNotaBean)FacesUtils.getManagedBean("consultarFoliosNotaBean");

            if (cosultaFolios != null) {
                cosultaFolios.setUsuario(usuarioClon);
                return BeanNavegacion.RUTA_CONSULTAR_FOLIOS;
            }
        }
        return null;
    }
