...
public class BuscadorCirugiasBean extends BaseBean {
    ...
    private List<Cpservicio> lstCirugiaSelec;

    private HtmlDataTable dtCirugiasSelec;

    public BuscadorCirugiasBean() {
    }

    public void init() {
        servicio = new Cpservicio();
        lstExamenesCirugias = new ArrayList();
        lstCirugiaSelec = new ArrayList<Cpservicio>();
    }
    ...
    public void setLstCirugiaSelec(List<Cpservicio> lstCirugiaSelec) {
        this.lstCirugiaSelec = lstCirugiaSelec;
    }

    public List<Cpservicio> getLstCirugiaSelec() {
