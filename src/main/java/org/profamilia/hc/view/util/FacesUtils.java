...
public class FacesUtils {
    ...
    /**
     * Add error message to a sepcific client, summary and detail.
     * 
     * @param clientId the client id
    ...
    /**
     * Verifica si el componente tiene alg�n valor
     * 
     * @param menu Componente que se va a validar
     * @param valor Indica la constante vac�a
        ...
        if (menu != null) {
            if (menu.getValue() != null) {
                if (menu.getValue().getClass().getName().equals("java.lang.String")) {
                    if (!((String)menu.getValue()).equals(valor)) {
                        return true;
                    } else {
                        return false;
                    }
