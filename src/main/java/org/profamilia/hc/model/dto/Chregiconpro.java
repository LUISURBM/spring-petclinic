...
public class Chregiconpro implements Serializable {
    ...
    public void setWservic(String wservic) {
        this.wservic = wservic;
    }

    public String getWservic() {
        return wservic;
    }
}
