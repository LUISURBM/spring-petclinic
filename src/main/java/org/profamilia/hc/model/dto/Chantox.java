...
public class Chantox implements Serializable {
    ...
    /** full constructor */
    public Chantox(Long hantnconsulta, String hantcrefiere, String hantcdesc, Date hantdfecreg, String hantcusuareg, BigDecimal version) {
    ...
    /** minimal constructor */
    public Chantox(Long hantnconsulta, String hantcrefiere, Date hantdfecreg, String hantcusuareg) {
        this.hantnconsulta = hantnconsulta;
        this.hantcrefiere = hantcrefiere;
        this.hantdfecreg = hantdfecreg;
        this.hantcusuareg = hantcusuareg;
