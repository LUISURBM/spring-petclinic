...
/**
 * Cpcontrato generated by hbm2java
 */

public class Cpcontrato implements java.io.Serializable {


	
	private CpcontratoId id;
     ...
     * @param id
     */
    public void setId(CpcontratoId id) {
        this.id = id;
    }
