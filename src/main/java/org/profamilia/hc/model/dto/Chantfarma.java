...
public class Chantfarma implements Serializable {
    ...
    /** full constructor */
    public Chantfarma(Long hanfnconsulta, String hanfcrefiere, String hanfcdesc, Date hanfdfecreg, String hanfcusuareg, BigDecimal version) {
    ...
    /** minimal constructor */
    public Chantfarma(Long hanfnconsulta, String hanfcrefiere, Date hanfdfecreg, String hanfcusuareg) {
        this.hanfnconsulta = hanfnconsulta;
        this.hanfcrefiere = hanfcrefiere;
        this.hanfdfecreg = hanfdfecreg;
        this.hanfcusuareg = hanfcusuareg;
