...
public class Chanttrauma implements Serializable {
    ...
    /** full constructor */
    public Chanttrauma(Long hantnconsulta, String hantcrefiere, String hantcdesc, Date hantdfecreg, String hantcusuareg, BigDecimal version) {
    ...
    /** minimal constructor */
    public Chanttrauma(Long hantnconsulta, String hantcrefiere, Date hantdfecreg, String hantcusuareg) {
        this.hantnconsulta = hantnconsulta;
        this.hantcrefiere = hantcrefiere;
        this.hantdfecreg = hantdfecreg;
        this.hantcusuareg = hantcusuareg;
