...
public class ChantecfamilPK implements Serializable {
    ...
    /** full constructor */
    public ChantecfamilPK(Long haflconsulta, String hafctiposervi) {
        this.haflconsulta = haflconsulta;
        this.hafctiposervi = hafctiposervi;
    }

    /** default constructor */
    public ChantecfamilPK() {
    }
    ...
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof ChantecfamilPK) ) return false;
        ChantecfamilPK castOther = (ChantecfamilPK) other;
