...
public interface CirugiaService {
     ...
     * @throws ModelException
     */
    public List<Chconsultori> getConsultoriosXClinica(final Integer tipoConsultorio, 
                                                      final Integer clinica) throws ModelException;
    ...
    */
    ...
    public void saveDescripcionQuirurgicaHisteroscopia(Chhisteroscopia histeroscopia) throws ModelException ;
    
    public void saveDescripcionQuirurgicaHallazgoHistero(Chhallahistero hallazgoHis) throws ModelException ;
    ...
    public Chexamfisico getExamenFisicoEpicrisis(final Long numeroConsulta)throws ModelException;
