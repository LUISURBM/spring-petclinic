/**
 * Lista_Sync_OutServiceLocator.java
 *
...
import org.profamilia.hc.sap.webservice.consultaservicio.Lista_Sync_Out;
import org.profamilia.hc.sap.webservice.consultaservicio.Lista_Sync_OutBindingStub;

public class Lista_Sync_OutServiceLocator extends org.apache.axis.client.Service implements Lista_Sync_OutService {

    public Lista_Sync_OutServiceLocator() {
    }


    public Lista_Sync_OutServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Lista_Sync_OutServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTPS_Port
    private java.lang.String HTTPS_Port_address = "https://190.216.140.196:50001/XISOAPAdapter/MessageServlet?senderParty=&senderService=SAP_I_CLINICO_BS&receiverParty=&receiverService=&interface=Lista_Sync_Out&interfaceNamespace=urn%3Alistaprecios%3Aclinico%3Asap";
    ...
    public Lista_Sync_Out getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Lista_Sync_OutBindingStub _stub = new Lista_Sync_OutBindingStub(portAddress, this);
    ...
    private java.lang.String HTTP_Port_address = "http://190.216.140.196:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=SAP_I_CLINICO_BS&receiverParty=&receiverService=&interface=Lista_Sync_Out&interfaceNamespace=urn%3Alistaprecios%3Aclinico%3Asap";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Lista_Sync_Out.class.isAssignableFrom(serviceEndpointInterface)) {
                Lista_Sync_OutBindingStub _stub = new Lista_Sync_OutBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (Lista_Sync_Out.class.isAssignableFrom(serviceEndpointInterface)) {
                Lista_Sync_OutBindingStub _stub = new Lista_Sync_OutBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:listaprecios:clinico:sap", "Lista_Sync_OutService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:listaprecios:clinico:sap", "HTTPS_Port"));
            ports.add(new javax.xml.namespace.QName("urn:listaprecios:clinico:sap", "HTTP_Port"));
        }
