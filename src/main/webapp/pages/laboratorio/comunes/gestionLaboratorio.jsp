...
<h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridConfirmarServicioTab"
  ...
  <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
    ...
    <t:panelTab id="panelTabGestionLab" label="Gestionar Laboratorios">
      <s:fieldset legend="Datos Laboratorio" id="fieldSetInfoLaboratorio" styleClass="fieldset">
        <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0" width="40%" id="panelRegionInfoLaboratorio"
                     rowClasses="labelText,labelTextInfo">
          <h:outputText value="Laboratorio" styleClass="labelTextOblig"/>
          <h:outputText value=""/>
           <h:outputText value="Clinica"/>
          <h:selectOneMenu id="listaProfesional" value="#{gestionLaboratorioBean.codigoLaboratorio}">
            <f:selectItems value="#{gestionLaboratorioBean.listaItemsProfesionales}"/>
          </h:selectOneMenu>
          <a4j:outputPanel ajaxRendered="true">
            <t:message for="listaProfesional" styleClass="errorMessage"/>
          </a4j:outputPanel>
           <h:outputText value="#{gestionLaboratorioBean.nombreClinica}"/>
        </h:panelGrid>
      </s:fieldset>
      <h:panelGroup>
      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonModificar">
        <h:panelGroup>
          <h:commandButton value="Guardar" styleClass="btn btn btn-success" action="#{gestionLaboratorioBean.guardar}">
