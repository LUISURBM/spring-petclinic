...
<html>
   <f:view>
      <head>
         <title>:: PROFAMILIA ** CONSULTAR HISTORIAS CLINICAS ::</title>
  ...
  {   
    (document.getElementById('body:consultarHistoriaIncompletoForm')).pagina.value=page_;
    (document.getElementById('body:consultarHistoriaIncompletoForm')).submit();

   } 
  
</script>
      
      <body><a4j:page id="completePageConsultarFolios">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/consulta/consultarHistoriaIncompletaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>