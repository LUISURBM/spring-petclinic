...
<a4j:form id="consultarUsuarioForm">
  <a4j:region id="bodyRegionConsultaUsuario">
    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableContenUsuario"
      ...
      <s:fieldset legend="Consulta por Usuario" id="fieldSetInfoUsuario" styleClass="fieldset">
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelRegionUsuario"
          ...
          <h:panelGroup>
            <h:selectOneMenu id="tipoIdentificacion" value="#{consultarUsuarioBean.usuario.husetipoiden}">
              <f:selectItems value="#{consultarUsuarioBean.listTipoIdentificacion}"/>
            </h:selectOneMenu>
          ...
          <h:panelGroup>
            <h:inputText id="itNumeroDocumento" value="#{consultarUsuarioBean.usuario.husanumeiden}"></h:inputText>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGroup>
            <h:inputText id="itPrimerNombre" styleClass="textmayuscula"
                         value="#{consultarUsuarioBean.usuario.huscprimernomb}">
          ...
          <h:panelGroup>
            <h:inputText id="itSegundoNombre" styleClass="textmayuscula"
                         value="#{consultarUsuarioBean.usuario.huscsegundnomb}">
              <f:converter converterId="cadena.stringUpperCaseConverter"/>
            </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
          ...
          <h:panelGroup>
            <h:inputText id="itPrimerApellido" styleClass="textmayuscula"
                         value="#{consultarUsuarioBean.usuario.huscprimerapel}">
              <f:converter converterId="cadena.stringUpperCaseConverter"/>
            </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
          ...
          <h:panelGroup>
            <h:inputText id="itSegundoApellido" value="#{consultarUsuarioBean.usuario.huscsegundapel}"></h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonUsuario"
          ...
          <t:htmlTag value="br"/>
          <a4j:commandButton value="Buscar por Usuario" action="#{consultarUsuarioBean.consultarUsuario}"
                             reRender="fieldSetConsultar" styleClass="boton_fieldset" id="idButtonUsuario"/>
        </h:panelGrid>
      </s:fieldset>
      
      <s:fieldset legend="Resultados Consulta Usuario" id="fieldSetConsultar" styleClass="fieldset_dataTable">
        <h:panelGrid columns="1" id="panelGridConsultar" rendered="#{empty consultarUsuarioBean.lstUsuarios}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableContentTabsConsultar"
                     rendered="#{not empty consultarUsuarioBean.lstUsuarios}" styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         binding="#{consultarUsuarioBean.dtConsultaUsuario}" value="#{consultarUsuarioBean.lstUsuarios}"
                         rows="10" styleClass="standard_table" rowClasses="standardTable_Row1,standardTable_Row2"
              ...
              <h:column>
                ...
                <h:commandLink id="aceptar" action="#{consultarUsuarioBean.consultar}">
       ...
       <s:fieldset legend="Consulta por Consecutivo" id="fieldSetConsultarConsec" styleClass="fieldset_dataTable">
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonConsec"
                     columnClasses="columnaBotonesCentrados">
        <h:outputText value=" Número Consecutivo"/>
        <h:panelGroup>
            <h:inputText id="itNumeroConsec" value="#{consultarUsuarioBean.consecutivoCito}"></h:inputText>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <t:htmlTag value="br"/>
          <a4j:commandButton value="Buscar por Consecutivo" action="#{consultarUsuarioBean.consultarConsecutivoCitologia}"
                             reRender="fieldSetConsultar" styleClass="boton_fieldset" id="idButtonConsec"/>
        </h:panelGrid>
      </s:fieldset>
    </h:panelGrid>
    <h:panelGrid>
