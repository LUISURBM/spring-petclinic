    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
      ...
      <s:fieldset legend="Datos Usuario" id="fieldSetInfoConsultarUsuario"
        ...
        <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0"
          ...
          <h:panelGroup>
            <h:selectOneMenu id="tipoIde" required="true" disabled="true"
                             value="#{consultarFoliosDocumentoBean.usuario.husetipoiden}">
              <f:selectItems value="#{consultarFoliosDocumentoBean.listTipoIdentificacion}"/>
            </h:selectOneMenu>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="tipoIde" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
          <h:outputText value="#{consultarFoliosDocumentoBean.usuario.husanumeiden}"/>
          <h:outputText id="itNumeroUsuario"
                        value="#{consultarFoliosDocumentoBean.usuario.huslnumero}"/>
          <t:htmlTag value="br"/>
        </h:panelGrid>
        <h:panelGrid columns="4" border="0" cellpadding="0" cellspacing="0"
          ...
          <h:panelGroup>
            <h:outputText value="#{consultarFoliosDocumentoBean.usuario.huscprimernomb}"/>
          </h:panelGroup>
          <h:outputText value="#{consultarFoliosDocumentoBean.usuario.huscsegundnomb}"/>
          <h:panelGroup>
            <h:outputText id="primerApellido"
                          value="#{consultarFoliosDocumentoBean.usuario.huscprimerapel}"/>
          </h:panelGroup>
          <h:outputText value="#{consultarFoliosDocumentoBean.usuario.huscsegundapel}"/>
          <h:outputText value="Fecha Nacimiento"/>
          <h:outputText value="Edad"/>
          <h:outputText value="Sexo"/>
          <h:outputText value="Estado Civil"/>
          <h:panelGroup>
            <h:outputText value="#{consultarFoliosDocumentoBean.usuario.husdfechanacim}"/>
          </h:panelGroup>
          <h:panelGroup>
            <h:outputText value="#{consultarFoliosDocumentoBean.edad}"/>
          </h:panelGroup>
          <h:panelGroup>
            <h:selectOneMenu id="radioSexo" disabled="true"
                             value="#{consultarFoliosDocumentoBean.usuario.husesexo}">
              <f:selectItems value="#{consultarFoliosDocumentoBean.listSexos}"/>
            </h:selectOneMenu>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGroup>
            <h:selectOneMenu id="radioEstadoCivil" disabled="true"
                             value="#{consultarFoliosDocumentoBean.usuario.huseestadcivil}">
              <f:selectItems value="#{consultarFoliosDocumentoBean.listEstadoCivil}"/>
            </h:selectOneMenu>
            <a4j:outputPanel ajaxRendered="true">
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
          ...
          <a4j:commandButton value="Consultar Folios"
                             action="#{consultarFoliosDocumentoBean.consultarFoliosUsuario}"
                             reRender="fieldSetConsultarFolio"
                             styleClass="boton_fieldset"
                             id="idButtonBuscarHistoria"/>
        </h:panelGrid>
      </s:fieldset>
      <s:fieldset legend="Resultados Consulta Conducta" id="fieldSetConsultarFolio"
                  styleClass="fieldset_dataTable">
        <h:panelGrid columns="1" id="panelGridConsultarFolios"
                     rendered="#{empty consultarFoliosDocumentoBean.lstFolios}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
                     width="100%" id="tableContentTabsBucar"
                     rendered="#{not empty consultarFoliosDocumentoBean.lstFolios}"
                     styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         binding="#{consultarFoliosDocumentoBean.dtFolios}"
                         value="#{consultarFoliosDocumentoBean.lstFolios}" rows="10"
              ...
              <h:column>
                  ...
                  <h:commandLink id="atender"
                                 action="#{consultarFoliosDocumentoBean.ConsultarConducta}">
                    <t:graphicImage  alt="" border="0"
                                    url="/comun/imagenes/si.png"/>
                  </h:commandLink>
                </h:column>
            </h:dataTable>
          </t:buffer>
      ...
      <h:panelGrid>
      <h:panelGroup>
        <a4j:outputPanel id="ajaxRegionMsgFolioDocumento" ajaxRendered="true">
          <t:htmlTag value="br"/>
          <t:messages id="msgInformationMsgFolioDocumento" showSummary="true"
