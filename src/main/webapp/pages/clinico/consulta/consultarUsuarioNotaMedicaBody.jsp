  ...
  <a4j:region id="bodyRegionConsultarNotaMedica">
    <a4j:status id="statusButton" for="bodyRegionConsultarNotaMedica">
      ...
      <h:panelGrid columns="1" id="tableConsultarNotaMedica" border="0" cellpadding="0"
        ...
        <h:outputText value="Registrar Nota Aclaratoria "
                      id="infoUbication"/>
    </h:panelGrid>
    
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableContentConsultarNotaAclaratoria"
                 styleClass="tabContainer">
       <s:fieldset legend="Criterios de Busqueda" id="fieldSetInfoUsuarioNotaAclaratoria" styleClass="fieldset">
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelRegionUsuarioNotaAclaratoria"
        ...
        <h:outputText value=" Numero Identificación" />
         <h:panelGroup>
          <h:selectOneMenu id="tipoIdentificacion" 
                           value="#{consultarUsuarioNotaMedicaBean.usuario.husetipoiden}">
            <f:selectItems value="#{consultarUsuarioNotaMedicaBean.listTipoIdentificacion}"/>
          </h:selectOneMenu>
        ...
        <h:panelGroup>
          <h:inputText id="itNumeroDocumento" 
                       value="#{consultarUsuarioNotaMedicaBean.usuario.husanumeiden}">
         </h:inputText>
          <a4j:outputPanel ajaxRendered="true">
        ...
        <h:outputText value=" Segundo Nombre" />
          ...
          <h:inputText id="itPrimerNombre" styleClass="textmayuscula"
                value="#{consultarUsuarioNotaMedicaBean.usuario.huscprimernomb}">
   ...
   <h:panelGroup>
          <h:inputText id="itSegundoNombre" styleClass="textmayuscula"
                      value="#{consultarUsuarioNotaMedicaBean.usuario.huscsegundnomb}">
                         <f:converter converterId="cadena.stringUpperCaseConverter"/>
                </h:inputText>
          <a4j:outputPanel ajaxRendered="true">
            <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
        ...
        <h:outputText value=" Segundo Apellido" />
          ...
          <h:inputText id="itPrimerApellido" styleClass="textmayuscula"
                       value="#{consultarUsuarioNotaMedicaBean.usuario.huscprimerapel}">
                          <f:converter converterId="cadena.stringUpperCaseConverter"/>
            </h:inputText>
          <a4j:outputPanel ajaxRendered="true">
            <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
   ...
   <h:panelGroup>
          <h:inputText id="itSegundoApellido" styleClass="textmayuscula"
                        value="#{consultarUsuarioNotaMedicaBean.usuario.huscsegundapel}">
                           <f:converter converterId="cadena.stringUpperCaseConverter"/>
            </h:inputText>
          <a4j:outputPanel ajaxRendered="true">
            <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
    ...
    <t:htmlTag value="br"/>
    <a4j:commandButton value="Buscar" action="#{consultarUsuarioNotaMedicaBean.consultarUsuario}"
      ...
      <s:fieldset legend="Resultados Consulta" id="fieldSetConsultarNotaMedica"
        ...
        <h:panelGrid columns="1" id="panelGridConsultarNotaMedica"
                rendered="#{empty consultarUsuarioNotaMedicaBean.lstUsuarios}">
                    <h:outputText value="#{msg.msg_sin_consultar}"/>
                        </h:panelGrid>    
  <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
               width="100%" id="tableContentTabsConsultarNotaMedica"
               rendered="#{not empty consultarUsuarioNotaMedicaBean.lstUsuarios}" 
               styleClass="tabContainer">
    <t:buffer into="#{table}">
      <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                   binding="#{consultarUsuarioNotaMedicaBean.dtConsultaUsuario}"
                   value="#{consultarUsuarioNotaMedicaBean.lstUsuarios}" rows="10"
        ...
        <h:column>
          <f:facet name="header">
           ...
           <h:commandLink id="aceptarCie10"
                                  action="#{consultarUsuarioNotaMedicaBean.consultarNotaMedica}">
