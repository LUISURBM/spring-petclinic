    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
      ...
      <s:fieldset legend="Datos Usuario" id="fieldSetInfoConsultarUsuario"
        ...
        <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0"
          ...
          <h:panelGroup>
            <h:selectOneMenu id="tipoIde" required="true" disabled="true"
                             value="#{consultarFoliosNotaBean.usuario.husetipoiden}">
              <f:selectItems value="#{consultarFoliosNotaBean.listTipoIdentificacion}"/>
            </h:selectOneMenu>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="tipoIde" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
          <h:outputText value="#{consultarFoliosNotaBean.usuario.husanumeiden}"/>
          <h:outputText id="itNumeroUsuario"
                        value="#{consultarFoliosNotaBean.usuario.huslnumero}"/>
          <t:htmlTag value="br"/>
        </h:panelGrid>
        <h:panelGrid columns="4" border="0" cellpadding="0" cellspacing="0"
          ...
          <h:panelGroup>
            <h:outputText value="#{consultarFoliosNotaBean.usuario.huscprimernomb}"/>
          </h:panelGroup>
          <h:outputText value="#{consultarFoliosNotaBean.usuario.huscsegundnomb}"/>
          <h:panelGroup>
            <h:outputText id="primerApellido"
                          value="#{consultarFoliosNotaBean.usuario.huscprimerapel}"/>
          </h:panelGroup>
          <h:outputText value="#{consultarFoliosNotaBean.usuario.huscsegundapel}"/>
          <h:outputText value="Fecha Nacimiento"/>
          <h:outputText value="Edad"/>
          <h:outputText value="Sexo"/>
          <h:outputText value="Estado Civil"/>
          <h:panelGroup>
            <h:outputText value="#{consultarFoliosNotaBean.usuario.husdfechanacim}"/>
          </h:panelGroup>
          <h:panelGroup>
            <h:outputText value="#{consultarFoliosNotaBean.edad}"/>
          </h:panelGroup>
          <h:panelGroup>
            <h:selectOneMenu id="radioSexo" disabled="true"
                             value="#{consultarFoliosNotaBean.usuario.husesexo}">
              <f:selectItems value="#{consultarFoliosNotaBean.listSexos}"/>
            </h:selectOneMenu>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGroup>
            <h:selectOneMenu id="radioEstadoCivil" disabled="true"
                             value="#{consultarFoliosNotaBean.usuario.huseestadcivil}">
              <f:selectItems value="#{consultarFoliosNotaBean.listEstadoCivil}"/>
            </h:selectOneMenu>
            <a4j:outputPanel ajaxRendered="true">
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
          ...
          <a4j:commandButton value="Buscar Consultas"
                             action="#{consultarFoliosNotaBean.consultarFoliosUsuario}"
      ...
      <s:fieldset legend="Resultados Consulta" id="fieldSetConsultarFolio"
        ...
        <h:panelGrid columns="1" id="panelGridConsultarFolios"
                     rendered="#{empty consultarFoliosNotaBean.lstFolios}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
                     width="100%" id="tableContentTabsBucar"
                     rendered="#{not empty consultarFoliosNotaBean.lstFolios}"
                     styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         binding="#{consultarFoliosNotaBean.dtFolios}"
                         value="#{consultarFoliosNotaBean.lstFolios}" rows="10"
              ...
              <h:column>
                ...
                <h:column>
                  ...
                  <h:commandLink id="atender"
                                 action="#{consultarFoliosNotaBean.RegistrarNotaMedica}">
