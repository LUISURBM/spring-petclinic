...
<html>
   <f:view>
    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
      ...
      <body><a4j:page id="completePageInformacionUsuario">
            <tiles:insert definition="layoutClave" flush="false">
               <tiles:put name="body" value="/pages/clinico/consulta/informacionUsuarioClinicaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>