...
<html>
   <f:view>
    ...
    function numeroJs() {
       document.forms['body:infoClinicaForm'].elements[10].focus(); 
    }
      ...
      <body><a4j:page id="completePageInformacionServicio">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/consulta/informacionServicioBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>