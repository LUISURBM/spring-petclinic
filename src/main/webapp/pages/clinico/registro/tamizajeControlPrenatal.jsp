...
<html>
  ...
  {   
    (document.getElementById('body:formTamizajeControlPrenatal')).pagina.value=page_;
    (document.getElementById('body:formTamizajeControlPrenatal')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/tamizajeControlPrenatalBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>