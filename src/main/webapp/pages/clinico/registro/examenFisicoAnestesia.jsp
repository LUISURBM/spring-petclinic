...
<html>
   <f:view>
    ...
    <script>
    document.forms['body:formExamenFisicoAnestesia'].elements[4].focus(); 
       //Ejecuta una acci�n
  function execute(form,page_)
    
  {   
    (document.getElementById('body:formExamenFisicoAnestesia')).pagina.value=page_;
    (document.getElementById('body:formExamenFisicoAnestesia')).submit();

   } 
   
   function temperaturaJs() {
       document.forms['body:formExamenFisicoAnestesia'].elements[10].focus(); 
    }
    ...
    function imcJs() {
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/examenFisicoAnestesiaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>