...
<a4j:form id="formControlMedicamentos">
  <a4j:region id="regionControlMedicamentos" renderRegionOnly="false">
    ...
    <h:panelGrid columns="2" id="tableBodyGeneralControlMedicamentos" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="verticalaligntop,td_fondoBarraH">
      <h:panelGroup id="tableGroupContentControlMedicamentos">
        <h:panelGrid columns="1" id="tableInfoUbicationControlMedicamentos" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="td_ubicador">
          <h:outputText value="HISTORIAS CLINICAS >> Cirugia >> Registro Anestesia >> Control Medicamentos " id="infoUbication"/>
        </h:panelGrid>
        <jsp:include page="/pages/clinico/cirugia/registro/anestesia/comun/controlMedicamentos.jsp" flush="true"/>
      </h:panelGroup>
