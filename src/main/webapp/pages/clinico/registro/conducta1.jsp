   ...
   <f:view>
    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         ...
         <script language="javascript" type="text/javascript">
          ...
          {   
            (document.getElementById('body:formControl')).pagina.value=page_;
            (document.getElementById('body:formControl')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/conductaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>