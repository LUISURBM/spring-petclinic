...
<html>
  ...
  {   
    (document.getElementById('body:formRiesgoMama')).pagina.value=page_;
    (document.getElementById('body:formRiesgoMama')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/riesgoMamaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>
