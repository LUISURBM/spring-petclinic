...
<html>
 ...
 <script language="javascript" type="text/javascript">
       ...
       //Ejecuta una acci�n
    function jsFunction() {   
    if(document.getElementById('body:formAntecedentesGinecologicospre:panelTabAntecedentesGinecologicospre:itNumGesta').value == 0){
            document.forms['body:formAntecedentesGinecologicospre'].elements[15].focus(); 
    }else{
        document.forms['body:formAntecedentesGinecologicospre'].elements[7].focus(); 
    }
   }
    ...
    function ciclosJs() {
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaNuevoPrenatalEnfermeria/antecedentesGinecologicosNuevoPrenatalEnfermeriaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>