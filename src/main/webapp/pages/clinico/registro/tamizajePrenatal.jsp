...
<html>
  ...
  {   
    (document.getElementById('body:formTamizajePrenatal')).pagina.value=page_;
    (document.getElementById('body:formTamizajePrenatal')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/tamizajePrenatalBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>