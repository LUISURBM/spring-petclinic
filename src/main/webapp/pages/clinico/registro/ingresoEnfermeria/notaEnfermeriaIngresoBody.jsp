...
<a4j:form id="formNotaIngresoEnfermeria">
  <a4j:region id="regionNotaIngresoEnfermeria" renderRegionOnly="false">
    <a4j:status id="statusButton" for="regionNotaIngresoEnfermeria">
      <f:facet name="start">
    ...
    <h:panelGrid columns="2" id="tableBodyGeneral" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="verticalaligntop,td_fondoBarraH">
      <h:panelGroup id="tableGroupContent">
        <h:panelGrid columns="1" id="tableInfoUbication" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="td_ubicador">
          <h:outputText value="HISTORIAS CLINICAS >> Cirugia >> Ingreso Enfermeria >> Nota Enfermeria" id="infoUbication"/>
        </h:panelGrid>
        <jsp:include page="/pages/clinico/cirugia/registro/enfermera/nota/registrarNotaEnfermeria.jsp" flush="true"/>
      </h:panelGroup>
