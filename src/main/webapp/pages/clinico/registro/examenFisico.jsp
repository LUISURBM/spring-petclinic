...
<html>
   <f:view>
    ...
    <script>
    document.forms['body:formExamenFisico'].elements[4].focus(); 
       //Ejecuta una acci�n
  function execute(form,page_)
    
  {   
    (document.getElementById('body:formExamenFisico')).pagina.value=page_;
    (document.getElementById('body:formExamenFisico')).submit();

   } 
   
   function temperaturaJs() {
       document.forms['body:formExamenFisico'].elements[10].focus(); 
    }
   ...
   function imcJsPeso() {
       document.forms['body:formExamenFisico'].elements[9].focus(); 
    }
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/examenFisicoBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>