...
<a4j:form id="formValoracion">
  <a4j:region id="regionValoracion" renderRegionOnly="false">
    <a4j:status id="statusButton" for="regionValoracion">
      <f:facet name="start">
        <t:div id="chargingValoracion" styleClass="loading">
    ...
    <h:panelGrid columns="2" id="tableBodyGeneral" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="verticalaligntop,td_fondoBarraH">
      <h:panelGroup id="tableGroupContent">
        ...
        <jsp:include page="/pages/clinico/comunes/valoracionPreanestesia.jsp" flush="true"/>
      </h:panelGroup>
