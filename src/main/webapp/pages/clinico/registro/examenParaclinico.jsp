...
<html>
  ...
  {   
    (document.getElementById('body:formExamenParaclinico')).pagina.value=page_;
    (document.getElementById('body:formExamenParaclinico')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/examenParaclinicoBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>