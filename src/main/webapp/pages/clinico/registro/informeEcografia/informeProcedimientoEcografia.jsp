...
<html>
   <f:view>
    ...
    function jsFunction() {
     ...
     if(document.getElementById('body:formInformeEcografia:panelTabInformeEcografia:mnuNumGesta').value != 0){
            document.forms['body:formInformeEcografia'].elements[9].focus(); 
    }
       
    if(document.getElementById('body:formInformeEcografia:panelTabInformeEcografia:mnuNumGesta').value == 0){
            document.forms['body:formInformeEcografia'].elements[13].focus(); 
    }
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/informeEcografia/informeProcedimientoEcografiaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>