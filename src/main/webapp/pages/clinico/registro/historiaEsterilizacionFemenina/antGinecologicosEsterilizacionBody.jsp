...
<a4j:form id="formAntecedentesGinecologicos">
  <a4j:region id="regionAntGinecologicos" renderRegionOnly="false">
    <a4j:status id="statusButton" for="regionAntGinecologicos">
      <f:facet name="start">
        <t:div id="chargingAntGinecologicos" styleClass="loading">
    ...
    <h:panelGrid columns="2" id="tableBodyGeneral" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="verticalaligntop,td_fondoBarraH">
      <h:panelGroup id="tableGroupContent">
        <h:panelGrid columns="1" id="tableInfoUbication" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="td_ubicador">
          <h:outputText value="HISTORIAS CLINICAS >> Cirugias >> Anticoncepción Quirurgica Voluntaria Femenina >> Formula Obstétrica" id="infoUbication"/>
        </h:panelGrid>
