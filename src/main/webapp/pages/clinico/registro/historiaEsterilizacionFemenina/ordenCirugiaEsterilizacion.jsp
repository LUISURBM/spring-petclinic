   ...
   <f:view>
      ...
      <meta http-equiv="X-UA-Compatible" content="IE =EmulateIE6"/>
         ...
         <script type="text/javascript"
                 src="/historiasroot/faces/myFacesExtensionResource/org.apache.myfaces.renderkit.html.util.MyFacesResourceLoader/12544153/prototype.PrototypeResourceLoader/prototype.js"></script>
         <script type="text/javascript"
                 src="/historiasroot/faces/myFacesExtensionResource/org.apache.myfaces.renderkit.html.util.MyFacesResourceLoader/12544153/calendar.HtmlCalendarRenderer/date.js"></script>
         <script type="text/javascript"
                 src="/historiasroot/faces/myFacesExtensionResource/org.apache.myfaces.renderkit.html.util.MyFacesResourceLoader/12544153/calendar.HtmlCalendarRenderer/popcalendar.js"></script>
         <script type="text/javascript"
                 src="/historiasroot/faces/myFacesExtensionResource/org.apache.myfaces.renderkit.html.util.MyFacesResourceLoader/12544153/inputTextHelp.HtmlTextHelpRenderer/inputTextHelp.js"></script>
    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         ...
         <script language="javascript" type="text/javascript">
                //Ejecuta una acci�n
                  ...
                  {   
                    (document.getElementById('body:formOrdenCirugia')).pagina.value=page_;
                    (document.getElementById('body:formOrdenCirugia')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaEsterilizacionFemenina/ordenCirugiaEsterilizacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>