   ...
   <f:view>
    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         ...
         //Ejecuta una acci�n
          ...
          {   
            (document.getElementById('body:formControlSinCosto')).pagina.value=page_;
            (document.getElementById('body:formControlSinCosto')).submit();        
           } 
        </script>
      </head>
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaEsterilizacionFemenina/controlSinCostoEsterilizacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>