    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         ...
         <script language="javascript" type="text/javascript">
            ...
            function execute(form,page_)
                {   
                    (document.getElementById('body:formMotivoConsulta')).pagina.value=page_;
                    (document.getElementById('body:formMotivoConsulta')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaEsterilizacionFemenina/motivoEsterilizacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>