    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         ...
         <script language="javascript" type="text/javascript">
            //Ejecuta una acci�n
              ...
              {   
                (document.getElementById('body:formIncapacidad')).pagina.value=page_;
                (document.getElementById('body:formIncapacidad')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaEsterilizacionFemenina/incapacidadEsterilizacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>