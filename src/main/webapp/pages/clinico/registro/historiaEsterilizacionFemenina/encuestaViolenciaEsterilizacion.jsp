    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         ...
         <script language="javascript" type="text/javascript">
          ...
          function execute(form,page_)
           ...
           {   
            (document.getElementById('body:formEncuestaViolencia')).pagina.value=page_;
            (document.getElementById('body:formEncuestaViolencia')).submit();
        
           } 
           
           function cursorViolencia(){
             document.forms['body:formEncuestaViolencia'].elements[5].focus(); 
           }
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaEsterilizacionFemenina/encuestaViolenciaEsterilizacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>