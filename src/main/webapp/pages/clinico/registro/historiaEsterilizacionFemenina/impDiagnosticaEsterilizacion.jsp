    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         ...
         <script language="javascript" type="text/javascript">
               //Ejecuta una acci�n
                function execute(form,page_) 
                  {   
                    (document.getElementById('body:formImpresionDiagnostica')).pagina.value=page_;
                    (document.getElementById('body:formImpresionDiagnostica')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaEsterilizacionFemenina/impDiagnosticaEsterilizacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>