   ...
   <f:view>
    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         ...
         <script language="javascript" type="text/javascript">  
              ...
              {   
                (document.getElementById('body:formExamenesElectrofisiologicos')).pagina.value=page_;
                (document.getElementById('body:formExamenesElectrofisiologicos')).submit();
               }          
        </script>
      </head>
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaEsterilizacionFemenina/examElectroFisioEsterilizacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>