...
<html>
  ...
  {   
    (document.getElementById('body:formExamenFisicoMama')).pagina.value=page_;
    (document.getElementById('body:formExamenFisicoMama')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/examenFisicoMamaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>
