...
<s:fieldset legend="Criterios de Busqueda CIE10 " id="fieldSetBuscador"
            styleClass="fieldset">
  <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0"
    ...
    <h:inputText value="#{buscadorCie10.cie10.cdcccodigo}" style="width:50px"
                 onkeydown="return blockEnter(event);"/>
                 
    <h:inputText value="#{buscadorCie10.cie10.cdccdescri}"
                 onkeydown="return blockEnter(event);"/>
                 
     <h:outputText value=""/>
    <h:outputText value="Descripcion 2"/>
                 
    <h:selectOneRadio id="radioOpcion" value="#{buscadorCie10.cie10.cdccopera1}">
      <f:selectItem itemValue="AND" itemLabel="AND"/>
      <f:selectItem itemValue="OR" itemLabel="OR"/>
    </h:selectOneRadio>
    
    <h:inputText value="#{buscadorCie10.cie10.cdccdescri2}"
                 onkeydown="return blockEnter(event);"/>
    ...
    <h:outputText value="Descripcion 3"/>
      ...
      <h:selectOneRadio id="radioOpcion2" value="#{buscadorCie10.cie10.cdccopera2}">
      <f:selectItem itemValue="Y" itemLabel="AND"/>
      <f:selectItem itemValue="O" itemLabel="OR"/>
    </h:selectOneRadio>
    
     
     <h:inputText value="#{buscadorCie10.cie10.cdccdescri3}"
            onkeydown="return blockEnter(event);"/>
  ...
  <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
    ...
    <t:htmlTag value="br"/>
    <a4j:commandButton value="Buscar" action="#{buscadorCie10.consultarCie10}"
...
<s:fieldset legend="Resultados Consulta" id="fieldSetResConsulta"
         ...
         <h:panelGrid columns="1" id="panelGridConsultar"
                     rendered="#{empty buscadorCie10.listCIE10}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>     
            
  <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
               width="100%" id="tableContentTabsBucar"
                rendered="#{not empty buscadorCie10.listCIE10}"
               styleClass="tabContainer">
    <t:buffer into="#{table}">
      <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                   binding="#{buscadorCie10.dtConsultas}"
                   value="#{buscadorCie10.listCIE10}" rows="10"
       ...
       <h:column>
          ...
          <a4j:commandLink id="aceptarCie10" immediate="true"
                         ...
                         action="#{buscadorCie10.seleccionarCie10}">
...
<s:fieldset legend="Diagnostico Seleccionado" id="fieldSetResDiagnostico"
            styleClass="fieldset_dataTable">
  <h:outputText value="#{buscadorCie10.cie10Select.cdccdescri}"/>
</s:fieldset>
