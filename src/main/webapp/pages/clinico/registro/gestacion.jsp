...
<html>
  ...
  {   
    (document.getElementById('body:formGestacion')).pagina.value=page_;
    (document.getElementById('body:formGestacion')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/gestacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>