...
<html>
  ...
  {   
    (document.getElementById('body:formExamenFisicoPrenatal')).pagina.value=page_;
    (document.getElementById('body:formExamenFisicoPrenatal')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/examenFisicoPrenatalBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>