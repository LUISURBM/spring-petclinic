...
<a4j:form id="formControlSinCosto">
  <a4j:region id="regionControlSinCosto" renderRegionOnly="false">
    ...
    <h:panelGrid columns="2" id="tableBodyGeneralControlSinCosto" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="verticalaligntop,td_fondoBarraH" styleClass="alignTop">
      <h:panelGroup id="tableGroupContentControlSinCosto">
        <h:panelGrid columns="1" id="tableInfoUbicationControlSinCosto" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="td_ubicador">
          <h:outputText value="HISTORIAS CLINICAS >> Procedimiento >> Historia Anticoncepción Temporal (Inserción y/o Retiro) >> Conducta >> Control " id="infoUbicationControlSinCosto"/>
        </h:panelGrid>
