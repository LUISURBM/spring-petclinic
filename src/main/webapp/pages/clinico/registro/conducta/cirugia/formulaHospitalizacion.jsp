...
<script language="javascript" type="text/javascript">
  ...
  {   
    (document.getElementById('body:formFormulaHospitalizacion')).pagina.value=page_;
    (document.getElementById('body:formFormulaHospitalizacion')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layoutCirugia" flush="false">
             <tiles:put name="body"
                          value="/pages/clinico/registro/conducta/cirugia/formulaHospitalizacionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>