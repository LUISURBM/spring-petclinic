...
<html>
  ...
  {   
    (document.getElementById('body:formMedidasApoyo')).pagina.value=page_;
    (document.getElementById('body:formMedidasApoyo')).submit();
      ...
      <body><a4j:page id="completePage">
            ...
            <tiles:put name="body"
                          value="/pages/clinico/registro/conducta/cirugia/medidasApoyoBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>