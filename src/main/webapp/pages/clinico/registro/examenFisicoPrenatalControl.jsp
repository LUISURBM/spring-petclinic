...
<html>
  ...
  {   
    (document.getElementById('body:formexamenFisicoPrenatalControl')).pagina.value=page_;
    (document.getElementById('body:formexamenFisicoPrenatalControl')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/examenFisicoPrenatalControlBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>