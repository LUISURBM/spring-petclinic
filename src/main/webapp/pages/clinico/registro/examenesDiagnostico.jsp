...
<html>
  ...
  {   
    (document.getElementById('body:formExamenesApoyoDiagnostico')).pagina.value=page_;
    (document.getElementById('body:formExamenesApoyoDiagnostico')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/examenesDiagnosticoBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>