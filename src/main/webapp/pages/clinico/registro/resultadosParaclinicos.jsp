...
<html>
  ...
  {   
    (document.getElementById('body:formResultadosParaclinicos')).pagina.value=page_;
    (document.getElementById('body:formResultadosParaclinicos')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/resultadosParaclinicosBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>