    ...
    <h:panelGrid columns="2" id="tableBodyGeneralResumenControl" border="0" cellpadding="0" cellspacing="0" width="100%"
      ...
      <h:panelGroup id="tableGroupContentResumenControl">
        <h:panelGrid columns="1" id="tableInfoUbicationResumenControl" border="0" cellpadding="0" cellspacing="0" width="100%"
          ...
          <h:outputText value="HISTORIAS CLINICAS >> Consulta >> Historia Control Entrega Resultados >> Resumen Historia Control Entrega Resultados "
                        id="infoUbication"/>
        </h:panelGrid>
       <jsp:include page="/pages/clinico/comunes/resumen/resumenhistoriaControlEntregaResultado.jsp" flush="true"/>
      </h:panelGroup>
