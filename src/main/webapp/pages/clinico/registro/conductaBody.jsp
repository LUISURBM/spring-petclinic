    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridConductaTab" styleClass="tabContainer">
      <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true" width="100%" id="panelTabbedPaneConducta" styleClass="tabbedPane"
        ...
        <t:panelTab id="panelTabConducta" label="Conducta ">
          <h:panelGrid columns="1" dir="LTR" cellpadding="0" cellspacing="0" border="0" width="100%" rendered="#{conductaBean.mostrarIcono}">
            <a4j:commandLink action="#{conductaBean.generarReporte}" reRender="formConducta" immediate="true" title="Imprimir Recomendaciones">
          ...
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridConducta" styleClass="tabContainer">
            <s:fieldset legend="Conducta" id="fieldConducta" styleClass="fieldset">
              <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelConductaObservaciones" rowClasses="labelText">
                <h:outputText value="Recomendaciones" styleClass="labelTextOblig"/>
                <h:outputText value=""/>
                <h:panelGroup>
                  <h:inputTextarea id="textObservaciones" required="true" disabled="#{conductaBean.modoconsulta}" value="#{conductaBean.conducta.hcncobservacio}" style="width:600px"/>
            ...
            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonBotonesConducta" columnClasses="panelGridBotones">
              <h:panelGroup>
                <a4j:commandButton value="Aceptar" styleClass="btn btn btn-success" disabled="#{conductaBean.modoconsulta}" reRender="formConducta" action="#{conductaBean.aceptar}"/>
              </h:panelGroup>
            </h:panelGrid>
            <h:panelGrid>
              <h:panelGroup>
                <a4j:outputPanel id="ajaxRegionMensajesConducta" ajaxRendered="true">
                  <t:htmlTag value="br"/>
                  <t:messages id="msgInfConducta" showSummary="true" errorClass="error" globalOnly="true" layout="table" infoClass="informacion"/>
                </a4j:outputPanel>
              </h:panelGroup>
            </h:panelGrid>
          </h:panelGrid>
      ...
      <f:subview id="generarRecomendaciones" rendered="#{conductaBean.generoRecomendaciones}">
        <f:verbatim>
