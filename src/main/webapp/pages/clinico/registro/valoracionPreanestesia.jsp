...
<html>
  ...
  {   
    (document.getElementById('body:formValoracionPreanestesia')).pagina.value=page_;
    (document.getElementById('body:formValoracionPreanestesia')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/valoracionPreanestesiaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>