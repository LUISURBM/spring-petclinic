...
<html>
  ...
  {   
    (document.getElementById('body:formExamenFisicoPediatria')).pagina.value=page_;
    (document.getElementById('body:formExamenFisicoPediatria')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/examenPediatriaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>