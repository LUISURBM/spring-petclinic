...
<html>
   ...
   function temperaturaJs() {
       document.forms['body:formExamenFisico'].elements[12].focus(); 
    }
   ...
   function imcJsPeso() {
       document.forms['body:formExamenFisico'].elements[11].focus(); 
    }
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/enfermeria/historiaAnticoncepcionEnfermeriaInsercion/examenFisicoAnticoncepcionEnfermeriaInsercionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>