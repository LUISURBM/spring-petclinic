...
<html>
   <f:view>
    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
       ...
       //Ejecuta una acci�n
    function jsFunction() {   
    if(document.getElementById('body:formAntecedentesGinecologicos:panelTabAntecedentesGinecologicos:itNumGesta').value == 0){
            document.forms['body:formAntecedentesGinecologicos'].elements[15].focus(); 
    }else{
        document.forms['body:formAntecedentesGinecologicos'].elements[7].focus(); 
    }
   }
    ...
    function ciclosJs() {
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/enfermeria/historiaAnticoncepcionEnfermeriaInsercion/antecedentesGinecologicosAnticoncepcionEnfermeriaInsercionBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>