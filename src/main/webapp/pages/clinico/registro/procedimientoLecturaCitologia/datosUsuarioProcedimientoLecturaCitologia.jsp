   ...
   <f:view>
    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
     ...
     function jsFunctionDepartamento() {
        document.forms['body:formDatosUsuarios'].elements[12].focus(); 
    }
   
    function jsFunctionOtroDepartamento() {
        document.forms['body:formDatosUsuarios'].elements[23].focus(); 
    }
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/procedimientoLecturaCitologia/datosUsuarioProcedimientoLecturaCitologiaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>