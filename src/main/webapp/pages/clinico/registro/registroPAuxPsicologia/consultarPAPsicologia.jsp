      ...
      <head>
       ...
       <script language="javascript" type="text/javascript">
            ...
            function execute(form,page_)
                {   
                    (document.getElementById('body:formConsultarNotas')).pagina.value=page_;
                    (document.getElementById('body:formConsultarNotas')).submit();
        
                }   
        </script>
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/registroPAuxPsicologia/consultarPAPsicologiaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>