...
<a4j:form id="formFormularLiquidos">
  <a4j:region id="regionFormularLiquidos" renderRegionOnly="false">
    <a4j:status id="statusButton" for="regionFormularLiquidos">
      <f:facet name="start">
        <t:div id="chargingFormularLiquidos" styleClass="loading">
    ...
    <h:panelGrid columns="2" id="tableBodyGeneral" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="verticalaligntop,td_fondoBarraH">
      <h:panelGroup id="tableGroupContent">
        <h:panelGrid columns="1" id="tableInfoUbication" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="td_ubicador">
          <h:outputText value="HISTORIAS CLINICAS >> Cirugia >> Descripcion Quirurgica  >> Conducta >> Ordenes Médicas >> Formular Liquidos " id="infoUbication"/>
        </h:panelGrid>
