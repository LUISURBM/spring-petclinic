    ...
    <h:panelGrid columns="2" id="tableBodyGeneral" border="0" cellpadding="0" cellspacing="0" width="100%"
      ...
      <h:panelGroup id="tableGroupContent">
        <h:panelGrid columns="1" id="tableInfoUbication" border="0" cellpadding="0" cellspacing="0" width="100%"
          ...
          <h:outputText value="HISTORIAS CLINICAS >> Reportes >> Reporte Antigenos Covid-19 "
                        id="infoUbication"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridRepoLogTab"
          ...
          <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false"
                             ...
                             disabledTabStyleClass="disabledTab" activeSubStyleClass="activeSub" selectedIndex="#{repCovidAntigenosBean.selectedIndex}"
                             inactiveSubStyleClass="inactiveSub" tabContentStyleClass="tabContent">
            <t:panelTab id="panelTabReporLogImpresion" label="Reporte Pruebas Antigenos de Covid-19"  rendered="#{!repCovidAntigenosBean.renderBuscador}">
              <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                <s:fieldset legend="Datos Busqueda" id="fieldReportLogImpresion" styleClass="fieldset">
                  <h:panelGrid columns="4" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0" columnClasses="labelTextInfo">
                      <a4j:commandLink action="#{repCovidAntigenosBean.mostrarBuscadorUsuarios}" immediate="true"
                                       reRender="panelGridRepoLogTab">
                        <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                        <t:graphicImage alt="" border="0" url="/comun/imagenes/lupa.gif"/>
                      </a4j:commandLink>
                      <h:inputText id="idUsuario" maxlength="15" style="width:80px" immediate="true"
                                   value="#{repCovidAntigenosBean.numeroUsuario}"
                                   valueChangeListener="#{repCovidAntigenosBean.setNumeroUsuario}"
                                   binding="#{repCovidAntigenosBean.itNumeroUsuario}"
                    ...
                    <t:inputCalendar id="fechaInicial" title="Formato: dd/mm/yyyy" monthYearRowClass="yearMonthHeader"
                                     ...
                                     value="#{repCovidAntigenosBean.fechaInicial}" popupTodayString="Hoy"
                    ...
                    <t:inputCalendar id="fechaFinal" monthYearRowClass="yearMonthHeader" weekRowClass="weekHeader"
                                     ...
                                     renderAsPopup="true" value="#{repCovidAntigenosBean.fechaFinal}"
                    ...
                    <h:outputText value=" "/>
                    <h:panelGroup>
                      <h:selectOneMenu id="listaClinicas" value="#{repCovidAntigenosBean.clinicaSelect}"
                                       required="true" disabled="#{repCovidAntigenosBean.disableClinicas}">
                        <f:selectItems value="#{repCovidAntigenosBean.listaClinicas}"/>
                      </h:selectOneMenu>
                      <a4j:outputPanel ajaxRendered="true">
                ...
                <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                  ...
                  <a4j:commandButton value="Generar Reporte" styleClass="btn btn btn-success"
                                     ...
                                     action="#{repCovidAntigenosBean.consultarRegistros}"/>
                  <t:htmlTag value="br"/>
                  <a4j:commandButton value="Generar Archivo CSV" styleClass="btn btn btn-success"
                                     reRender="panelGridRepoLogTab,panelBotonBotonesRepoLogImpresion"  
                                     rendered="#{repCovidAntigenosBean.existeInformacion}"
                                     action="#{repCovidAntigenosBean.generarArchivoCsv}"/>
                </h:panelGrid>



                <f:subview id="generarReporte" rendered="#{repCovidAntigenosBean.generoReporte}">
                  <f:verbatim>
            ...
            <t:panelTab id="panelBuscadorUsuarios" label="Buscar Usuarios"
                            rendered="#{repCovidAntigenosBean.renderBuscador}">
                        ...
                        <h:panelGrid id="panelGridBuscarUsuariosBotones" width="100%"
                            ...
                            <h:panelGroup id="panelGroupBuscarUsuariosBotones1">
                                <h:commandButton value="Aceptar Usuario" styleClass="btn btn btn-success"
                                                 action="#{repCovidAntigenosBean.aceptarUsuario}"></h:commandButton>
                            </h:panelGroup>
                        </h:panelGrid>
                    </a4j:region>
                </t:panelTab>
