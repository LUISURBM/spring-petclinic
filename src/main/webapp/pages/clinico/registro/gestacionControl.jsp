...
<html>
  ...
  {   
    (document.getElementById('body:formGestacionControl')).pagina.value=page_;
    (document.getElementById('body:formGestacionControl')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/registro/gestacionControlBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>