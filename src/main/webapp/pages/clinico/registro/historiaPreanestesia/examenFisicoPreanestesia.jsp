...
<html>
   ...
   function temperaturaJs() {
       document.forms['body:formExamenFisicoPreanestesia'].elements[13].focus(); 
    }
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/registro/historiaPreanestesia/examenFisicoPreanestesiaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>