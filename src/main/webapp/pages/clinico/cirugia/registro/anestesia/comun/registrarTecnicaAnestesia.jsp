...
<h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridTecnicaAnestesiaTab"
             styleClass="tabContainer">
               <jsp:include page="/pages/clinico/comunes/encabezadoDatosCirugia.jsp"
                     flush="true"/>
                     
                  
  <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
                     width="100%" id="panelTabbedPaneTecnicaAnestesia" styleClass="tabbedPane"
                     activeTabStyleClass="activeTab" inactiveTabStyleClass="inactiveTab"
                     disabledTabStyleClass="disabledTab" activeSubStyleClass="activeSub"
                     inactiveSubStyleClass="inactiveSub" tabContentStyleClass="tabContent">
                          
    <t:panelTab id="panelTabTecnicaAnestesia" label="Técnica Anestesia">
      <s:fieldset legend="Técnica Anestesia" id="fieldTecnicaAnestesia" styleClass="fieldset">
        <h:panelGrid columns="4" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelTecnicaAnestesia"
          ...
          <h:outputText value=""/>
          <a4j:region renderRegionOnly="false">
            <h:selectBooleanCheckbox id="checkAnestesiaLocal" value="#{registrarTecnicaAnestesiaBean.esAnestesiaLocal}"
          ...
          <h:panelGroup id="panelOutputAnestesiaGeneral">
            <h:outputText value="¿Forma Administración? " styleClass="labelTextOblig"
                          rendered="#{registrarTecnicaAnestesiaBean.esAnestesiaGeneral}"/>
          </h:panelGroup>
          <h:panelGroup id="panelOutputAnestesiaRegional">
            <h:outputText value="¿Forma Administracion?" styleClass="labelTextOblig"
                          rendered="#{registrarTecnicaAnestesiaBean.esAnestesiaRegional}"/>
          </h:panelGroup>
          <h:panelGroup id="panelTextTipoNeuroaxial">
            <h:outputText value="Tipo Neuroaxial"
                          rendered="#{registrarTecnicaAnestesiaBean.mostrarNeuroaxial && registrarTecnicaAnestesiaBean.esAnestesiaRegional}"/>
          </h:panelGroup>
          <h:panelGroup>
            <h:outputText value=""/>
          </h:panelGroup>
          <h:panelGroup id="panelInputAnestesiaGeneral">
            <h:selectOneRadio id="mnuFormaAdministracionGeneral" layout="pageDirection"
            ...
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="mnuFormaAdministracionGeneral" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
          <h:panelGroup id="panelInputAnestesiaRegional">
            ...
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="mnuFormaAdministracionRegional" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
          <h:panelGroup id="panelMnuTipoNeuroaxial">
            <h:selectOneRadio id="mnuTipoNeuroaxial"
                              rendered="#{registrarTecnicaAnestesiaBean.mostrarNeuroaxial && registrarTecnicaAnestesiaBean.esAnestesiaRegional}"
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                     id="panelDescripcionProcedimientoAnestesia" rowClasses="labelText,labelTextInfo">
          <h:panelGroup>
          ...
          <h:panelGroup>
            <h:inputTextarea id="itDescripcionAnestesia" required="true" style="width:600px"
                             rendered="#{registrarTecnicaAnestesiaBean.esAnestesiaRegional || registrarTecnicaAnestesiaBean.esAnestesiaLocal}"
      ...
      <s:fieldset legend="Agentes Inhalados" id="fieldAgentesInhalados" styleClass="fieldset">
        <h:panelGrid columns="5" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridAgentesInhalados"
                     rowClasses="labelText,labelTextInfo">
          <h:outputText value="Oxigeno O2"/>
          ...
          <a4j:region renderRegionOnly="false">
            <h:panelGroup>
                 <h:selectOneMenu id="itOxigeno"   immediate="true"  style="width:100px"
              ...
              <h:outputText value = "LPM"/>
              
            </h:panelGroup>
          </a4j:region>
          <h:panelGroup id="panelFechaInicioOxigeno">
            <t:inputCalendar id="fechaInicioOxigeno" onkeydown="return blockEnter(event);" styleClass="input-small"
                             ...
                             value="#{registrarTecnicaAnestesiaBean.fechainiciooxigeno}" popupTodayString="Hoy"
          ...
          <h:panelGroup id="panelHoraInicioOxigeno">
            <h:panelGroup>
              <h:selectOneMenu id="mnuHoraInicioOxigeno" required="true" immediate="true" styleClass="input-mini"
                               rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}"
            ...
            <h:panelGroup>
              <h:selectOneMenu id="mnuMinutosInicioOxigeno" required="true" styleClass="input-mini"
                               rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}" immediate="true"
                               value="#{registrarTecnicaAnestesiaBean.minutoiniciooxigeno}">
                <f:selectItems value="#{registrarTecnicaAnestesiaBean.lstMinutos}"/>
              </h:selectOneMenu>
              <a4j:outputPanel ajaxRendered="true" rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}">
                <t:message for="mnuMinutosInicioOxigeno" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
          </h:panelGroup>
          <h:panelGroup id="panelFechaFinOxigeno">
            <t:inputCalendar id="fechaFinOxigeno" rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}" styleClass="input-small"
                             onkeydown="return blockEnter(event);" monthYearRowClass="yearMonthHeader"
                             weekRowClass="weekHeader" immediate="true" title="Formato: dd/mm/yyyy"
                             currentDayCellClass="currentDayCell" popupDateFormat="dd/MM/yyyy" renderAsPopup="true"
                             value="#{registrarTecnicaAnestesiaBean.fechafinoxigeno}" popupTodayString="Hoy"
                             popupWeekString="Semana" popupButtonString="Fecha" readonly="false" maxlength="11"
                             size="11" popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                             renderPopupButtonAsImage="true" align="top" required="true"></t:inputCalendar>
            <a4j:outputPanel ajaxRendered="true" rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}">
          ...
          <h:panelGroup id="panelHorafinOxigeno">
            <h:panelGroup>
              <h:selectOneMenu id="mnuHoraFinOxigeno" required="true" immediate="true"  styleClass="input-mini"
                               rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}"
            ...
            <h:outputText value=" : " rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}"/>
            <h:panelGroup>
              <h:selectOneMenu id="mnuMinutosFinOxigeno" required="true"  styleClass="input-mini"
                               rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}" immediate="true"
                               value="#{registrarTecnicaAnestesiaBean.minutofinoxigeno}">
                <f:selectItems value="#{registrarTecnicaAnestesiaBean.lstMinutos}"/>
              </h:selectOneMenu>
              <a4j:outputPanel ajaxRendered="true" rendered="#{registrarTecnicaAnestesiaBean.mostraroxigeno}">
                <t:message for="mnuMinutosFinOxigeno" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
          </h:panelGroup>
          <h:outputText value="Oxigeno Nitroso" style="width:30px"/>
          ...
          <h:panelGroup>
            <a4j:region renderRegionOnly="false">
              <h:panelGroup>
                <h:selectOneMenu id="itOxigenoNitroso" style="width:100px" immediate="true"
                  ...
                  <f:selectItems value = "#{registrarTecnicaAnestesiaBean.ltsOxigenoNitroso}"/>
          ...
          <h:panelGroup id="panelFechaInicioNitroso">
            <t:inputCalendar id="fechaInicioNitroso" rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}" styleClass="input-small"
                             onkeydown="return blockEnter(event);" monthYearRowClass="yearMonthHeader"
                             weekRowClass="weekHeader" immediate="true" title="Formato: dd/mm/yyyy"
                             currentDayCellClass="currentDayCell" popupDateFormat="dd/MM/yyyy" renderAsPopup="true"
                             value="#{registrarTecnicaAnestesiaBean.fechainicionitroso}" popupTodayString="Hoy"
                             popupWeekString="Semana" popupButtonString="Fecha" readonly="false" maxlength="11"
                             size="11" popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                             renderPopupButtonAsImage="true" align="top" required="true"></t:inputCalendar>
            <a4j:outputPanel ajaxRendered="true" rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}">
          ...
          <h:panelGroup id="panelHoraInicioNitroso">
            <h:panelGroup rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}">
              <h:selectOneMenu id="mnuHoraInicioNitroso" required="true" immediate="true"  styleClass="input-mini"
            ...
            <h:panelGroup rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}">
              <h:selectOneMenu id="mnuMinutosInicioNitroso" required="true" immediate="true"  styleClass="input-mini"
                               value="#{registrarTecnicaAnestesiaBean.minutoinicionitroso}">
                <f:selectItems value="#{registrarTecnicaAnestesiaBean.lstMinutos}"/>
              </h:selectOneMenu>
              <a4j:outputPanel ajaxRendered="true">
                <t:message for="mnuMinutosInicioNitroso" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
          </h:panelGroup>
          <h:panelGroup id="panelFechaFinNitroso">
            <t:inputCalendar id="fechaFinNitroso" onkeydown="return blockEnter(event);" styleClass="input-small"
                             rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}"
                             monthYearRowClass="yearMonthHeader" weekRowClass="weekHeader" immediate="true"
                             title="Formato: dd/mm/yyyy" currentDayCellClass="currentDayCell"
                             popupDateFormat="dd/MM/yyyy" renderAsPopup="true"
                             value="#{registrarTecnicaAnestesiaBean.fechafinnitroso}" popupTodayString="Hoy"
                             popupWeekString="Semana" popupButtonString="Fecha" readonly="false" maxlength="11"
                             size="11" popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                             renderPopupButtonAsImage="true" align="top" required="true"></t:inputCalendar>
            <a4j:outputPanel ajaxRendered="true" rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}">
          ...
          <h:panelGroup id="panelHoraFinNitroso">
            <h:panelGroup rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}">
              <h:selectOneMenu id="mnuHoraFinNitroso" required="true" immediate="true"  styleClass="input-mini"
            ...
            <h:outputText value=" : " rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}"/>
            <h:panelGroup rendered="#{registrarTecnicaAnestesiaBean.mostrarnitroso}">
              <h:selectOneMenu id="mnuMinutosFinNitroso" required="true" immediate="true" styleClass="input-mini"
                               value="#{registrarTecnicaAnestesiaBean.minutofinnitroso}">
                <f:selectItems value="#{registrarTecnicaAnestesiaBean.lstMinutos}"/>
              </h:selectOneMenu>
              <a4j:outputPanel ajaxRendered="true">
                <t:message for="mnuMinutosFinNitroso" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
          </h:panelGroup>
        </h:panelGrid>
      </s:fieldset>
      <s:fieldset legend="Agentes Anestesico Inhalatorio" id="fieldAgenteAnestesicoInhalatorio" styleClass="fieldset">
        <h:panelGrid columns="4" border="0" cellpadding="0" cellspacing="0" width="100%"
                     id="panelGridAgenteAnestesicoInhalatorio" rowClasses="labelText,labelTextInfo">
          <h:outputText value="Fecha Inicio"/>
          <h:outputText value="Hora Inicio"/>
          <h:outputText value=""/>
          <h:outputText value=""/>
          <h:panelGroup id="panelFechaInicioInhalatorio">
            <t:inputCalendar id="fechaInicioInhalatorio" onkeydown="return blockEnter(event);" styleClass="input-small"
                             monthYearRowClass="yearMonthHeader" weekRowClass="weekHeader" immediate="true"
                             title="Formato: dd/mm/yyyy" currentDayCellClass="currentDayCell"
                             popupDateFormat="dd/MM/yyyy" renderAsPopup="true"
                             value="#{registrarTecnicaAnestesiaBean.fechainicioinhalatorio}" popupTodayString="Hoy"
                             popupWeekString="Semana" popupButtonString="Fecha" readonly="false" maxlength="11"
                             size="11" popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                             renderPopupButtonAsImage="true" align="top" required="true"></t:inputCalendar>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGroup id="panelHoraInicioInhalatorio">
            <h:panelGroup>
              <h:selectOneMenu id="mnuHoraInicioInhalatorio" required="true" immediate="true" styleClass="input-mini"
            ...
            <h:outputText value=" : "/>
            <h:panelGroup>
              <h:selectOneMenu id="mnuMinutosInicioInhalatorio" required="true" immediate="true" styleClass="input-mini"
                               value="#{registrarTecnicaAnestesiaBean.minutoinicioinhalatorio}">
                <f:selectItems value="#{registrarTecnicaAnestesiaBean.lstMinutos}"/>
              </h:selectOneMenu>
              <a4j:outputPanel ajaxRendered="true">
                <t:message for="mnuMinutosInicioInhalatorio" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
          </h:panelGroup>
          <h:outputText value=""/>
          ...
          <a4j:region renderRegionOnly="false">
            <h:panelGroup>
              <h:selectOneRadio id="mnuAgenteInduccion" immediate="true" layout="pageDirection"
          ...
          <a4j:region renderRegionOnly="false">
            <h:panelGroup>
              <h:selectOneRadio id="mnuAgentemantenimiento" immediate="true" layout="pageDirection"
          ...
          <h:panelGroup id="panelInputVolumenMantenimiento">
            ...
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itMantenimientoConcentracion" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
          <h:outputText value=""/>
          <h:outputText value=""/>
          ...
          <a4j:region renderRegionOnly="false">
            <h:panelGroup>
              <h:selectOneRadio id="mnuCambio" immediate="true" layout="pageDirection"
          ...
          <h:panelGroup id="panelPorcentajeCambio">
            ...
            <a4j:outputPanel ajaxRendered="true" rendered="#{registrarTecnicaAnestesiaBean.mostrarcambio}">
              <t:message for="itPorcentaheCambio" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
          <h:panelGroup id="panelFechaCambio">
            <t:inputCalendar id="fechaCambio" onkeydown="return blockEnter(event);"
                             rendered="#{registrarTecnicaAnestesiaBean.mostrarcambio}" styleClass="input-small"
                             monthYearRowClass="yearMonthHeader" weekRowClass="weekHeader" immediate="true"
                             title="Formato: dd/mm/yyyy" currentDayCellClass="currentDayCell"
                             popupDateFormat="dd/MM/yyyy" renderAsPopup="true"
                             value="#{registrarTecnicaAnestesiaBean.fechacambio}" popupTodayString="Hoy"
                             popupWeekString="Semana" popupButtonString="Fecha" readonly="false" maxlength="11"
                             size="11" popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                             renderPopupButtonAsImage="true" align="top" required="true"></t:inputCalendar>
            <a4j:outputPanel ajaxRendered="true" rendered="#{registrarTecnicaAnestesiaBean.mostrarcambio}">
          ...
          <h:panelGroup id="panelHoraCambio">
            <h:panelGroup>
              <h:selectOneMenu id="mnuHoraCambio" required="true" styleClass="input-mini"
                               rendered="#{registrarTecnicaAnestesiaBean.mostrarcambio}" immediate="true"
            ...
            <h:panelGroup>
              <h:selectOneMenu id="mnuMinutosCambio" required="true" immediate="true" styleClass="input-mini"
                               rendered="#{registrarTecnicaAnestesiaBean.mostrarcambio}"
                               value="#{registrarTecnicaAnestesiaBean.minutocambio}">
                <f:selectItems value="#{registrarTecnicaAnestesiaBean.lstMinutos}"/>
              </h:selectOneMenu>
              <a4j:outputPanel ajaxRendered="true" rendered="#{registrarTecnicaAnestesiaBean.mostrarcambio}">
                <t:message for="mnuMinutosCambio" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
          </h:panelGroup>
          ...
          <h:panelGroup id="panelFechaFinInhalatorio">
            <t:inputCalendar id="fechaFinInhalatorio" onkeydown="return blockEnter(event);" styleClass="input-small"
                             monthYearRowClass="yearMonthHeader" weekRowClass="weekHeader" immediate="true"
                             title="Formato: dd/mm/yyyy" currentDayCellClass="currentDayCell"
                             popupDateFormat="dd/MM/yyyy" renderAsPopup="true"
                             value="#{registrarTecnicaAnestesiaBean.fechafininhalatorio}" popupTodayString="Hoy"
                             popupWeekString="Semana" popupButtonString="Fecha" readonly="false" maxlength="11"
                             size="11" popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                             renderPopupButtonAsImage="true" align="top" required="true"></t:inputCalendar>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGroup id="panelHoraFinInhalatorio">
            <h:panelGroup>
              <h:selectOneMenu id="mnuHoraFinInhalatorio" required="true" immediate="true" styleClass="input-mini"
            ...
            <h:outputText value=" : "/>
            <h:panelGroup>
              <h:selectOneMenu id="mnuMinutosFinInhalatorio" required="true" immediate="true" styleClass="input-mini"
                               value="#{registrarTecnicaAnestesiaBean.minutofininhalatorio}">
                <f:selectItems value="#{registrarTecnicaAnestesiaBean.lstMinutos}"/>
              </h:selectOneMenu>
              <a4j:outputPanel ajaxRendered="true">
                <t:message for="mnuMinutosFinInhalatorio" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
          </h:panelGroup>
          <h:outputText value=""/>
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                     id="panelGridObservacionesAgenteAnestesicoInhalatorio" rowClasses="labelText,labelTextInfo">
