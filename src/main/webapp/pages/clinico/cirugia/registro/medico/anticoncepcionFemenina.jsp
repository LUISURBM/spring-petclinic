   ...
   <f:view>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/comun/css/bootstrap-responsive.min.css"/>
         ...
         <script language="javascript" type="text/javascript">
              ...
              {   
                (document.getElementById('body:formDatosUsuario')).pagina.value=page_;
                (document.getElementById('body:formDatosUsuario')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/cirugia/registro/medico/anticoncepcionFemeninaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>