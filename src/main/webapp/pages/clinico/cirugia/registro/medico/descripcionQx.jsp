  ...
  <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
    ...
    <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
      ...
      <t:panelTab id="panelTabDescripcionQuirurgica" label="#{descripcionQuirurgicaBean.labelEncabezado}"
        ...
        <s:fieldset legend="#{descripcionQuirurgicaBean.labelfielSet}" 
        ...
        <s:fieldset legend="#{descripcionQuirurgicaBean.labelfielSet2}"  id="fieldDescripcionQuirugica" styleClass="fieldset">
          <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelAmbito"
            ...
            <h:panelGroup id="panelInstrumentador">
              <h:outputText value="Instrumentador" styleClass="labelTextOblig" rendered="#{descripcionQuirurgicaBean.renderObliIntrumentador}" />
              <h:outputText value="Instrumentador"  rendered="#{!descripcionQuirurgicaBean.renderObliIntrumentador}" />
              
            </h:panelGroup>
            <h:outputText value=""/>
            <h:panelGroup>
              <h:selectOneMenu id="idInstrumentadora" immediate="true" required="#{descripcionQuirurgicaBean.renderObliIntrumentador}" 
        ...
        <h:panelGrid  columns="8" border="0" cellpadding="0" cellspacing="0" width="100%"
            ...
            <a4j:region renderRegionOnly="false">
              <h:selectOneMenu id="mnuAyudantia1" immediate="true" required="true"
                  ...
                  <a4j:outputPanel ajaxRendered="true">
                    <t:message for="mnuAyudantia1" styleClass="errorMessage"/>
                  </a4j:outputPanel>
          ...
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
            ...
            <h:panelGroup id="panelGroupTextDiagnostico">
              <h:panelGroup rendered="#{descripcionQuirurgicaBean.mostrarComplicaciones}">
                <h:outputText value="Registrar Diagnostico Complicación" styleClass="labelTextOblig"/>
              </h:panelGroup>
            </h:panelGroup>
            ...
            <h:panelGroup id="panelTextDescripcionComplicacion">
              <h:outputText value="Descripción y manejo Complicación"
        ...
        <s:fieldset legend="#{descripcionQuirurgicaBean.labelfielSet3}" id="fieldSetDatosCirugiaAplicacion"
          ...
          <h:panelGrid columns="5" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <a4j:region renderRegionOnly="false">
                      <h:selectOneRadio id="mnuDiuresis" immediate="true"
                        ...
                        <a4j:support id="supportMnuDiuresis" event="onclick" immediate="true"
                                     ...
                                     reRender="panelTextCantidadDiresis,panelTextAspectos,panelTextGrado,panelCantidadDiuresis,panelMnuAspectos,panelMenuGrado,panelCuantificadoDiure">
                          <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                        </a4j:support>
                      </h:selectOneRadio>
                    </a4j:region>
           ...
           <h:panelGroup id="panelCuantificadoDiure">
              <h:outputText value="Cuantificado" styleClass="labelTextOblig"  rendered="#{descripcionQuirurgicaBean.mostrarDiuresis}"/>
              <h:panelGroup>
                <a4j:region renderRegionOnly="false">
                  <h:selectOneRadio id="mnuCuantificadoDiur" immediate="true" required="true"  rendered="#{descripcionQuirurgicaBean.mostrarDiuresis}"
                    ...
                    <f:selectItems value="#{descripcionQuirurgicaBean.lstOpciones}"/>
                     <a4j:support id="supportMnuDiuresisc" event="onclick" immediate="true"
                                     action="#{descripcionQuirurgicaBean.changeCuantiDiuresis}"
            ...
            <h:panelGroup id="panelTextCantidadDiresis">
              <h:outputText value="Cantidad (mL)" styleClass="labelTextOblig"
                            rendered="#{descripcionQuirurgicaBean.mostrarDiureCuanti}"/>
            ...
            <h:panelGroup id="panelTextGrado">
              <h:outputText value="Grado" styleClass="labelTextOblig"
                            rendered="#{descripcionQuirurgicaBean.mostrarDiureCuanti && descripcionQuirurgicaBean.renderGrado}"/>
           ...
           <s:fieldset legend="Productos Farmacéuticos" rendered="#{descripcionQuirurgicaBean.flagCostos}" id="fieldSetServicios"
                    styleClass="fieldset">
          
             
               <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
                     width="100%" id="tableContentTabsConsultar"
                     rendered="#{not empty descripcionQuirurgicaBean.lstServicios}"
                     styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         value="#{descripcionQuirurgicaBean.lstServicios}" rows="10"
                         binding="#{descripcionQuirurgicaBean.dtServiciosCostos}"
               ...
               <h:column>
                <f:facet name="header">
                  ...
                  <h:selectOneRadio  immediate="true"                          
                                    value="#{item.utilizo}"
                                     valueChangeListener="#{descripcionQuirurgicaBean.setUtilizo}">
                                    
                    <f:selectItem itemValue="S" itemLabel="Si"/>
                    <f:selectItem itemValue="N" itemLabel="No"/>
                    <a4j:support id="supportMnuUtilizo" immediate="true" event="onclick"
                               action="#{descripcionQuirurgicaBean.changeListaServicio}"
               ...
               <h:column>
                <f:facet name="header">
                  ...
                  <h:selectOneMenu rendered="#{not empty item.lstLotes}" immediate="true"                            
                                    ...
                                    valueChangeListener="#{descripcionQuirurgicaBean.setLote}">
                    ...
                    <a4j:support id="supportMnuLote" event="onchange" immediate="true"
                                 action="#{descripcionQuirurgicaBean.changeFechaLote}"
                                 reRender="fieldSetServicios">
                      <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                    </a4j:support>
                  </h:selectOneMenu>
        ...
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%"
          ...
          <h:panelGroup>
            <h:commandButton value="Guardar" styleClass="btn btn btn-success"
                             onclick="if (!confirm(\'¿Realmente desea Crear la Descripción Quirurgica\')) return false"
