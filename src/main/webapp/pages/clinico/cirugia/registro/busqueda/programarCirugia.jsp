...
<html>
   <f:view>
      <head>
         ...
         <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/comun/css/styles.css"/>
         ...
         <script language="javascript" src="<%=request.getContextPath()%>/comun/js/jquery-1.8.2.min.js" type="text/javascript"></script>
       
      </head>
      <body id="body"><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/cirugia/registro/busqueda/programarCirugiaBody.jsp"/>
