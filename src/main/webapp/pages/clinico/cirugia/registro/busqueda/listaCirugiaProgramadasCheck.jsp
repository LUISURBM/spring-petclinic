...
<html>
   <f:view>
      <head>
         ...
         <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/comun/css/AdminLTE.css"/>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/comun/css/bootstrap-responsive.min.css"/>
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/cirugia/registro/busqueda/listaCirugiaProgramadasCheckBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>