...
<a4j:form id="formListaCirugiasProgramadasCheck">
  <a4j:region id="regionListaCirugiasProgramadasCheck" renderRegionOnly="false">
    <a4j:status id="statusButton" for="regionListaCirugiasProgramadasCheck">
      <f:facet name="start">
        <t:div id="chargingListaCirugiasProgramadasCheck" styleClass="loading">
    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
                 width="100%" id="tableContentTabsListaCirugiasProgramadasCheck"
                 styleClass="content-header">
      <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0"
                         serverSideTabSwitch="false" activePanelTabVar="true"
                         width="100%" id="tabbedPaneListaCirugiasProgramadasCheck"
        ...
        <t:panelTab id="panelTabListaCirugiasProgramadas"
          ...
          <s:fieldset legend="CIRUGIAS PROGRAMADAS" id="fieldAsesoria"
            ...
            <h:panelGrid columns="1" id="panelGridNoConsultas"
                         rendered="#{empty listaCirugiasProgramadasCheckBean.lstCirugias}">
              <h:outputText value="#{listaCirugiasProgramadasCheckBean.msg_sin_registros}"/>
            </h:panelGrid>
            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
                         width="100%" id="tableContentTabs"
                         rendered="#{not empty listaCirugiasProgramadasCheckBean.lstCirugias}"
                         styleClass="tabContainer">
              <t:buffer into="#{table}">
                <h:dataTable var="item" border="1" cellpadding="0"
                             cellspacing="0"
                             binding="#{listaCirugiasProgramadasCheckBean.dtCirugias}"
                             value="#{listaCirugiasProgramadasCheckBean.lstCirugias}"
                  ...
                  <h:column>
                    ...
                    <h:commandLink id="atender"
                                   action="#{listaCirugiasProgramadasCheckBean.atenderUsuario}"
                                   ondblclick="openWin()">
