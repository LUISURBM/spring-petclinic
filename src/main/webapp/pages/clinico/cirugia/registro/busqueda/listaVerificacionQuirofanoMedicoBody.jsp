  ...
  <a4j:region id="bodyRegionListaVerificacion">
    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
      ...
      <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
        ...
        <t:panelTab id="panelTabListaRegistrosVerificacion" label="Verificacion de Quirofano Medico ">
          <h:panelGrid id="panelDatosListaVerificacion" columns="1" border="0" cellpadding="0" cellspacing="0"
            ...
            <s:fieldset legend="Usuarios" id="fieldSetVerificacion" styleClass="fieldset_dataTable">
              <h:panelGrid columns="1" id="panelGridVerificacion"
                           rendered="#{empty listaVerificacionQuirofanoMedicoBean.lstCirugiasIngresadas}">
                <h:outputText value="#{msg.msg_sin_consultar}"/>
              </h:panelGrid>
              <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                           id="tableContentTabsVerificacion"
                           rendered="#{not empty listaVerificacionQuirofanoMedicoBean.lstCirugiasIngresadas}"
                           styleClass="tabContainer">
                <t:buffer into="#{table}">
                  <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                               binding="#{listaVerificacionQuirofanoMedicoBean.dtCirugia}"
                               value="#{listaVerificacionQuirofanoMedicoBean.lstCirugiasIngresadas}" rows="10"
                    ...
                    <h:column>
                     ...
                     <h:column>
                      ...
                      <h:commandLink id="registrarVerificacion"
                            action="#{listaVerificacionQuirofanoMedicoBean.registrarVerificacionQuirofano}">
