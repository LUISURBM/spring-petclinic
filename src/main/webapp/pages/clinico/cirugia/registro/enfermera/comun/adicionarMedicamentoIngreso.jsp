...
<t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
  ...
  <t:panelTab id="panelTabIngresoHospitalizacion" label="Control Medicamentos Ingreso">
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                 id="panelGridFormulaHospitalizacion" styleClass="tabContainer">
      <s:fieldset legend="#{registrarMedicamentosIngresoBean.legendServicio}" id="fieldCirugiasMedicamentos" styleClass="fieldset">
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelCirugiasMedicamentos"
                     rowClasses="labelText,labelTextInfo">
          <h:outputText value="#{registrarMedicamentosIngresoBean.legendTablaServicio}"/>
          <h:outputText/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0"
                     rendered="#{not empty registrarMedicamentosIngresoBean.lstCirugias}" cellspacing="0" width="100%"
                     id="tableCirugiasProgramadasMedicamentos" styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         binding="#{registrarMedicamentosIngresoBean.dtCirugias}"
                         value="#{registrarMedicamentosIngresoBean.lstCirugias}" rows="10" styleClass="standard_table"
      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelActualizarMedicamentos"
          ...
          <h:panelGroup>
            <a4j:commandButton value="Actualizar Medicamentos" styleClass="btn btn btn-info"
                             action="#{registrarMedicamentosIngresoBean.actualizarDatos}" 
      ...
      <s:fieldset legend="Médicamentos Suministrados en su Totalidad " id="fieldMedicamentosSuministrados"
        ...
        <h:panelGrid columns="1" id="panelGridConsultarMedicamentosSuministrados"
                     rendered="#{empty registrarMedicamentosIngresoBean.lstMedicamentosTerminados}">
          <h:outputText value="#{msg.msg_sin_medicamentos_suministrados}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                     id="panelMedicamentosSuministradosTable"
                     rendered="#{not empty registrarMedicamentosIngresoBean.lstMedicamentosTerminados}"
                     styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         value="#{registrarMedicamentosIngresoBean.lstMedicamentosTerminados}" rows="10"
      ...
      <a4j:region renderRegionOnly="false">
        <s:fieldset legend="Médicamentos Formulados" id="fieldHospitalizacionLista" styleClass="fieldset">
          <h:panelGrid columns="1" id="panelGridConsultarMedicamentosFormulados"
                       rendered="#{empty registrarMedicamentosIngresoBean.lstPrescripciones}">
          ...
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelFormulacionTable"
                       rendered="#{not empty registrarMedicamentosIngresoBean.lstPrescripciones}" styleClass="tabContainer">
            <t:buffer into="#{table}">
              <h:dataTable var="item" border="1" cellpadding="0" binding="#{registrarMedicamentosIngresoBean.dtFormula}"
                           cellspacing="0" value="#{registrarMedicamentosIngresoBean.lstPrescripciones}" rows="10"
                           styleClass="standard_table" rowClasses="standardTable_Row1,standardTable_Row2"
                ...
                <h:column>
                  ...
                  <h:commandLink id="administrar" immediate="true"
                                 action="#{registrarMedicamentosIngresoBean.administrarMedicamento}">
        ...
        <s:fieldset legend="Médicamentos Formulados (Consulta Externa)" id="fieldMedicamentoExterna"
          ...
          <h:panelGrid columns="1" id="panelGridConsultarMedicamentosExterna"
                       rendered="#{empty registrarMedicamentosIngresoBean.lstPrescripcionesExterna}">
            <h:outputText value="#{msg.msg_sin_medicamentos_formulados}"/>
          </h:panelGrid>
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                       id="panelFormulacionTableExterna"
                       rendered="#{not empty registrarMedicamentosIngresoBean.lstPrescripcionesExterna}"
                       styleClass="tabContainer">
            <t:buffer into="#{table_Externa}">
              <h:dataTable var="item" border="1" cellpadding="0" binding="#{registrarMedicamentosIngresoBean.dtFormulaExterna}"
                           cellspacing="0" value="#{registrarMedicamentosIngresoBean.lstPrescripcionesExterna}" rows="10"
                           styleClass="standard_table" rowClasses="standardTable_Row1,standardTable_Row2"
                ...
                <h:column>
                  ...
                  <h:commandLink id="administrarExterna" immediate="true"
                                 action="#{registrarMedicamentosIngresoBean.administrarMedicamentoExterna}">
                    <t:graphicImage alt="" border="0" url="/comun/imagenes/editar.gif"/>
                  </h:commandLink>
                </h:column>
              </h:dataTable>
