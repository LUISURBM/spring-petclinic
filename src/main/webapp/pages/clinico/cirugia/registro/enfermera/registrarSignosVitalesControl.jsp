   ...
   <f:view>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/comun/css/bootstrap-responsive.min.css"/>
         <script language="javascript" src="<%=request.getContextPath()%>/comun/js/common.js" type="text/javascript"></script>
          ...
          <script>
    document.forms['body:formSignosVitales'].elements[4].focus(); 
       //Ejecuta una acci�n
  function temperaturaJs() {
       document.forms['body:formSignosVitales'].elements[8].focus(); 
    }
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/cirugia/registro/enfermera/registrarSignosVitalesControlBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>