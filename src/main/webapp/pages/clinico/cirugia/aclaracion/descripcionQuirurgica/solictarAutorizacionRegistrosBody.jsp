...
<a4j:form id="consultarRegistrosQuirurgicosForm">
    <a4j:region id="bodyRegionRegistrosQuirurgicos">
        <a4j:status id="statusButton" for="bodyRegionRegistrosQuirurgicos">
            <f:facet name="start">
                <t:div id="chargindConsultarRegistrosQuirurgicos" styleClass="loading">
        ...
        <h:panelGrid columns="1" id="tableConsultarRegistrosQuirurgicos" border="0" cellpadding="0" cellspacing="0"
                     width="100%" columnClasses="verticalaligntop,td_fondoBarraH">
            <h:outputText value="Consultar Registros Quirúrgicos " id="infoUbicationRegistrosQuirurgicos"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                     id="tableRegistrosQuirurgicosTabs" styleClass="tabContainer">
            <h:panelGroup>
                <a4j:outputPanel id="ajaxRegistrosQuirurgicos" ajaxRendered="true">
                    <t:htmlTag value="br"/>
                    <t:messages id="msgRegistrosQuirurgicos" showSummary="false" errorClass="error" globalOnly="true"
            ...
            <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false"
                               ...
                               selectedIndex="#{solicitarAutorizacionRegistrosBean.selectedIndex}"
                               disabledTabStyleClass="disabledTab" activeSubStyleClass="activeSub"
                               inactiveSubStyleClass="inactiveSub" tabContentStyleClass="tabContent">
                <t:panelTab id="panelConRegistrosQuirurgicos" label="Consultar Registros Quirúrgicos"
                            rendered="#{!solicitarAutorizacionRegistrosBean.renderBuscador}">
                    <s:fieldset legend="Datos Paciente" id="fieldDatosRegistrosQuirurgicos" styleClass="fieldset">
                        <h:panelGrid columns="4" border="0" cellpadding="0" width="100%"
                                     id="tableContentListaConRegistrosQuirurgicos" rowClasses="labelText,labelTextInfo">
                            <h:outputText value="Número Usuario" styleClass="labelTextOblig"/>
                            <h:panelGroup>
                                <h:outputText value="Nombre" styleClass="labelTextOblig"
                                              rendered="#{solicitarAutorizacionRegistrosBean.renderInformacionUsuario}"/>
                            </h:panelGroup>
                            <h:panelGroup>
                            ...
                            <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <a4j:commandLink action="#{solicitarAutorizacionRegistrosBean.mostrarBuscadorUsuarios}"
                                ...
                                <h:inputText id="idtipoAnulaMedico" maxlength="15" style="width:80px" immediate="true"
                                             value="#{solicitarAutorizacionRegistrosBean.numeroUsuario}"
                                             valueChangeListener="#{solicitarAutorizacionRegistrosBean.setNumeroUsuario}"
                                             binding="#{solicitarAutorizacionRegistrosBean.itNumeroUsuario}"
                                             onkeydown="return blockEnter(event);">
                                    <a4j:support id="supportNumUsuarioMedico" event="onchange" ignoreDupResponses="true"
                                                 action="#{solicitarAutorizacionRegistrosBean.changeUsuario}"
                            ...
                            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="2"
                                ...
                                <h:outputText value=" #{solicitarAutorizacionRegistrosBean.nombreUsuario}"
                                              styleClass="buscador"/>
                            </h:panelGrid>
                            <h:outputText value="#{solicitarAutorizacionRegistrosBean.usuario.husetipoiden}"/>
                            <h:outputText value="#{solicitarAutorizacionRegistrosBean.usuario.husanumeiden}"/>
                            <h:panelGroup>
                            ...
                            <h:outputText value="#{solicitarAutorizacionRegistrosBean.usuario.husdfechanacim}"/>
                            <h:outputText value="#{solicitarAutorizacionRegistrosBean.usuario.edad}"/>
                            <h:panelGroup>
                                <h:selectOneMenu id="radioSexoMedico" disabled="true"
                                                 rendered="#{solicitarAutorizacionRegistrosBean.renderInformacionUsuario}"
                                                 value="#{solicitarAutorizacionRegistrosBean.usuario.husesexo}">
                                    <f:selectItems value="#{solicitarAutorizacionRegistrosBean.listSexos}"/>
                                </h:selectOneMenu>
                            </h:panelGroup>
                            <h:panelGroup>
                                <h:selectOneMenu id="radioEstadoCivilRegistrosQuirurgicos" disabled="true"
                                                 rendered="#{solicitarAutorizacionRegistrosBean.renderInformacionUsuario}"
                                                 value="#{solicitarAutorizacionRegistrosBean.usuario.huseestadcivil}">
                                    <f:selectItems value="#{solicitarAutorizacionRegistrosBean.listEstadoCivil}"/>
                                </h:selectOneMenu>
                            </h:panelGroup>
                        </h:panelGrid>
                        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <a4j:commandButton value="Consultar Registros Quirurgicos"
                                               rendered="#{solicitarAutorizacionRegistrosBean.renderInformacionUsuario}"
                                               action="#{solicitarAutorizacionRegistrosBean.consultarRegistrosQuirugicos}"
                                               reRender="fieldSetListaDescripcionesAclaracion"
                                               styleClass="btn btn btn-success" id="idButtonBuscarHistoriaMedico"/>
                        </h:panelGrid>
                    </s:fieldset>
                    <s:fieldset legend="Descripción(es) Quirurgica(s) " id="fieldSetListaDescripcionesAclaracion"
                                styleClass="fieldset_dataTable">
                        <h:panelGrid columns="1" id="panelGridConsultarListaDescripcionesAclaracion"
                                     rendered="#{empty solicitarAutorizacionRegistrosBean.lstDescripcion}">
                            <h:outputText value="#{msg.msg_sin_consultar}"/>
                        </h:panelGrid>
                        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                                     id="tableContentTabsConsultarlstDescripcionAclaracion"
                                     rendered="#{not empty solicitarAutorizacionRegistrosBean.lstDescripcion}"
                                     styleClass="tabContainer">
                            <t:buffer into="#{table}">
                                <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                                             binding="#{solicitarAutorizacionRegistrosBean.dtDescripcionAclaracion}"
                                             value="#{solicitarAutorizacionRegistrosBean.lstDescripcion}" rows="10"
                                    ...
                                    <h:column>
                                        ...
                                        <h:outputText value="#{item[3]} #{item[4]}"/>
                                    </h:column>
                                    <h:column>
                                        <f:facet name="header">
                                            <h:outputText value="Descripción Quirurgica"/>
                                        </f:facet>
                                        <h:commandLink id="aclararDescripcion" immediate="true"
                                                       action="#{solicitarAutorizacionRegistrosBean.aclaracionDescripcion}">
                    ...
                    <h:panelGrid>
                        <h:commandLink action="#{solicitarAutorizacionRegistrosBean.volverConsulta}" immediate="true">
                        ...
                        <h:panelGrid id="panelGridBusUsuaBotMedico" width="100%" columnClasses="columnaBotonesCentrados"
                            ...
                            <h:panelGroup id="panelGroupBusUsuBotMedico">
                                <h:commandButton value="Aceptar Usuario" styleClass="btn btn btn-success"
                                                 action="#{solicitarAutorizacionRegistrosBean.aceptarUsuario}">
        ...
        <h:panelGrid>
            <h:panelGroup>
                <a4j:outputPanel id="ajaxRegionMsgRegistrosQuirurgicos" ajaxRendered="true">
                    <t:htmlTag value="br"/>
                    <t:messages id="msgInformationMsgRegistrosQuirurgicos" showSummary="true" errorClass="error"
