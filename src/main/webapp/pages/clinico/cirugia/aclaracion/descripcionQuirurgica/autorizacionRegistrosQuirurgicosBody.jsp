                    ...
                    <s:fieldset legend="Datos Paciente" id="fieldDatosAutorizacionRegistros" styleClass="fieldset">
                        <h:panelGrid columns="2" border="0" cellpadding="0" width="100%"
                            ...
                            <h:inputTextarea id="textAreaMotivoAclaracion" required="true"
                                             value="#{solicitarAutorizacionRegistrosBean.autoriza.hadcmotivsolic}"
            ...
            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
              ...
              <h:panelGroup>
                <h:commandButton value="Aceptar"
                                   ...
                                   action="#{solicitarAutorizacionRegistrosBean.solicitarAclaracion}"/>
              </h:panelGroup>
            </h:panelGrid>
                    <h:panelGrid>
                        <h:commandLink action="#{solicitarAutorizacionRegistrosBean.volverDescripcion}"
                                       immediate="true">
