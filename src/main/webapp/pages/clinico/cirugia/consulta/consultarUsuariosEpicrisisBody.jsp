    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
      ...
      <s:fieldset legend="Criterios de Busqueda" id="fieldSetInfoUsuario"
        ...
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0"
          ...
          <h:panelGroup>
            <h:selectOneMenu id="tipoIdentificacion"
                             value="#{consultarUsuariosEpicrisisBean.usuario.husetipoiden}">
              <f:selectItems value="#{consultarUsuariosEpicrisisBean.listTipoIdentificacion}"/>
            </h:selectOneMenu>
          ...
          <h:panelGroup>
            <h:inputText id="itNumeroDocumento" 
                         value="#{consultarUsuariosEpicrisisBean.usuario.husanumeiden}">
                        </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGroup>
            <h:inputText id="itPrimerNombre" styleClass="textmayuscula" 
                         value="#{consultarUsuariosEpicrisisBean.usuario.huscprimernomb}">
          ...
          <h:panelGroup>
            <h:inputText id="itSegundoNombre" styleClass="textmayuscula" 
                         value="#{consultarUsuariosEpicrisisBean.usuario.huscsegundnomb}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
            </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
          ...
          <h:panelGroup>
            <h:inputText id="itPrimerApellido" styleClass="textmayuscula" 
                         value="#{consultarUsuariosEpicrisisBean.usuario.huscprimerapel}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
                </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
          ...
          <h:panelGroup>
            <h:inputText id="itSegundoApellido" styleClass="textmayuscula" 
                         value="#{consultarUsuariosEpicrisisBean.usuario.huscsegundapel}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
                         </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
          ...
          <a4j:commandButton value="Buscar"
                             action="#{consultarUsuariosEpicrisisBean.buscarPacientesIngresados}"
      ...
      <s:fieldset legend="Resultados Consulta" id="fieldSetConsultar"
        ...
        <h:panelGrid columns="1" id="panelGridConsultar"
                     rendered="#{empty consultarUsuariosEpicrisisBean.lstUsuariosIngresados}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
                     width="100%" id="tableContentTabsConsultar"
                     rendered="#{not empty consultarUsuariosEpicrisisBean.lstUsuariosIngresados}"
                     styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         binding="#{consultarUsuariosEpicrisisBean.dtConsultaUsuario}"
                         value="#{consultarUsuariosEpicrisisBean.lstUsuariosIngresados}"
              ...
              <h:column>
                ...
                <h:commandLink id="consultarDescripcionQuirurgica"
                               action="#{consultarUsuariosEpicrisisBean.registrarEpicrisis}">
