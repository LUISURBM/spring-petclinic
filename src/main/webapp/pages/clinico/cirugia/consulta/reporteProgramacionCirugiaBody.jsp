...
<a4j:form id="formReporteProgramacion">
  <a4j:region id="regionReporteProgramacion" renderRegionOnly="false">
    <a4j:status id="statusButton" for="regionReporteProgramacion">
      <f:facet name="start">
        <t:div id="chargingReporteProgramacion" styleClass="loading">
    ...
    <h:panelGrid columns="1" id="tableInfoUbication" border="0" cellpadding="0" cellspacing="0" width="100%"
      ...
      <h:outputText value="HISTORIAS CLINICAS >> Cirugia >> Reporte  Programaci�n " id="infoUbication"/>
    </h:panelGrid>
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                 id="tableContentTabsReporteProgramacion" styleClass="tabContainer">
      <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
                         width="100%" id="tabbedPaneReporteProgramacion" styleClass="tabbedPane"
        ...
        <s:fieldset legend="Busqueda Consulta" id="fieldDatosConsulta" styleClass="fieldset">
          <h:panelGrid columns="4" border="0" cellpadding="0" cellspacing="10" width="100%"
                ...
                <h:outputText id="otnomDoctor" value="#{reporteProgramacionCirugiaBean.usuarioSystem.curcnombre}"/>
                <h:outputText value=" "/>
                <h:outputText value=" "/>
            ...
            <t:inputCalendar id="fechaConsulta" title="Formato: dd/MM/yyyy" monthYearRowClass="yearMonthHeader"
                             ...
                             renderAsPopup="true" value="#{reporteProgramacionCirugiaBean.fechaInicial}"
            ...
            <t:inputCalendar id="fechaFinalConsulta" title="Formato: dd/MM/yyyy" monthYearRowClass="yearMonthHeader"
                             weekRowClass="weekHeader" currentDayCellClass="currentDayCell" popupDateFormat="dd/MM/yyyy"
                             renderAsPopup="true" value="#{reporteProgramacionCirugiaBean.fechaFinal}"
                             popupTodayString="Hoy" popupWeekString="Semana" popupButtonString="Fecha" readonly="false"
                             disabled="false" maxlength="11" size="11" 
                             popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif" renderPopupButtonAsImage="true"
                             align="top" 
            ...
            <h:panelGroup>
              <h:selectOneMenu id="mnuSala" value="#{reporteProgramacionCirugiaBean.sala}" 
                               styleClass="dropdown-toggle, input-medium">
                <f:selectItems value="#{reporteProgramacionCirugiaBean.lstSalasCirugia}"/>
              </h:selectOneMenu>
              <a4j:outputPanel ajaxRendered="true">
                ...
                <h:outputText value="Numero Documento Usuario "/>
            <h:panelGroup>
              <h:inputText value="#{reporteProgramacionCirugiaBean.wusuario}"/>
            </h:panelGroup>
        ...
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%"
          ...
          <h:panelGroup>
            <a4j:commandButton value="Reporte Programaci�n" styleClass="btn btn btn-success"
                               reRender="tableContentTabsReporteProgramacion"
                               action="#{reporteProgramacionCirugiaBean.consultarProgramacion}">
              <a4j:support event="onclick" status="statusButton"/>
            </a4j:commandButton>
          </h:panelGroup>
        </h:panelGrid>
        <s:fieldset legend="Cirugias Programadas " id="fieldSetReporteCirugias" styleClass="fieldset_dataTable">
          <h:panelGrid columns="1" id="panelGridReporte"
                       rendered="#{empty reporteProgramacionCirugiaBean.lstCirugiasCompleta}">
            <t:messages id="msgReporteProgramacionCirugia" showSummary="false" errorClass="error" globalOnly="true"
                        layout="table" infoClass="informacion" showDetail="true" tooltip="true"/>
          </h:panelGrid>
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                       id="tableContentTabsReporte"
                       rendered="#{not empty reporteProgramacionCirugiaBean.lstCirugiasCompleta}"
                       styleClass="tabContainer">
            <t:buffer into="#{table}">
              <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                           value="#{reporteProgramacionCirugiaBean.lstCirugiasCompleta}" rows="50"
                ...
                <h:column>
                  ...
                  <h:outputText value="#{item.descSala}"/>
                </h:column>
              ...
              <h:column>
                  ...
                  <h:outputText value="#{item.numerofijo}"/>
                </h:column>
         ...
         <f:subview id="generarReporteProgramacion" rendered="#{reporteProgramacionCirugiaBean.generoReporte}">
                  <f:verbatim>
