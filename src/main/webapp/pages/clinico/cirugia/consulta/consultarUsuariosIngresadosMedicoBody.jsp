    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
      ...
      <s:fieldset legend="Criterios de Busqueda" id="fieldSetInfoUsuario"
        ...
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0"
          ...
          <h:panelGroup>
            <h:selectOneMenu id="tipoIdentificacion"
                             value="#{consultarUsuariosIngresadosMedicoBean.usuario.husetipoiden}">
              <f:selectItems value="#{consultarUsuariosIngresadosMedicoBean.listTipoIdentificacion}"/>
            </h:selectOneMenu>
          ...
          <h:panelGroup>
            <h:inputText id="itNumeroDocumento" 
                         value="#{consultarUsuariosIngresadosMedicoBean.usuario.husanumeiden}">
                     </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGroup>
            <h:inputText id="itPrimerNombre" styleClass="textmayuscula" 
                         value="#{consultarUsuariosIngresadosMedicoBean.usuario.huscprimernomb}">
          ...
          <h:panelGroup>
            <h:inputText id="itSegundoNombre" styleClass="textmayuscula" 
                         value="#{consultarUsuariosIngresadosMedicoBean.usuario.huscsegundnomb}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
                </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
          ...
          <h:panelGroup>
            <h:inputText id="itPrimerApellido" styleClass="textmayuscula" 
                         value="#{consultarUsuariosIngresadosMedicoBean.usuario.huscprimerapel}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
            </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
          ...
          <h:panelGroup>
            <h:inputText id="itSegundoApellido" styleClass="textmayuscula" 
                         value="#{consultarUsuariosIngresadosMedicoBean.usuario.huscsegundapel}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
            </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
          ...
          <a4j:commandButton value="Buscar"
                             action="#{consultarUsuariosIngresadosMedicoBean.buscarPacientesIngresados}"
      ...
      <s:fieldset legend="Resultados Consulta" id="fieldSetConsultar"
        ...
        <h:panelGrid columns="1" id="panelGridConsultar"
                     rendered="#{empty consultarUsuariosIngresadosMedicoBean.lstUsuariosIngresados}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
                     width="100%" id="tableContentTabsConsultar"
                     rendered="#{not empty consultarUsuariosIngresadosMedicoBean.lstUsuariosIngresados}"
                     styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         binding="#{consultarUsuariosIngresadosMedicoBean.dtConsultaUsuario}"
                         value="#{consultarUsuariosIngresadosMedicoBean.lstUsuariosIngresados}" rows="10"
             ...
             <h:column>
              ...
              <h:column>
                <f:facet name="header">
                  <h:outputText value="#{consultarUsuariosIngresadosMedicoBean.nombreLabel}"/>
                </f:facet>
                 <h:commandLink id="consultarDescripcionQuirurgica" 
                               action="#{consultarUsuariosIngresadosMedicoBean.registrarDescripcionQuirurgica}">
