...
<html>
   <f:view>
    ...
    function numeroJs() {
       document.forms['body:formDatosSAPUsuarios'].elements[9].focus(); 
    }
    ...
    function searchByEnterAndReturn(e){ 
        if(e.keyCode==13){
            document.getElementById("body:formDatosSAPUsuarios:panelTabDatosSAPUsuario:BtnBuscar").click(); 
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/cirugia/consulta/consultarUsuarioCirugiaSinFacturaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>