...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/comun/css/estilos.css"/>
         ...
         <link rel="stylesheet" type="text/css"
               href="<%=request.getContextPath()%>/comun/css/bootstrap-responsive.css"/>
         <link rel="stylesheet" type="text/css"
               href="<%=request.getContextPath()%>/comun/css/bootstrap-responsive.min.css"/>
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridFoliosCirugiaTab"
            ...
            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableFoliosCirugiaTabs"
                ...
                <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false"
                                   ...
                                   selectedIndex="#{consultarFoliosUsuarioCirugiaBean.selectedIndex}"
                    ...
                    <t:panelTab id="panelConFoliosCirugia" label="Consultar Folios Cirugia"
                        ...
                        <s:fieldset legend="Imprimir Folios Cirugia" id="fieldSetListaFoliosCirugia"
                            ...
                            <h:panelGrid columns="1" id="panelGridFoliosCirugia"
                                         rendered="#{empty consultarFoliosUsuarioCirugiaBean.lstFolios}">
                                <h:outputText value="#{msg.msg_sin_consultar}"/>
                            </h:panelGrid>
                            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                                         id="tableContentTabsFoliosCirugia"
                                         rendered="#{not empty consultarFoliosUsuarioCirugiaBean.lstFolios}"
                                         styleClass="tabContainer">
                               
                                    <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                                                 binding="#{consultarFoliosUsuarioCirugiaBean.dtFoliosCirugia}"
                                                 value="#{consultarFoliosUsuarioCirugiaBean.lstFolios}" rows="10"
                                        ...
                                        <h:column>
                                            ...
                                            <h:commandLink id="imprimirDescripcion" immediate="true"
                                                           action="#{consultarFoliosUsuarioCirugiaBean.generar}">
