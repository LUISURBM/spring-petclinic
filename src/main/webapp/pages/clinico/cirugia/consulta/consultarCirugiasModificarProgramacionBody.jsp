...
<a4j:form id="consultamodificarModiProgaForm">
  <a4j:region id="bodyRegionConsultaModificacionProgramacion">
    ...
    <h:panelGrid columns="1" id="tableConsultarmodificarModiProga" border="0" cellpadding="0" cellspacing="0" width="100%"
      ...
      <h:outputText value="Datos Usuario - Modificar Programación Usuario  " id="infoUbication"/>
    </h:panelGrid>
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableContenmodificarModiProga"
      ...
      <s:fieldset legend="Criterios de Busqueda" id="fieldSetInfoUsuarioModificarProgramar" styleClass="fieldset">
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelRegionConsultarModificaPrograma"
          ...
          <h:panelGroup>
            <h:selectOneMenu id="tipoIdentificacionModiProga" value="#{modificarCirugiasProgramarBean.usuario.husetipoiden}">
              <f:selectItems value="#{modificarCirugiasProgramarBean.listTipoIdentificacion}"/>
            </h:selectOneMenu>
          ...
          <h:panelGroup>
            <h:inputText id="itNumeroDocumentoModiProga"  
                         value="#{modificarCirugiasProgramarBean.usuario.husanumeiden}">
             </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGroup>
            <h:inputText id="itPrimerNombreModiProga" styleClass="textmayuscula" 
                         value="#{modificarCirugiasProgramarBean.usuario.huscprimernomb}">
          ...
          <h:panelGroup>
            <h:inputText id="itSegundoNombreModiProga" styleClass="textmayuscula" 
                         value="#{modificarCirugiasProgramarBean.usuario.huscsegundnomb}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
                </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumentoModiProga" styleClass="errorMessage"/>
          ...
          <h:panelGroup>
            <h:inputText id="itPrimerApellidoModiProga" styleClass="textmayuscula" 
                         value="#{modificarCirugiasProgramarBean.usuario.huscprimerapel}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
                        </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumentoModiProga" styleClass="errorMessage"/>
          ...
          <h:panelGroup>
            <h:inputText id="itSegundoApellidoProga" styleClass="textmayuscula" 
                         value="#{modificarCirugiasProgramarBean.usuario.huscsegundapel}">
                            <f:converter converterId="cadena.stringUpperCaseConverter"/>
                        </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumentoModiProga" styleClass="errorMessage"/>
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonUsuarioModiProga"
          ...
          <t:htmlTag value="br"/>
          <a4j:commandButton value="Buscar" action="#{modificarCirugiasProgramarBean.buscarUsuarioProgramacion}"
    ...
    <s:fieldset legend="Resultados Consulta" id="fieldSetConsultarModiProga" styleClass="fieldset_dataTable" >
        <h:panelGrid columns="1" id="panelGridModiProga" rendered="#{empty modificarCirugiasProgramarBean.lstUsuarios}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" 
                        id="tableContentTabsModiProga"
                     rendered="#{not empty modificarCirugiasProgramarBean.lstUsuarios}" styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         binding="#{modificarCirugiasProgramarBean.dtConsultaUsuario}"
                         value="#{modificarCirugiasProgramarBean.lstUsuarios}" rows="10" styleClass="standard_table"
              ...
              <h:column>
                ...
                <h:commandLink id="aceptar" action="#{modificarCirugiasProgramarBean.consultar}">
