...
<a4j:form id="consultarAutorizacionRegistrosForm">
    <a4j:region id="bodyRegionAutorizacionRegistros">
        ...
        <h:panelGrid columns="1" id="tableConsultarAutorizacionRegistros" border="0" cellpadding="0" cellspacing="0"
            ...
            <h:outputText value="Solicitar Informe Psicologico " id="infoUbicationAutorizacionRegistros"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
            ...
            <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false"
                ...
                <t:panelTab id="panelConAutorizacionRegistros" label="Solicitar Informe Psicologico. ">
                 <jsp:include page="/pages/clinico/comunes/encabezadoDatosUsuario.jsp" flush="true"/>
                    <s:fieldset legend="Motivo" id="fieldDatosAutorizacionRegistros" styleClass="fieldset">
                        <h:panelGrid columns="2" border="0" cellpadding="0" width="100%"
                            ...
                            <h:outputText value=" Motivo Solicitud de informe"  styleClass="labelTextOblig"/>
                            <h:outputText value=""/>
                            <h:inputTextarea id="textAreaMotivoSolicitudInforme" required="true"
                                             value="#{solicitarInformePsicologicoBean.autoriza.haipcmotivsolic}"
                                             style="width:650px;height:70px">
                                <f:validateLength maximum="4000"/>
                            </h:inputTextarea>
                            <a4j:outputPanel ajaxRendered="true">
                                <t:message for="textAreaMotivoSolicitudInforme" styleClass="errorMessage"/>
                            </a4j:outputPanel>
                        </h:panelGrid>
                    </s:fieldset>
                    
            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
                         width="100%" id="panelBotonesMotivoSolicitudInforme"
                         columnClasses="panelGridBotones">
              <h:panelGroup>
                <h:commandButton value="Aceptar"
                                   styleClass="btn btn btn-success"
                                   action="#{solicitarInformePsicologicoBean.solicitarAclaracion}"/>
              </h:panelGroup>
            </h:panelGrid>
                    <h:panelGrid>
                        <h:commandLink action="#{solicitarInformePsicologicoBean.volverDescripcion}"
                                       immediate="true">
