...
<html>
  ...
  {   
    (document.getElementById('body:formInformeMamografia')).pagina.value=page_;
    (document.getElementById('body:formInformeMamografia')).submit();
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body"
                          value="/pages/clinico/procedimientos/informeCitopuncionSenoBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>