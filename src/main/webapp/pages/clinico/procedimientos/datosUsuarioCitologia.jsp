...
<html>
  ...
  {   
    (document.getElementById('body:formDatosUsuarioCitologia')).pagina.value=page_;
    (document.getElementById('body:formDatosUsuarioCitologia')).submit();

   } 
   
   
     function jsFunctionDepartamento() {
        document.forms['body:formDatosUsuarioCitologia'].elements[13].focus(); 
    }
   
    function jsFunctionOtroDepartamento() {
        document.forms['body:formDatosUsuarioCitologia'].elements[24].focus(); 
    }
      ...
      <body><a4j:page id="completePage">
            ...
            <tiles:put name="body"
                          value="/pages/clinico/procedimientos/datosUsuarioCitologiaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>