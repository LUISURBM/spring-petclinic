  ...
  <a4j:region id="regionLecturaCitologia" renderRegionOnly="false">
    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridLecturaCitologiaTab"
      ...
      <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
        ...
        <t:panelTab id="panelTabLecturaCitologia" label="Modificar lectura Citologia">
              ...
              <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                <h:panelGroup>
                  <a4j:region renderRegionOnly="false">
                    <h:selectOneMenu id="menuCalidadMuestra" required="true" immediate="true" style="width:600px"
                ...
                <h:panelGroup id="panelTextMicroorganismos">
                  <h:outputText value="MicroOrganismos" styleClass="labelTextOblig"
                  ...
                  <a4j:region renderRegionOnly="false">
                    <h:panelGroup>
                      <h:selectOneMenu id="menuMicroOrganismos" required="true" immediate="true"
                                       ...
                                       rendered="#{lecturaCitologiaBean.renderLectura}" style="width:600px"
