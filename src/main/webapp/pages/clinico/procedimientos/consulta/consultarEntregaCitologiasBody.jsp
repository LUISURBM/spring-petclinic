    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableContenUsuario" styleClass="tabContainer">
      <s:fieldset legend="Criterios de Busqueda" id="fieldSetInfoUsuario" styleClass="fieldset">
        <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelRegionUsuario" rowClasses="labelText,labelTextInfo">
          ...
          <h:panelGroup>
            <h:selectOneMenu id="tipoIdentificacion" value="#{consultarEntregaCitologiasBean.citologia.ccictipide}">
              <f:selectItems value="#{consultarEntregaCitologiasBean.listTipoIdentificacion}"/>
            </h:selectOneMenu>
          ...
          <h:panelGroup>
            <h:inputText id="itNumeroDocumento"
                value="#{consultarEntregaCitologiasBean.citologia.ccianumide}">
             </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroDocumento" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
          <h:outputText value="Número de la Citologia"/>
          <h:outputText value=""/>
          <h:panelGroup>
            <h:inputText id="itNumeroCitologia" 
            value="#{consultarEntregaCitologiasBean.citologia.ccinconsec}">
             </h:inputText>
            <a4j:outputPanel ajaxRendered="true">
              <t:message for="itNumeroCitologia" styleClass="errorMessage"/>
            </a4j:outputPanel>
          </h:panelGroup>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonUsuario" columnClasses="columnaBotonesCentrados">
          ...
          <t:htmlTag value="br"/>
          <a4j:commandButton value="Buscar" action="#{consultarEntregaCitologiasBean.consultarCitologia}" reRender="fieldSetConsultar" styleClass="boton_fieldset" id="idButtonUsuario"/>
        </h:panelGrid>
      </s:fieldset>
      <s:fieldset legend="Resultados Consulta" id="fieldSetConsultar" styleClass="fieldset_dataTable">
        <h:panelGrid columns="1" id="panelGridConsultar" rendered="#{empty consultarEntregaCitologiasBean.lstCitologia}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableContentTabsConsultar" rendered="#{not empty consultarEntregaCitologiasBean.lstCitologia}"
                     styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0" binding="#{consultarEntregaCitologiasBean.dtConsultaCitologia}" value="#{consultarEntregaCitologiasBean.lstCitologia}"
              ...
              <h:column>
                ...
                <h:outputText value="#{item.ccictipide} #{item.ccianumide}"/>
              </h:column>
              <h:column>
                <f:facet name="header">
              ...
              <h:column>
                ...
                <h:outputText value="#{item.wtipcito}"/>
              </h:column>
              <h:column>
                <f:facet name="header">
                  <h:outputText value="Numero de Citologia"/>
                </f:facet>
              ...
              <h:column>
                ...
                <h:commandLink id="aceptar" action="#{consultarEntregaCitologiasBean.consultar}">
