        ...
        <h:panelGrid columns="2" id="tableBodyGeneral" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="verticalaligntop,td_fondoBarraH">
            <h:panelGroup id="tableGroupContent">
                <h:panelGrid columns="1" id="tableInfoUbication" border="0" cellpadding="0" cellspacing="0" width="100%" columnClasses="td_ubicador">
                    <h:outputText value="Historias Clinicas >> Consulta Profesionales Lectura" id="infoUbication"/>
                </h:panelGrid>
                        ...
                        <t:panelTab id="panelTabInfoGenral" label="Consultar Profesionales Lectura" rendered="true">
                            ...
                            <s:fieldset legend="Criterios de Busqueda" id="fieldSetInfoBasica" styleClass="fieldset">
                                <h:panelGrid columns="4" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelRegionInfoBasica" rowClasses="labelText,labelTextInfo">
                                    ...
                                    <h:outputText value=""/>
                                    <h:inputText id="labelcltscnombre" value="#{profesionalLecturaBean.profesionalLec.comp_id.hplnclinlect}"/>
                                    <a4j:outputPanel ajaxRendered="true">
                                        <t:message for="labelcltscnombre" id="messagecltscnombre" errorClass="errorMessage"/>
                                    </a4j:outputPanel>
                                    <h:inputText id="labelcltscdescripcion" value="#{profesionalLecturaBean.profesionalLec.comp_id.hplncodprofes}"/>
                                    <a4j:outputPanel ajaxRendered="true">
                                ...
                                <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonConsulta" columnClasses="columnaBotonesCentrados">
                                    <t:htmlTag value="br"/>
                                    <a4j:commandButton value="Buscar" action="#{profesionalLecturaBean.buscar}" reRender="tableContentTabs" styleClass="boton_fieldset"/>
                                </h:panelGrid>
                            </s:fieldset>
                            <s:fieldset legend="Operaciones Basicas" id="fieldSetOperBasica" styleClass="fieldset">
                                <h:panelGrid columns="2" rowClasses="labelText,labelText">
                                    ...
                                    <h:commandButton value="Profesional" action="#{profesionalLecturaBean.verAdicionar}" styleClass="boton_fieldset"/>
                                </h:panelGrid>
                            </s:fieldset>
                            <s:fieldset legend="Resultados Consulta" id="fieldSetResConsulta" styleClass="fieldset_dataTable">
                                <h:panelGrid columns="1" id="panelGridNoEmpresa" rendered="#{empty profesionalLecturaBean.listaProfesionalesLec}">
                                    <h:outputText value="#{msg.msg_sin_consultar}"/>
                                </h:panelGrid>
                                <h:panelGrid columns="1" id="panelGridEmpresa" rendered="#{not empty profesionalLecturaBean.listaProfesionalesLec}" width="100%" style="text-align:center;">
                                    <t:buffer into="#{table}">
                                        <h:dataTable var="item" border="0" cellpadding="0" cellspacing="0" binding="#{profesionalLecturaBean.dtProfesionalLectura}"
                                                     value="#{profesionalLecturaBean.listaProfesionalesLec}" styleClass="standard_table" rowClasses="standardTable_Row1,standardTable_Row2"
                                                     footerClass="paginacion" rows="20" id="idDtProfesionales">
                                            <h:column>
                                                <f:facet name="header">
                                                    <h:outputText value="Profesional"/>
                                                </f:facet>
                                                <h:outputText value="#{item.comp_id.hplncodprofes} - #{item.cpprofesio.cpfcnombre}"/>
                                            </h:column>
                                            <h:column>
                                                <f:facet name="header">
                                                    <h:outputText value="Centro de Profesional"/>
                                                </f:facet>
                                                <h:outputText value="#{item.hplnclinprof} - #{item.centroProfesional}"/>
                                            </h:column>
                                            <h:column>
                                                <f:facet name="header">
                                                    <h:outputText value="Centro para Lectura"/>
                                                </f:facet>
                                                <h:outputText value="#{item.comp_id.hplnclinlect} - #{item.centroLectura}"/>
                                            </h:column>
                                            <h:column>
                                                <f:facet name="header">
                                                    <h:outputText value="Estado"/>
                                                </f:facet>
                                                <h:outputText value="#{item.hplcestado}"/>
                                            </h:column>
                                            <h:column>
                                                <f:facet name="header">
                                                    <h:outputText value="Editar"/>
                                                </f:facet>
                                                <h:commandLink id="editar" action="#{profesionalLecturaBean.verEditar}">
