...
<h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridReferenciaTab"
  ...
  <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
                     ...
                     selectedIndex="#{referenciaUsuarioBean.selectedIndex}"
    ...
    <t:panelTab id="panelTabReferencia" label="Referencia">
      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridReferencia"
        ...
        <s:fieldset legend="Referencia" id="fieldReferencia" styleClass="fieldset">
          <s:fieldset legend="Responsable" id="fieldReferenciaResponsable" styleClass="fieldset">
            <h:panelGrid columns="6" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelDatosReferencia1"
              ...
              <h:outputText/>
              <h:panelGroup>
                <h:inputText id="itNombreResponsable" required="true" onkeydown="return blockEnter(event);"
                             maxlength="40" disabled="#{referenciaUsuarioBean.modoconsulta}"
              ...
              <h:inputText id="itNumeroIde" immediate="true"
              maxlength="15" required="true"
                           disabled="#{referenciaUsuarioBean.modoconsulta}"
                           value="#{referenciaUsuarioBean.referencia.hreanumideresp}"
                           onkeydown="return blockEnter(event);">
                           </h:inputText>
              <a4j:outputPanel ajaxRendered="true">
                <t:message for="itNumeroIde" styleClass="errorMessage"/>
              </a4j:outputPanel>
              <h:outputText/>
              <h:outputText/>
              ...
              <h:outputText/>
              <h:panelGroup>
                <h:inputText id="itDirResponsable"  immediate="true" required="true" maxlength="40" onkeydown="return blockEnter(event);"
                             disabled="#{referenciaUsuarioBean.modoconsulta}"
              ...
              <h:panelGroup>
                <h:inputText id="itCelResponsable" immediate="true" required="true" onkeydown="return blockEnter(event);" maxlength="20"
                             disabled="#{referenciaUsuarioBean.modoconsulta}"
              ...
              <h:outputText/>
              <a4j:region renderRegionOnly="false">
                <h:selectOneMenu id="menuDepartamentos" immediate="true" onkeydown="return blockEnter(event);"
              ...
              <h:panelGroup id="panelCiudad">
                <h:selectOneMenu id="menuCiudad" immediate="true" onkeydown="return blockEnter(event);" required="true"
                                 disabled="#{referenciaUsuarioBean.modoconsulta}"
          ...
          <s:fieldset legend="Datos Referencia "  id="fieldRef" styleClass="fieldset">
            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelDatosReferencia2"
                         rowClasses="labelText,labelTextInfo">
              <h:outputText value="Servicio donde se encuentra el paciente" styleClass="labelTextOblig"/>
              <h:panelGroup>
                <h:inputText id="textServicioSolicitaEncuentra" required="true" 
                disabled="#{referenciaUsuarioBean.modoconsulta}" immediate="true"
              ...
              <h:panelGroup>
                <h:inputText id="textServicioSolicita" immediate="true" required="true" disabled="#{referenciaUsuarioBean.modoconsulta}"
              ...
              <h:panelGroup>
                <h:inputTextarea id="textAnamnesis" immediate="true" required="true" disabled="#{referenciaUsuarioBean.modoconsulta}"
              ...
              <h:panelGroup>
                <h:inputTextarea id="textJustificacion" immediate="true" required="true" disabled="#{referenciaUsuarioBean.modoconsulta}"
        ...
        <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0" id = "panelDiagnostico">
              ...
              <a4j:commandLink action="#{referenciaUsuarioBean.mostrarDiagnostico}" immediate="true"
                               reRender="panelGridReferenciaTab">
                <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                <t:graphicImage alt="" border="0" url="/comun/imagenes/lupa.gif"/>
              </a4j:commandLink>
            
              <h:inputText id="itDiagnostico" onkeydown="return blockEnter(event);" 
                           styleClass="textmayuscula" value="#{referenciaUsuarioBean.referencia.hrecdiagnosti}"
                ...
                <a4j:support id="supportDiagnostico" event="onchange"
                             action="#{referenciaUsuarioBean.changeDiagnostico}"
                             reRender="panelDiagnostico">
                  <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                </a4j:support>
                  <a4j:outputPanel ajaxRendered="true">
              ...
              <h:panelGroup>
                ...
                <a4j:outputPanel ajaxRendered="true">
                 ...
                 <h:outputText value="Morbilidad Materna Extrema" styleClass="labelTextOblig" rendered="#{referenciaUsuarioBean.renderHistoriasValidas}"/>
                  <a4j:region renderRegionOnly="false">
                    <h:panelGroup>
                      <h:selectOneRadio id="radioMorbilidadCiru" required="true" immediate="true"
                                        onkeydown="return blockEnter(event);"
                        ...
                        <a4j:support id="supportRadioMorbilidadCiru" event="onclick" reRender="panelTextMedicoCiru,panelMedAutTrasCiru,textMedicoCiru"
                    ...
                    <t:message for="radioMorbilidadCiru" styleClass="errorMessage"/>
                  </a4j:outputPanel>
                    </h:panelGroup>
                  </a4j:region>
                </h:panelGrid>
                <h:panelGroup id="panelTextMedicoCiru">
                <h:outputText id="textMedicoCiru" value="Medico que autoriza el traslado" styleClass="labelTextOblig"/>
                </h:panelGroup>
                <h:panelGrid columns="2" border="0" cellpadding="1" cellspacing="1" columnClasses="labelTextInfo" id="panelMedAutTrasCiru">
              <a4j:commandLink action="#{referenciaUsuarioBean.mostrarBuscadorProfesional}" 
                               reRender="panelGridReferenciaTab" immediate="true">
                <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                <t:graphicImage alt="" border="0" url="/comun/imagenes/lupa.gif"/>
              </a4j:commandLink>
              <h:inputText id="itMedicoCiru" disabled="true"
          ...
          <s:fieldset legend="Lista de Chequeo " id="fieldListaChequeo" styleClass="fieldset">
            <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelListaChequeo"
              ...
              <h:outputText/>
                 ...
                 <h:selectOneRadio id="mnuDiligenciaFormato"  immediate="true" disabled="#{referenciaUsuarioBean.modoconsulta}"
              ...
              <h:outputText value="2. Se adjunta copia de la historia cl�nica del paciente (de la atenci�n actual)"
                            styleClass="labelTextOblig"/>
              <h:outputText/>
              <h:selectOneRadio id="mnuCopiaHisto"  immediate="true" disabled="#{referenciaUsuarioBean.modoconsulta}" value="#{referenciaUsuarioBean.referencia.hreccopiahisto}"
                                required="true">
                <f:selectItems value="#{referenciaUsuarioBean.lstOpciones}"/>
              </h:selectOneRadio>
              <a4j:outputPanel ajaxRendered="true">
              ...
              <h:outputText value="3. Se anexan los resultados de los apoyos diagn�sticos tomados con ocasi�n de la atenci�n actual"
                            styleClass="labelTextOblig"/>
              <h:outputText/>
              <h:selectOneRadio id="mnuResulApoyo"  immediate="true" disabled="#{referenciaUsuarioBean.modoconsulta}" value="#{referenciaUsuarioBean.referencia.hrecresulapoyo}"
                                required="true">
                <f:selectItems value="#{referenciaUsuarioBean.lstOpciones}"/>
              </h:selectOneRadio>
              <a4j:outputPanel ajaxRendered="true">
              ...
              <h:outputText/>
              <h:selectOneRadio id="mnuCartaPago"   disabled="#{referenciaUsuarioBean.modoconsulta}" value="#{referenciaUsuarioBean.referencia.hreccartapago}"
                                required="true">
                <f:selectItems value="#{referenciaUsuarioBean.lstOpciones}"/>
              </h:selectOneRadio>
              <a4j:outputPanel ajaxRendered="true">
      ...
      <f:subview id="generarReferencia" rendered="#{referenciaUsuarioBean.generoReferencia}">
        ...
        <t:panelTab id="panelBuscador" label="Buscar Diagnosticos"
                rendered="#{referenciaUsuarioBean.mostrarCie10}">
        ...
        <h:panelGrid id="panelGridCie10Botones" width="100%" columnClasses="columnaBotonesCentrados" dir="RTL">
          ...
          <h:panelGroup id="panelGroupCie10Botones1">
            <a4j:commandButton value="Aceptar" styleClass="btn btn btn-success"
                               action="#{referenciaUsuarioBean.aceptarDiagnostico}"
                               reRender="panelGridReferenciaTab">
              <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
            </a4j:commandButton>
          </h:panelGroup>
