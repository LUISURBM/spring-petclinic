...
<a4j:form id="consultarCopiaTuberculinaForm">
    <a4j:region id="bodyRegionCopiaTuberculina">
        ...
        <h:panelGrid columns="1" id="tableConsultarCopiaTuberculina" border="0" cellpadding="0" cellspacing="0"
            ...
            <h:outputText value="Imprimir Copia Primeros Auxilios Psicologicos " id="infoUbicationCopiaTuberculina"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableCopiaTuberculinaTabs"
            ...
            <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false"
                               ...
                               selectedIndex="#{consultarCopiaPAPsicologiaBean.selectedIndex}"
                               disabledTabStyleClass="disabledTab" activeSubStyleClass="activeSub"
                               inactiveSubStyleClass="inactiveSub" tabContentStyleClass="tabContent">
                <t:panelTab id="panelConFoliosCopiaTuberculina" label="Consultar Primeros Aux. Psicologia"
                            rendered="#{!consultarCopiaPAPsicologiaBean.renderBuscador}">
                    <s:fieldset legend="Datos Paciente" id="fieldDatosCopiaTuberculina" styleClass="fieldset">
                        <h:panelGrid columns="4" border="0" cellpadding="0" width="100%"
                            ...
                            <h:panelGroup>
                                <h:outputText value="Nombre" styleClass="labelTextOblig"
                                              rendered="#{consultarCopiaPAPsicologiaBean.renderInformacionUsuario}"/>
                            </h:panelGroup>
                            <h:panelGroup>
                            ...
                            <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <a4j:commandLink action="#{consultarCopiaPAPsicologiaBean.mostrarBuscadorUsuarios}"
                                ...
                                <h:inputText id="idtipoCopiaTuberculina" maxlength="15" style="width:80px"
                                             immediate="true" value="#{consultarCopiaPAPsicologiaBean.numeroUsuario}"
                                             valueChangeListener="#{consultarCopiaPAPsicologiaBean.setNumeroUsuario}"
                                             binding="#{consultarCopiaPAPsicologiaBean.itNumeroUsuario}"
                                             onkeydown="return blockEnter(event);">
                                    <a4j:support id="supportNumUsuarioCopiaTuberculina" event="onchange"
                                                 ignoreDupResponses="true"
                                                 action="#{consultarCopiaPAPsicologiaBean.changeUsuario}"
                            ...
                            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="2"
                                ...
                                <h:outputText value=" #{consultarCopiaPAPsicologiaBean.nombreUsuario}"
                                              styleClass="buscador"/>
                            </h:panelGrid>
                            <h:outputText value="#{consultarCopiaPAPsicologiaBean.usuario.husetipoiden}"/>
                            <h:outputText value="#{consultarCopiaPAPsicologiaBean.usuario.husanumeiden}"/>
                            <h:panelGroup>
                            ...
                            <h:outputText value="#{consultarCopiaPAPsicologiaBean.usuario.husdfechanacim}"/>
                            <h:outputText value="#{consultarCopiaPAPsicologiaBean.usuario.edad}"/>
                            <h:panelGroup>
                                <h:selectOneMenu id="radioSexoCopiaTuberculina" disabled="true"
                                                 rendered="#{consultarCopiaPAPsicologiaBean.renderInformacionUsuario}"
                                                 value="#{consultarCopiaPAPsicologiaBean.usuario.husesexo}">
                                    <f:selectItems value="#{consultarCopiaPAPsicologiaBean.listSexos}"/>
                                </h:selectOneMenu>
                            </h:panelGroup>
                            <h:panelGroup>
                                <h:selectOneMenu id="radioEstadoCivilCopiaTuberculina" disabled="true"
                                                 rendered="#{consultarCopiaPAPsicologiaBean.renderInformacionUsuario}"
                                                 value="#{consultarCopiaPAPsicologiaBean.usuario.huseestadcivil}">
                                    <f:selectItems value="#{consultarCopiaPAPsicologiaBean.listEstadoCivil}"/>
                                </h:selectOneMenu>
                            </h:panelGroup>
                        </h:panelGrid>
                        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <a4j:commandButton value="Consultar"
                                               action="#{consultarCopiaPAPsicologiaBean.consultarPapsicologicoUsuario}"
     ...
     <s:fieldset legend="Resultados Consulta" id="fieldSetCopiaTuberculina" styleClass="fieldset_dataTable">
        <h:panelGrid columns="1" id="panelGridCopiaTuberculina"
                     rendered="#{empty consultarCopiaPAPsicologiaBean.lstPapsicologicoUsuario}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" 
                    id="tableContentTabsBucarCopiaTuberculina"
                     rendered="#{not empty consultarCopiaPAPsicologiaBean.lstPapsicologicoUsuario}" 
                        styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         value="#{consultarCopiaPAPsicologiaBean.lstPapsicologicoUsuario}" rows="10" styleClass="standard_table"
                         binding="#{consultarCopiaPAPsicologiaBean.dtCopiaCitologia}"
            ...
            <h:column>
              ...
              <h:column>
               ...
               <h:column>
                ...
                <h:outputText value="#{item[7]} #{item[8]} #{item[9]} #{item[10]}"/>
              </h:column>
              
              <h:column>
                <f:facet name="header">
                  <h:outputText value="Generar"/>
                </f:facet>
                <h:commandLink id="generarLectura" action="#{consultarCopiaPAPsicologiaBean.generarCopiaCopiaPAPsicologicos}">
          ...
          <h:outputText value="#{tableScroller}" escape="false"/>
                    ...
                    <h:panelGrid>
                        <h:commandLink action="#{consultarCopiaPAPsicologiaBean.volverConsulta}" immediate="true">
                        ...
                        <h:panelGrid id="panelGridBusUsuaBotCopiaTuberculina" width="100%"
                            ...
                            <h:panelGroup id="panelGroupBusUsuBotCopiaTuberculina">
                                <h:commandButton value="Aceptar Usuario" styleClass="btn btn btn-success"
                                                 action="#{consultarCopiaPAPsicologiaBean.aceptarUsuario}">
        ...
        <f:subview id="generarCopiaTuberculina" rendered="#{consultarCopiaPAPsicologiaBean.generoCopia}">
            <f:verbatim>
