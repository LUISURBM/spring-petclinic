      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridExamenImagenes"
        ...
        <s:fieldset legend="Busqueda de Examenes Imagenes " id="fieldSetBuscadorImagenes" styleClass="fieldset">
          <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridBuscarImagenes"
            ...
            <h:inputText value="#{examImagenFertilidadBean.servicio.csvccodigo}" onkeydown="return blockEnter(event);"/>
            <h:inputText value="#{examImagenFertilidadBean.servicio.csvcnombre}" onkeydown="return blockEnter(event);"/>
            <h:outputText value=""/>
            <h:outputText value="Descripcion 2"/>
            <h:selectOneRadio id="radioOpcion2" onkeydown="return blockEnter(event);"
                              value="#{examImagenFertilidadBean.servicio.csvcopera1}">
              <f:selectItem itemValue="AND" itemLabel="AND"/>
              <f:selectItem itemValue="OR" itemLabel="OR"/>
            </h:selectOneRadio>
            <h:inputText value="#{examImagenFertilidadBean.servicio.csvcnombre2}" onkeydown="return blockEnter(event);"/>
            <h:outputText value=""/>
            <h:outputText value="Descripcion 3"/>
            <h:selectOneRadio id="radioOpcion3" onkeydown="return blockEnter(event);"
                              value="#{examImagenFertilidadBean.servicio.csvcopera2}">
              <f:selectItem itemValue="AND" itemLabel="AND"/>
              <f:selectItem itemValue="OR" itemLabel="OR"/>
            </h:selectOneRadio>
            <h:inputText value="#{examImagenFertilidadBean.servicio.csvcnombre3}" onkeydown="return blockEnter(event);"/>
          </h:panelGrid>
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonConsulta"
            ...
            <t:htmlTag value="br"/>
            <a4j:commandButton value="Buscar" action="#{examImagenFertilidadBean.consultarImagenes}"
        ...
        <s:fieldset legend="Resultados Consulta" id="fieldSetImagenesConsulta" styleClass="fieldset_dataTable">
          <h:panelGrid columns="1" id="panelGridNoImagenes"
                       rendered="#{empty examImagenFertilidadBean.lstExamenesImagenes}">
            <h:outputText value="#{msg.msg_sin_consultar}"/>
          </h:panelGrid>
          <h:panelGrid columns="1" border="0" cellpadding="0"
                       rendered="#{not empty examImagenFertilidadBean.lstExamenesImagenes}" cellspacing="0" width="100%"
                       id="tableContentTabsBucar" styleClass="tabContainer">
            <t:buffer into="#{table}">
              <h:dataTable var="item" border="0" cellpadding="0" cellspacing="0"
                           binding="#{examImagenFertilidadBean.dtServicios}"
                           value="#{examImagenFertilidadBean.lstExamenesImagenes}" rows="10" styleClass="standard_table"
                ...
                <h:column>
                  ...
                  <h:commandLink id="aceptarImagenes" action="#{examImagenFertilidadBean.agregarRemision}">
        ...
        <s:fieldset legend="Lista Examenes Imagenes " id="fieldExamenImagenesLista" styleClass="fieldset">
          <h:panelGrid columns="1" id="panelGridNoImagenesSeleccionados"
                       rendered="#{empty examImagenFertilidadBean.lstRemision}">
            <h:outputText value="#{msg.msg_sin_consultar}"/>
          </h:panelGrid>
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelExamenImagenesTable"
                       styleClass="tabContainer" rendered="#{not empty examImagenFertilidadBean.lstRemision}">
            <t:buffer into="#{table}">
              <h:dataTable var="item" border="0" cellpadding="0" binding="#{examImagenFertilidadBean.dtRemision}"
                           cellspacing="0" value="#{examImagenFertilidadBean.lstRemision}" rows="10"
                ...
                <h:column>
                  ...
                  <h:commandLink id="eliminar" immediate="true" rendered="#{!item.modoconsulta}"
                                 action="#{examImagenFertilidadBean.eliminarRemision}">
        ...
        <a4j:region renderRegionOnly="false">
          <s:fieldset legend="Observaciones " id="fieldObservaciones" styleClass="fieldset"
                      rendered="#{not empty examImagenFertilidadBean.lstRemision}">
            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridObservaciones"
                         styleClass="tabContainer">
              <h:outputText value="Observaciones "/>
              <h:panelGroup>
                <h:inputTextarea id="inputDescripcionRemision" value="#{examImagenFertilidadBean.descripcionRemision}"
                                 style="width:300px"/>
          ...
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonBotonesControl"
            ...
            <a4j:commandButton value="Generar Remision" styleClass="btn btn btn-success"
                               reRender="panelGridExamenImagenesTab" action="#{examImagenFertilidadBean.generarRemision}"/>
          </h:panelGrid>
        </a4j:region>
        <h:panelGrid></h:panelGrid>
      </h:panelGrid>
      <f:subview id="generarExamenImagenes" rendered="#{examImagenFertilidadBean.generoDocPDF}">
        <f:verbatim>
