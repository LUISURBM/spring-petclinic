...
<s:fieldset legend="Criterios de Busqueda Plantillas " id="fieldSetBuscador"
  ...
  <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0"
    ...
    <h:inputText value="#{buscadorPlantillaCirugiaBean.plantilla.hplcnombrplant}" style="width:200px"
                 onkeydown="return blockEnter(event);"/>
                 
    <h:inputText value="#{buscadorPlantillaCirugiaBean.plantilla.hplcdescripcio}"
                 onkeydown="return blockEnter(event);"/>
 </h:panelGrid>
  <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
    ...
    <t:htmlTag value="br"/>
    <a4j:commandButton value="Buscar" action="#{buscadorPlantillaCirugiaBean.consultarPlantillas}"
  ...
  <s:fieldset legend="Lista Plantillas" id="fieldPlantillas" styleClass="fieldset">
        <h:panelGrid columns="1" id="panelGridNoPlantillasSeleccionados" 
             rendered="#{empty buscadorPlantillaCirugiaBean.lstPlantillas}">
            <h:outputText value="#{msg.msg_sin_consultar}"/>
              ...
              rendered="#{not empty buscadorPlantillaCirugiaBean.lstPlantillas}">
                <t:buffer into="#{table}">
                  <h:dataTable var="item" border="0" cellpadding="0" 
                               binding="#{buscadorPlantillaCirugiaBean.dtPlantilla}"  cellspacing="0" 
                               value="#{buscadorPlantillaCirugiaBean.lstPlantillas}" rows="10"
                  ...
                  <f:facet name="header">
                    ...
                    <a4j:commandLink id="aceptarPlantilla" action="#{buscadorPlantillaCirugiaBean.selectPlantilla}" reRender="#{buscadorPlantillaCirugiaBean.tagRenderizar}">
