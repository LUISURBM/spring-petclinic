    ...
    <t:panelTab id="panelTabConducta" label="Conducta " disabled="#{recomedacionUsuarioBean.renderPlantilla}">
      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridConducta" styleClass="tabContainer">
        <s:fieldset legend="Conducta" id="fieldConducta" styleClass="fieldset">
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="" id="panelConductaEntrega" rowClasses="labelText,labelTextInfo ">
           <h:outputText value="Conducta " styleClass="labelTextOblig"/>
                        <h:panelGroup>
                    <h:selectOneMenu id = "mnuConductaEntrega" value = "#{recomedacionUsuarioBean.conducta.hcnccondentr}" required="true">
                    <f:selectItems value = "#{recomedacionUsuarioBean.lstConductaEntrega}"/>
                    </h:selectOneMenu>
                       <a4j:outputPanel ajaxRendered="true">
                      <t:message for="mnuConductaEntrega" styleClass="errorMessage"/>
                    </a4j:outputPanel>
                    </h:panelGroup>
