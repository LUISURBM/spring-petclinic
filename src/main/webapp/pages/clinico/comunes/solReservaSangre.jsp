      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridReservaSangre"
        ...
        <s:fieldset legend="Reserva de Sangre" id="fieldReserva" styleClass="fieldset">
          <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelReservaSangre"
            ...
            <h:panelGroup>
              <h:outputText value="Fecha sugerida de cirug�a"/>
            </h:panelGroup>
            <h:panelGroup/>
            <h:panelGroup>
            <h:panelGrid columns="1">
              <h:selectOneRadio id="mnuCondicionesAlteran" disabled="#{reservaSangreUsuarioBean.modoconsulta}"
                ...
                <a4j:support id="supportCondicionesAl" event="onclick"
                             action="#{reservaSangreUsuarioBean.changeCondicionAl}"
                             reRender="outConMediA">
                  <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                </a4j:support>
              </h:selectOneRadio>
              
              <h:panelGroup id="outConMediA" >
              <h:outputText id="condMediaudo" value="Cual?"  rendered="#{reservaSangreUsuarioBean.renderCondicionAl}"/>
                <h:inputText value="#{reservaSangreUsuarioBean.reserva.hrscconmedaltadesc}" rendered="#{reservaSangreUsuarioBean.renderCondicionAl}"/>
               </h:panelGroup>
              <a4j:outputPanel ajaxRendered="true">
                <t:message for="outConMediA" styleClass="errorMessage"/>
              </a4j:outputPanel>
              </h:panelGrid>
            ...
            <h:outputText value="Via de acceso" styleClass="labelTextOblig"/>
            <h:panelGroup id="outputCualVia">
              <h:outputText value="Cual" styleClass="labelTextOblig"
                            rendered="#{reservaSangreUsuarioBean.mostrarOtraVia}"/>
            </h:panelGroup>
            <h:panelGroup>
             ...
             <h:panelGroup>
            <a4j:region renderRegionOnly="false">
              <h:selectOneRadio id="mnuViaAcceso" onkeydown="return blockEnter(event);"
                                disabled="#{reservaSangreUsuarioBean.modoconsulta}"
                                value="#{reservaSangreUsuarioBean.reserva.hrscviaacceso}"
                                valueChangeListener="#{reservaSangreUsuarioBean.setHrscviaacceso}"
                                styleClass="labelRadio">
                <f:selectItems value="#{reservaSangreUsuarioBean.lstViasAcceso}"/>
                <a4j:support id="supportitComponenteVia" event="onclick" ignoreDupResponses="true"
                             action="#{reservaSangreUsuarioBean.changeViaAcceso}"
                             reRender="outputCualVia,inputCualVia">
                  <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                </a4j:support>
              </h:selectOneRadio>
              </a4j:region>
              <a4j:outputPanel ajaxRendered="true">
                <t:message for="mnuViaAcceso" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
            <h:panelGroup id="inputCualVia">
              <h:inputText id="itCualVia" onkeydown="return blockEnter(event);" maxlength="80" style="width:200px"
                           rendered="#{reservaSangreUsuarioBean.mostrarOtraVia}"
                           disabled="#{reservaSangreUsuarioBean.modoconsulta}"
                           value="#{reservaSangreUsuarioBean.reserva.hrsccualviaacceso}"/>
              <a4j:outputPanel ajaxRendered="true">
                <t:message for="itCualVia" styleClass="errorMessage"/>
              </a4j:outputPanel>
            </h:panelGroup>
          </h:panelGrid>
        </s:fieldset>
