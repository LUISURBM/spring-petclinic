...
<h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridDatosUsuarioTab"
  ...
  <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
    ...
    <t:panelTab id="panelTabDatosUsuario" label="Datos Usuario">
      <s:fieldset legend="Datos Basicos Usuario(a)" id="fieldSetInfoBasica" styleClass="fieldset">
                <h:panelGrid columns="8" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <h:inputText id="itNumeroUsuario" disabled="true" maxlength="12"
                                 ...
                                 onkeydown="return blockEnter(event);"/>
                    <h:outputText value=""/>
                    <h:inputText id="itComoDeseaSerLlamado" disabled="true" maxlength="80" required="true"
                    ...
                    <h:outputText value=""/>
                    <h:inputText id="primerNombre" disabled="true" onkeydown="return blockEnter(event);" maxlength="20"
                                 value="#{datosBasicosUsuarioBean.usuario.huscprimernomb}"></h:inputText>
                    <a4j:outputPanel ajaxRendered="true">
                        <t:message for="primerNombre" styleClass="errorMessage"/>
                    </a4j:outputPanel>
                    <h:inputText id="segundoNombre" disabled="true" onkeydown="return blockEnter(event);"
                                 value="#{datosBasicosUsuarioBean.usuario.huscsegundnomb}" maxlength="20"></h:inputText>
                    <a4j:outputPanel ajaxRendered="true">
                    ...
                    <h:inputText id="primerApellido" disabled="true" onkeydown="return blockEnter(event);" maxlength="20"
                                 value="#{datosBasicosUsuarioBean.usuario.huscprimerapel}"></h:inputText>
                    <a4j:outputPanel ajaxRendered="true">
                    ...
                    <h:inputText id="segundoApellido" disabled="true" onkeydown="return blockEnter(event);" maxlength="20"
                                 value="#{datosBasicosUsuarioBean.usuario.huscsegundapel}"></h:inputText>
                    <a4j:outputPanel ajaxRendered="true">
                    ...
                    <h:selectOneMenu id="radioSexo" disabled="true" onkeydown="return blockEnter(event);"
                                     value="#{datosBasicosUsuarioBean.usuario.husesexo}">
                    ...
                    <h:outputText value=""/>
                    <h:selectOneMenu id="radioEstadoCivil" disabled="true" onkeydown="return blockEnter(event);"
                                     value="#{datosBasicosUsuarioBean.usuario.huseestadcivil}">
                    ...
                    <h:selectOneMenu id="menuPais" disabled="true" onkeydown="return blockEnter(event);"
                    ...
                    <h:selectOneMenu id="menuDepartamentos" disabled="true" onkeydown="return blockEnter(event);"
                    ...
                    <h:selectOneMenu id="menuCiudad" disabled="true" onkeydown="return blockEnter(event);"
                                     value="#{datosBasicosUsuarioBean.usuario.husnciudad}">
                    ...
                    <h:outputText value=""/>
                    <h:selectOneMenu id="radioZona" disabled="true"  onkeydown="return blockEnter(event);"
                                     value="#{datosBasicosUsuarioBean.usuario.husezonareside}">
                        <f:selectItems value="#{datosBasicosUsuarioBean.listzona}"/>
                    </h:selectOneMenu>
                    <a4j:outputPanel ajaxRendered="true">
                        <t:message for="radioZona" styleClass="errorMessage"/>
                    </a4j:outputPanel>
                    <h:inputText id="itBarrio" disabled="true" onkeydown="return blockEnter(event);" maxlength="20"
                                 value="#{datosBasicosUsuarioBean.usuario.huscbarrio}"></h:inputText>
                    <a4j:outputPanel ajaxRendered="true">
                        <t:message for="itBarrio" styleClass="errorMessage"/>
                    </a4j:outputPanel>
                    <h:inputText id="Direccion" disabled="true" maxlength="20" onkeydown="return blockEnter(event);"
                                 value="#{datosBasicosUsuarioBean.usuario.huscdireccion}"></h:inputText>
                    <a4j:outputPanel ajaxRendered="true">
                        <t:message for="Direccion" styleClass="errorMessage"/>
                    </a4j:outputPanel>
                    <h:inputText id="Telefono" disabled="true" maxlength="20" onkeydown="return blockEnter(event);"
                                 value="#{datosBasicosUsuarioBean.usuario.husctelefono}"/>
                    <a4j:outputPanel ajaxRendered="true">
                    ...
                    <h:outputText value=" "/>
                    <h:inputText id="Celular" disabled="true" maxlength="20" onkeydown="return blockEnter(event);" required="true"
                                 value="#{datosBasicosUsuarioBean.usuario.husccelular}"/>
                    <a4j:outputPanel ajaxRendered="true">
                        <t:message for="Celular" styleClass="errorMessage"/>
                    </a4j:outputPanel>
                    <h:inputText id="itCorreo" disabled="true" maxlength="30" onkeydown="return blockEnter(event);"
                                 value="#{datosBasicosUsuarioBean.usuario.husccorreoelec}"/>
                    <a4j:outputPanel ajaxRendered="true">
                        <t:message for="itCorreo" styleClass="errorMessage"/>
                    </a4j:outputPanel>
                    <h:selectOneMenu id="menuAfiliacion" disabled="true" onkeydown="return blockEnter(event);"
                                     value="#{datosBasicosUsuarioBean.usuario.husetipoafilia}">
                    ...
                    <h:panelGroup>
                    <a4j:region renderRegionOnly="false">
                        <h:inputText id="itOcupacion" disabled="true" value="#{datosBasicosUsuarioBean.usuario.husnocupacion}"
                        ...
                        <h:commandLink action="#{datosBasicosUsuarioBean.renderOcupacion}">
                        ...
                        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="2"
                            ...
                            <h:outputText value=" #{datosBasicosUsuarioBean.seleccionOcupacion}" styleClass="buscador"/>
                        </h:panelGrid>
                    </a4j:region>
                    </h:panelGroup>
                    ...
                    <h:panelGroup>
                        <h:selectOneRadio id="mnuViveSolo" onkeydown="return blockEnter(event);" required="true"
                                          value="#{datosBasicosUsuarioBean.usuario.huscvivesolo}" 
                                          rendered="false">
                            <f:selectItems value="#{antecedentesGinecologicosUsuarioBean.lstOpciones}"/>
                        </h:selectOneRadio>
                    </h:panelGroup>
                    <a4j:outputPanel ajaxRendered="true" >
                        <t:message for="mnuViveSolo" styleClass="errorMessage" rendered="#{datosBasicosUsuarioBean.renderViveSola}"/>
                    </a4j:outputPanel>
                    <h:outputText/>
                    <h:outputText/>
                </h:panelGrid>
      ...
      <s:fieldset legend="Datos Acompañante" id="fieldSetInfoBasicaAcompa" styleClass="fieldset">
        <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelRegionInfoAcompa"
          ...
          <h:panelGroup>
          <h:inputText id = "itTelAcom" onkeydown="return blockEnter(event);" 
                        required="true" immediate="true"
                        maxlength="20"
                       value="#{datosBasicosUsuarioBean.usuario.husctelacompana}">
                       <f:validateLength minimum="1" />
                       <a4j:support id="idTelAcom"                         
                             event="onchange"  >
                                <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                            </a4j:support>
            </h:inputText>
    ...
    <s:fieldset legend="Consentimiento Informado" id="fieldConsentimiento" styleClass="fieldset" rendered="true">
      ...
      <a4j:region renderRegionOnly="false">
        ...
        <a4j:outputPanel ajaxRendered="true">
          ...
          <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelLupaConsentimientos"
            ...
            <h:outputText/>
            <a4j:region renderRegionOnly="false">
            <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" id="panelBotonConsulta">
             <a4j:commandLink  immediate="true" title="Seleccionar Concentimiento"
               ...
               <h:inputText id="itConsentimiento" rendered="#{datosBasicosUsuarioBean.renderRealizaConsentimiento}" value="#{datosBasicosUsuarioBean.codigoConsentimiento}"                                      
                                        style="width:50px">
                                <a4j:support id="supportConsentimiento" event="onchange"
                                             action="#{datosBasicosUsuarioBean.agregarConsentimiento}"
      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonModificar"
        ...
        <h:panelGroup>
          <h:commandButton value="Guardar" styleClass="btn btn btn-success"
                           action="#{datosBasicosUsuarioBean.guardarUsuarioPruebasRapidas}">
