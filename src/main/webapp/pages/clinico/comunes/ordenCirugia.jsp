  ...
  <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
    ...
    <t:panelTab id="panelTabOrdenCirugia" label="Cirug�as y procedimientos"
      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridOrdenCirugia"
                   styleClass="tabContainer">
        <s:fieldset legend="Servicios Propuestos " id="fieldServiAdmision" styleClass="fieldset" rendered="#{not empty ordenCirugiaUsuarioBean.cfdetafacturaList}">
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableContentTabsServ"
                       rendered="#{not empty ordenCirugiaUsuarioBean.cfdetafacturaList}">
            <t:buffer into="#{table}">
              <h:dataTable var="itemAdmin" border="0" cellpadding="0" cellspacing="4"
                           binding="#{ordenCirugiaUsuarioBean.tableServiciosAdmision}"
                           value="#{ordenCirugiaUsuarioBean.cfdetafacturaList}" rows="30" styleClass="standard_table"
                ...
                <h:column rendered="#{!ordenCirugiaUsuarioBean.modoconsulta}">
                  ...
                  <h:commandLink id="agregarServiAdm" immediate="true" rendered="#{!itemAdmin.validacionConsultaClinica}"
                                 action="#{ordenCirugiaUsuarioBean.aceptarServicioPropuesto}" >
            ...
            <t:buffer into="#{tableScroller}">
              <h:panelGrid columns="1" rowClasses="labelTextInfo,labelTextInfo">
                <t:dataScroller id="scroll_Admin" for="tdatosServicios" fastStep="10" pageCountVar="pageCount"
        ...
        <s:fieldset legend="Cirujano" id="fieldCirugias" styleClass="fieldset">
          ...
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelViasAcceso"
                       rowClasses="labelText,labelTextInfo">
           <h:outputText value="V�as de acceso"/>
            <h:selectOneMenu id="selectViasAcce"
              value="#{ordenCirugiaUsuarioBean.orden.hoccviaacceso}">
            <f:selectItems value="#{ordenCirugiaUsuarioBean.listViasAcceso}"/>
           </h:selectOneMenu>
          </h:panelGrid>
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="tableFechasCirugia">
          <s:fieldset legend="Fechas Cirugia" id="fieldFechaCirugia" styleClass="fieldset"
            ...
            <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelDatosCirugia"
                ...
                <h:panelGrid columns="3">
                  <h:selectOneRadio id="mnuReserva" immediate="true" required="true"
                    ...
                    <a4j:support id="supportReserva" event="onclick" immediate="true"
                                 ...
                                 reRender="panelOutputUnidades,panelInputUnidades,pgHemocomp,pglblHemocomp">
                      <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                    </a4j:support>
                  </h:selectOneRadio>
                  <a4j:outputPanel ajaxRendered="true">
              ...
              <h:panelGroup id="pgHemocomp">
               <h:selectOneMenu id="mnuHemocomp" immediate="true"
                                   onkeydown="return blockEnter(event);"
                                    rendered="#{ordenCirugiaUsuarioBean.necesitaReserva}"
                                   required="#{ordenCirugiaUsuarioBean.necesitaReserva}"
                                   disabled="#{ordenCirugiaUsuarioBean.modoconsulta}"
                                   value="#{ordenCirugiaUsuarioBean.orden.hocchemocomp}">
                    <f:selectItems value="#{ordenCirugiaUsuarioBean.lsthemocomponentes}"/>
                  </h:selectOneMenu>
                  <a4j:outputPanel ajaxRendered="true">
                  <t:message for="mnuHemocomp" styleClass="errorMessage"/>
                </a4j:outputPanel>
                </h:panelGroup>
