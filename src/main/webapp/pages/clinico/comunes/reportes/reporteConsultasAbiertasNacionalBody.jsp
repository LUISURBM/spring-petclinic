  ...
  <a4j:region id="bodyRegionReporteConsultasAbiertas">
    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridReporteGestacionTab"
      ...
      <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
        ...
        <t:panelTab id="panelTabReporteConsultasAbiertas" label="Reporte Consultas sin Cerrar Nacional ">
          <h:panelGroup>
              <a4j:outputPanel id="ajaxRegionAbiertas" ajaxRendered="true">
                <t:htmlTag value="br"/>
                <t:messages id="msgInfAbiertas" showSummary="false" errorClass="error" globalOnly="true"
            ...
            <s:fieldset legend="Datos Busqueda" id="fieldReporteConsultasAbiertas" styleClass="fieldset">
              <h:panelGrid columns="4" border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                <h:selectOneMenu id ="mnuClinica" required="true"
                    value="#{reporteConsultasAbiertasNacionalBean.wcodclin}">
                <f:selectItems value = "#{reporteConsultasAbiertasNacionalBean.lstClinicas}"/>
                 </h:selectOneMenu>
                ...
                <t:inputCalendar id="fechaInicialReporteConsultasAbiertas" title="Formato: dd/mm/yyyy"
                                 ...
                                 value="#{reporteConsultasAbiertasNacionalBean.fechaInicial}" popupTodayString="Hoy"
                ...
                <t:inputCalendar id="fechaFinalReporteConsultasAbiertas" monthYearRowClass="yearMonthHeader"
                                 ...
                                 value="#{reporteConsultasAbiertasNacionalBean.fechaFinal}" popupTodayString="Hoy"
                                 popupWeekString="Semana" popupButtonString="Fecha" readonly="false" maxlength="11"
                                 size="11" popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                                 renderPopupButtonAsImage="true" align="top" required="true"/>
                <a4j:outputPanel ajaxRendered="true">
     ...
     <s:fieldset legend="Consultas sin cerrar" id="fieldSetInfoReporteConsultasAbiertas" styleClass="fieldset">
            <h:commandLink action="#{reporteConsultasAbiertasNacionalBean.generarReporteConsultasAbiertas}"
                              rendered="#{not empty reporteConsultasAbiertasNacionalBean.lstConsultasAbiertas}" 
                            immediate="true"
        ...
        <h:panelGrid columns="1" id="panelGridInfoReporteConsultasAbiertas" 
                rendered="#{empty reporteConsultasAbiertasNacionalBean.lstConsultasAbiertas}">
          <h:outputText value="#{msg.msg_sin_consultar}"/>
        </h:panelGrid>
         <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" 
                       id="tableContentTabsReporteConsultasAbiertas"
                       rendered="#{not empty reporteConsultasAbiertasNacionalBean.lstConsultasAbiertas}" styleClass="tabContainer">
          <t:buffer into="#{table}">
            <h:dataTable var="item" border="1" cellpadding="0" cellspacing="0"
                         value="#{reporteConsultasAbiertasNacionalBean.lstConsultasAbiertas}" rows="10" styleClass="standard_table"
                         rowClasses="standardTable_Row1,standardTable_Row2" 
                         binding="#{reporteConsultasAbiertasNacionalBean.dtConsultasAbiertas}"
            ...
            <h:panelGroup>
             ...
             <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonReporteConsultasAbiertas" columnClasses="panelGridBotones">
              <h:commandButton value="Generar Reporte" styleClass="boton_fieldset" 
                   action="#{reporteConsultasAbiertasNacionalBean.generarConsultasAbiertas}">
                     <a4j:support event="onclick" status="statusButton"/>
                   </h:commandButton>
            </h:panelGrid>
          </h:panelGrid>
        </t:panelTab>
        <h:commandLink action="#{reporteConsultasAbiertasNacionalBean.volverInicio}" immediate="true">
          <t:graphicImage alt="" border="0" url="/comun/imagenes/volver.gif" align="Volver"/>
        </h:commandLink>
      </t:panelTabbedPane>
    </h:panelGrid>
  </a4j:region>
      <f:subview id="generarReporteConsultasAbiertas" rendered="#{reporteConsultasAbiertasNacionalBean.generoReporte}">
              <f:verbatim>
