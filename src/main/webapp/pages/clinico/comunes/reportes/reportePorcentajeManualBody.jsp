  ...
  <a4j:region id="bodyRegionReportePorcentajeManual">
    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
      ...
      <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0"
        ...
        <t:panelTab id="panelTabReportePorcentajeManual" label="Reporte Porcentaje Sistema">
            ...
            <s:fieldset legend="Reporte Porcentaje Sistema" id="fieldSetInfoReportePorcentajeManual"
              ...
              <h:panelGrid columns="6" border="0" cellpadding="0"
                ...
                <t:inputCalendar id="fechaInicialReporteOportunidad" title="Formato: dd/mm/yyyy"
                                 ...
                                 renderAsPopup="true"
                                 value="#{reportePorcentajeManualBean.fechaInicial}" popupTodayString="Hoy"
                ...
                <t:inputCalendar id="fechaFinalReporteOportunidad" monthYearRowClass="yearMonthHeader"
                                 ...
                                 value="#{reportePorcentajeManualBean.fechaFinal}" popupTodayString="Hoy"
                                 popupWeekString="Semana" popupButtonString="Fecha" readonly="false" maxlength="11"
                                 size="11" popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                                 renderPopupButtonAsImage="true" align="top" required="true"/>
                <a4j:outputPanel ajaxRendered="true">
                ...
                <h:selectOneMenu id = "mnuMedico" value="#{reportePorcentajeManualBean.wcodmed}">
                <f:selectItems value = "#{reportePorcentajeManualBean.listaProfesionalesClinica}"/>
                </h:selectOneMenu>
               <a4j:outputPanel ajaxRendered="true">
                  <t:message for="mnuMedico" styleClass="errorMessage"/>
                </a4j:outputPanel>  
                <h:selectOneMenu id = "mnuSalasEspera" value="#{reportePorcentajeManualBean.numeroSala}">
                <f:selectItems value = "#{reportePorcentajeManualBean.lstSala}"/>
                </h:selectOneMenu>
               <a4j:outputPanel ajaxRendered="true">
                  <t:message for="mnuSalasEspera" styleClass="errorMessage"/>
                </a4j:outputPanel>  
                <h:inputText id ="itServicio" value="#{reportePorcentajeManualBean.wservicio}"/>
                 <a4j:outputPanel ajaxRendered="true">
                ...
                <h:selectOneRadio id="mnuTipoReporteManual" required="true"
                    value = "#{reportePorcentajeManualBean.tipoSelect}">
                <f:selectItems value = "#{reportePorcentajeManualBean.lstTipoReporte}"/>
        ...
        <f:subview id="generarReportePorcentajeManual" rendered="#{reportePorcentajeManualBean.generoReporte}">
        <f:verbatim>
      ...
      <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0"
        ...
        <h:panelGroup>
          <a4j:commandButton value="Generar" styleClass="boton_fieldset" 
                           ...
                           action="#{reportePorcentajeManualBean.generarReporte}">
