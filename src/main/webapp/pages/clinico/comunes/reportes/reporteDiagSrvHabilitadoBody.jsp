...
<a4j:form id="reporteDiagSrvForm">
    ...
    <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
      ...
      <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0"
        ...
        <t:panelTab id="panelTabReporteDiagSrv"
                    label="Reporte Diagnosticos Servicios Habilitados">
          <h:panelGrid id="panelDatosReporteDiagSrv" columns="1"
                       border="0" cellpadding="0" cellspacing="0" width="100%"
                       styleClass="tabContainer">
            <s:fieldset legend="Reporte Diagnosticos Servicios Habilitados"
              ...
              <h:panelGrid columns="6" border="0" cellpadding="0"
                ...
                <t:inputCalendar id="fechaInicialReporte"
                                 ...
                                 renderAsPopup="true"
                                 value="#{reporteDiagnosticoServicioHabilitadoBean.fechaInicial}"
                ...
                <t:inputCalendar id="fechaFinalReporte"
                                 ...
                                 popupDateFormat="dd/MM/yyyy"
                                 renderAsPopup="true"
                                 value="#{reporteDiagnosticoServicioHabilitadoBean.fechaFinal}"
                                 popupTodayString="Hoy" popupWeekString="Semana"
                                 popupButtonString="Fecha" readonly="false"
                                 maxlength="11" size="11"
                                 popupButtonImageUrl="/comun/imagenes/ico_calendario2.gif"
                ...
                <h:selectOneMenu id="mnuClinica" 
                                 ...
                                 value="#{reporteDiagnosticoServicioHabilitadoBean.wcodclin}"
                                 valueChangeListener="#{reporteDiagnosticoServicioHabilitadoBean.setWcodclin}"
                                 binding="#{reporteDiagnosticoServicioHabilitadoBean.mnuCodclin}">
                  <f:selectItems value="#{reporteDiagnosticoServicioHabilitadoBean.lstClinicas}"/>
                  <a4j:support id="supportMnuClinica"
                             action="#{reporteDiagnosticoServicioHabilitadoBean.changeClinica}"
              ...
              <h:panelGroup id="panelMenuContrato">
                <h:selectOneMenu id="mnuTipoContrato" required="true"
                                 value="#{reporteDiagnosticoServicioHabilitadoBean.codcontrato}">
                  <f:selectItems value="#{reporteDiagnosticoServicioHabilitadoBean.lstTipoUsuarios}"/>
                </h:selectOneMenu>
              </h:panelGroup>
      ...
      <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0"
        ...
        <h:panelGroup>
          <h:commandButton value="Generar Reporte"
                           ...
                           action="#{reporteDiagnosticoServicioHabilitadoBean.generarReporte}"></h:commandButton>
        </h:panelGroup>
      </h:panelGrid>
    </h:panelGrid>
    <h:panelGrid>
  ...
  <f:subview id="generarReporteDiagSrv"
             rendered="#{reporteDiagnosticoServicioHabilitadoBean.generoReporte}">
    <f:verbatim>
