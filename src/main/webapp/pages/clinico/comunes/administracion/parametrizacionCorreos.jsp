...
<html>
   <f:view>
    ...
    <script language="javascript" src="<%=request.getContextPath()%>/comun/js/effects.js" type="text/javascript"></script>
         <script language="javascript" src="<%=request.getContextPath()%>/comun/js/validar_archivo.js" type="text/javascript"></script>
...
document.onkeydown=checkKeyCode;
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/clinico/comunes/administracion/parametrizacionCorreosBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>
