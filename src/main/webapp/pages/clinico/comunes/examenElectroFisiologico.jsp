      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridExamenElectrofisiologico" styleClass="tabContainer">
        ...
        <s:fieldset legend=" Busqueda de Examenes Electrofisiologicos " id="fieldSetBuscadorElectrofisiologicos" styleClass="fieldset">
          <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridBuscarElectrofisiologicos" rowClasses="labelText,labelTextInfo">
            ...
            <h:inputText value="#{examElectrofisioUsuarioBean.servicio.csvccodigo}" onkeydown="return blockEnter(event);"/>
            <h:inputText value="#{examElectrofisioUsuarioBean.servicio.csvcnombre}" onkeydown="return blockEnter(event);"/>
            
                <h:outputText value=""/>
    <h:outputText value="Descripcion 2"/>
                 
    <h:selectOneRadio id="radioOpcion2" onkeydown="return blockEnter(event);" value="#{examElectrofisioUsuarioBean.servicio.csvcopera1}" >
      <f:selectItem itemValue="AND" itemLabel="AND"/>
      <f:selectItem itemValue="OR" itemLabel="OR"/>
    </h:selectOneRadio>
    
    <h:inputText value="#{examElectrofisioUsuarioBean.servicio.csvcnombre2}" onkeydown="return blockEnter(event);"/>
    
    <h:outputText value=""/>
    <h:outputText value="Descripcion 3"/>
    
    <h:selectOneRadio id="radioOpcion3" value="#{examElectrofisioUsuarioBean.servicio.csvcopera2}" onkeydown="return blockEnter(event);">
      <f:selectItem itemValue="AND" itemLabel="AND"/>
      <f:selectItem itemValue="OR" itemLabel="OR"/>
    </h:selectOneRadio>
    
    <h:inputText value="#{examElectrofisioUsuarioBean.servicio.csvcnombre3}" onkeydown="return blockEnter(event);"/>
          ...
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonConsulta" columnClasses="columnaBotonesCentrados">
            ...
            <t:htmlTag value="br"/>
            <a4j:commandButton value="Buscar" action="#{examElectrofisioUsuarioBean.consultarElectrofisiologicos}" reRender="fieldSetElectrofisiologicosConsulta" styleClass="btn btn btn-success" id="idButtonContrato"/>
          </h:panelGrid>
        </s:fieldset>
        <s:fieldset legend="Resultados Consulta"  id="fieldSetElectrofisiologicosConsulta" styleClass="fieldset_dataTable">
          <h:panelGrid columns="1" id="panelGridNoElectrofisiologicos" rendered="#{empty examElectrofisioUsuarioBean.lstExamenesElectrofisiologicos}">
            <h:outputText value="#{msg.msg_sin_consultar}"/>
          </h:panelGrid>
          <h:panelGrid columns="1" border="0" cellpadding="0" rendered="#{not empty examElectrofisioUsuarioBean.lstExamenesElectrofisiologicos}" cellspacing="0" width="100%" id="tableContentTabsBucar"
                       styleClass="tabContainer">
            <t:buffer into="#{table}">
              <h:dataTable var="item" border="0" cellpadding="0" cellspacing="0" binding="#{examElectrofisioUsuarioBean.dtServicios}" value="#{examElectrofisioUsuarioBean.lstExamenesElectrofisiologicos}" rows="10"
                ...
                <h:column>
                  ...
                  <h:commandLink id="aceptarElectrofisiologicos" action="#{examElectrofisioUsuarioBean.agregarRemision}">
      ...
      <s:fieldset legend="Lista Examenes Electrofisiologicos " id="fieldExamenElectrofisiologicoLista" styleClass="fieldset">
        ...
        <h:panelGrid columns="1" id="panelGridNoElectrofisiologicosSeleccionados" rendered="#{empty examElectrofisioUsuarioBean.lstRemision}">
            <h:outputText value="#{msg.msg_sin_consultar}"/>
          </h:panelGrid>
              <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelExamenElectrofisiologicoTable" styleClass="tabContainer" rendered="#{not empty examElectrofisioUsuarioBean.lstRemision}">
                <t:buffer into="#{table}">
                  <h:dataTable var="item" border="0" cellpadding="0" binding="#{examElectrofisioUsuarioBean.dtRemision}" cellspacing="0" value="#{examElectrofisioUsuarioBean.lstRemision}"
                    ...
                    <h:column>
                      ...
                      action="#{examElectrofisioUsuarioBean.eliminarRemision}">
        ...
        <a4j:region renderRegionOnly="false">
          <s:fieldset legend="Observaciones " id="fieldObservaciones" styleClass="fieldset" rendered="#{not empty examElectrofisioUsuarioBean.lstRemision}">
            <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridObservaciones" rowClasses="labelText" styleClass="tabContainer">
              ...
              <h:panelGroup>
                <h:inputTextarea id="inputDescripcionRemision" value="#{examElectrofisioUsuarioBean.descripcionRemision}" 
                                 style="width:300px"/>
          ...
          <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonBotonesControl" columnClasses="panelGridBotones">
            <a4j:commandButton value="Generar Remision" styleClass="btn btn btn-success" reRender="panelGridExamenElectrofisiologicoTab" 
                               action="#{examElectrofisioUsuarioBean.generarRemision}"/>
          </h:panelGrid>
        </a4j:region>
        <h:panelGrid></h:panelGrid>
      </h:panelGrid>
        <f:subview id="generarExamenElectrofisiologico"
                       rendered="#{examElectrofisioUsuarioBean.generoDocPDF}">
              <f:verbatim>
