        ...
        <s:fieldset legend="Datos Examen Fisico" id="fieldExamenFisico" styleClass="fieldset">
          <a4j:region renderRegionOnly="false">
            <h:panelGrid columns="3" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelDatosExamen"
              ...
              <h:outputText value="Presión Arterial" styleClass="#{(!examenFisicoUsuarioBean.campoopcional) ? 'labelTextOblig' : ''}" />
              <h:outputText value="Frecuencia Cardiaca" styleClass="#{(!examenFisicoUsuarioBean.campoopcional) ? 'labelTextOblig' : ''}" />
              <h:outputText value="Frecuencia Respiratoria" styleClass="#{(!examenFisicoUsuarioBean.campoopcional) ? 'labelTextOblig' : ''}" />
              <h:panelGroup>
                <h:inputText id="itPresion" title="mm Hg" 
                required ="#{!examenFisicoUsuarioBean.campoopcional}" 
                onkeydown="return blockEnter(event);"
                             value="#{examenFisicoUsuarioBean.presionArterial1}" 
                             style="width:30px" maxlength="3"/>
                <a4j:outputPanel ajaxRendered="true">
                  <t:message for="itPresion" styleClass="errorMessage"/>
                </a4j:outputPanel>
                <h:outputText value="/"/>
                <h:inputText id="itPresion2" title="mm Hg" required ="#{!examenFisicoUsuarioBean.campoopcional}" onkeydown="return blockEnter(event);"
                             value="#{examenFisicoUsuarioBean.presionArterial2}" 
                             style="width:30px" maxlength="3"/>
              ...
              <h:panelGroup>
                <h:inputText id="itRespiratoria" title="respiraciones por minuto" onkeydown="return blockEnter(event);"
                             required ="#{!examenFisicoUsuarioBean.campoopcional}" 
                             value="#{examenFisicoUsuarioBean.examen.hefnfrecresp}" style="width:30px"
                             maxlength="2"/>
              ...
              <h:outputText value="Peso" styleClass="#{(!examenFisicoUsuarioBean.campoopcional) ? 'labelTextOblig' : ''}" />
              <h:outputText value="Talla" styleClass="#{(!examenFisicoUsuarioBean.campoopcional) ? 'labelTextOblig' : ''}" />
              <h:outputText value="IMC" styleClass="#{(!examenFisicoUsuarioBean.campoopcional) ? 'labelTextOblig' : ''}" />
              <a4j:region renderRegionOnly="false">
              <h:panelGroup>
                <h:panelGroup>
                  <h:inputText id="itPeso" required ="#{!examenFisicoUsuarioBean.campoopcional}" onkeydown="return blockEnter(event);"
                               value="#{examenFisicoUsuarioBean.peso}"
                               valueChangeListener="#{examenFisicoUsuarioBean.setPeso}" style="width:40px" maxlength="4"
              ...
              <a4j:region renderRegionOnly="false">
              <h:panelGroup>
                <h:inputText id="itTalla" title="Talla en metros" required ="#{!examenFisicoUsuarioBean.campoopcional}" onkeydown="return blockEnter(event);"
                             value="#{examenFisicoUsuarioBean.talla}"
                             valueChangeListener="#{examenFisicoUsuarioBean.setTalla}" style="width:40px" maxlength="4">
                  <a4j:support id="supportIMC" event="onchange"
                               action="#{examenFisicoUsuarioBean.calcularIMC}" reRender="itIndiceMasaCorporal">
                    <a4j:ajaxListener type="org.ajax4jsf.ajax.ForceRender"/>
                  </a4j:support>
                </h:inputText>
                <a4j:outputPanel ajaxRendered="true">
              ...
              <h:panelGroup id = "panelInputTemperatura">
                <h:inputText id="itTemperaura" onkeydown="return blockEnter(event);"
                             title="Temperatura en grados centígrados"
                             value="#{examenFisicoUsuarioBean.examen.hefatemperatu}" style="width:50px" maxlength="5"/>
                <a4j:outputPanel ajaxRendered="true">
             ...
             <h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelDatosExamenEstadoPacienteAlIngresar"
                         rowClasses="labelText,labelTextInfo">
                         
                          <h:outputText value="Estado del paciente al momento de la consulta" styleClass="#{(!examenFisicoUsuarioBean.campoopcional) ? 'labelTextOblig' : ''}" />
                          <h:outputText/>
                          
                            <h:inputTextarea id="textHallazgos" required ="#{!examenFisicoUsuarioBean.campoopcional}"
                 value="#{examenFisicoUsuarioBean.examen.hefthallazgo}" 
        ...
        <s:fieldset legend="Hallazgos Examen Físico" id="fieldHallazgos" styleClass="fieldset">
           ...
           <a4j:region renderRegionOnly="false">
            <h:panelGrid columns="12">
              ...
              <a4j:commandLink style="font-size:8.0pt; font-weight:bold;" value=" Todos SI" 
                                immediate="true"
                               action="#{examenFisicoUsuarioBean.changeTodosSi}" 
                               reRender="panelHallazgosExamenFisico"/>
              <h:outputText value=" | " style="font-size:8.0pt; font-weight:bold;"/>
              <a4j:commandLink style="font-size:8.0pt; font-weight:bold;" value="Todos SIN ALTERACIONES " immediate="true"
                               action="#{examenFisicoUsuarioBean.changeTodosSinAL}" 
                               reRender="panelHallazgosExamenFisico"/>
              <h:outputText value=" | " style="font-size:8.0pt; font-weight:bold;"/>
              <a4j:commandLink style="font-size:8.0pt; font-weight:bold;" value="Todos NO " immediate="true"
                               action="#{examenFisicoUsuarioBean.changeTodosNo}" 
                               reRender="panelHallazgosExamenFisico"/>
              <h:outputText value=" | " style="font-size:8.0pt; font-weight:bold;"/>
              <a4j:commandLink style="font-size:8.0pt; font-weight:bold;" value="Todos EVALUADO-SIN HALLAZGO " immediate="true"
                               action="#{examenFisicoUsuarioBean.changeTodosEvaluado}" 
                               reRender="panelHallazgosExamenFisico"/>
              <h:outputText value=" | " style="font-size:8.0pt; font-weight:bold;"/>
              <a4j:commandLink style="font-size:8.0pt; font-weight:bold;" value="Ninguno " immediate="true"
                               action="#{examenFisicoUsuarioBean.changeNinguno}" 
                               reRender="panelHallazgosExamenFisico"/>
              <h:outputText value=" ]" style="font-size:8.0pt; font-weight:bold;"/>
            </h:panelGrid>
          </a4j:region>
         ...
         <h:outputText value="  Neuromuscular: "  styleClass="labelTextOblig" />
          <a4j:region renderRegionOnly="false">
            <h:selectOneRadio id="mnuNeuromuscular" required="true" immediate="true" layout="pageDirection"
              ...
              <f:selectItems value="#{examenFisicoUsuarioBean.lstAlteraciones}"/>
              <a4j:support id="supportmnumnuNeuromuscular" 
              action="#{examenFisicoUsuarioBean.changeNeuromuscular}"
