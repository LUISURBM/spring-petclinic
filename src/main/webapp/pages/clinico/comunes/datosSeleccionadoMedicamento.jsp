...
<h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelGridSeleccionMedicamentosTab"
             styleClass="tabContainer">
  <t:panelTabbedPane border="0" cellpadding="0" cellspacing="0" serverSideTabSwitch="false" activePanelTabVar="true"
                     width="100%" id="panelTabbedPaneSeleccionMedicamentos" styleClass="tabbedPane"
                     activeTabStyleClass="activeTab" inactiveTabStyleClass="inactiveTab"
                     disabledTabStyleClass="disabledTab" activeSubStyleClass="activeSub"
                     selectedIndex = "#{datosBasicosUsuarioBean.selectedIndex}"
                     inactiveSubStyleClass="inactiveSub" tabContentStyleClass="tabContent">
    <t:panelTab id="panelTabSeleccionMedicamentos" label="Admision Seleccionada">
      <s:fieldset legend="Medicamentos y/o Vacuna Seleccionada" id="fieldSetInfoBasica" styleClass="fieldset">
                <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%"
                    ...
                    <h:dataTable var="item" border="0" cellpadding="0" cellspacing="0"
                                 binding="#{listaMedicamentosBean.dtLstServicios}"
                                 value="#{listaMedicamentosBean.listaServicios}" styleClass="standard_table"
      ...
      <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0" width="100%" id="panelBotonModificar"
        ...
        <h:panelGroup>
              <h:commandButton value="Siguiente" styleClass="btn btn btn-success"
                           action="#{listaMedicamentosBean.siguienteSeleccion}">
