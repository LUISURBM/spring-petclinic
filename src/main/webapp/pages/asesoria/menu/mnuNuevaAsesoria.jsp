                ...
                <s:accordionPanel id="menuToolsAccordion" layout="accordion" style="border-bottom:White !important;">
                    <t:panelTab label="Registrar Asesoria" id="divToolsAccordionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                            ...
                            <h:commandLink value="Datos Usuario" action="#{mnuNuevaAsesoriaBean.irDatosUsuario}"
                                           immediate="true"/>
                             <h:commandLink value="Registrar Asesoria" action="#{mnuNuevaAsesoriaBean.irRegistrarOtraNuevaAsesoria}"
                                           rendered="#{mnuNuevaAsesoriaBean.renderAsesoria}"
                                           immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
