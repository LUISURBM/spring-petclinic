...
<script  type="text/javascript">
    ...
    function numeroJs() {
       document.forms['body:formAsesoriaHumanitaria'].elements[15].focus(); 
    }
       
    function fechaJs() {
       document.forms['body:formAsesoriaHumanitaria'].elements[21].focus(); 
    }
      ...
      <body><a4j:page id="completePage">
            <tiles:insert definition="layout" flush="false">
               <tiles:put name="body" value="/pages/asesoria/registrarAsesoriaHumanitariaBody.jsp"/>
            </tiles:insert>
         </a4j:page></body>
   </f:view>
</html>