        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
            ...
            <t:div id="toolBarInstrumentos">
                <s:accordionPanel id="menuToolsAccordion" layout="accordion" style="border-bottom:White !important;">
                    <t:panelTab label="Historia Antigenos Covid-19" id="divToolsAccordionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                                     columnClasses="nivelTresBarra">
                            <h:commandLink value="Datos Usuario" action="#{menuAntigenosCovidBean.irDatosUsuarioCovid}"
                                           immediate="true"/>
                           <h:commandLink value="Prueba Antigenos Covid-19" action="#{menuAntigenosCovidBean.irpruebaAntigenosCovid}"
                                           immediate="true"
                                           rendered="#{menuAntigenosCovidBean.renderCovid}"/>
                            <h:commandLink value="Pre - visualizar Consulta"
                                           action="#{menuAntigenosCovidBean.irImprimirCovidAntigenos}" immediate="true"
                                           rendered="#{menuAntigenosCovidBean.renderImprimir}"/>
                        </h:panelGrid>
                    </t:panelTab>
                    <t:panelTab label="Resumen Historia" id="divToolsAccordionResHis">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                                     columnClasses="nivelTresBarra">
                            <h:commandLink value="Historia Total" action="#{menuAntigenosCovidBean.irResumenHistoriaControl}"
                                           immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
