        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
            ...
            <t:div id="toolBarInstrumentos">
                <s:accordionPanel id="menuToolsAccordion" layout="accordion" style="border-bottom:White !important;">
                    <t:panelTab label="Pruebas rapidas" id="divToolsAccordionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                                     columnClasses="nivelTresBarra">
                            <h:commandLink value="Datos Usuario" action="#{menuPruebasRapidasBean.irDatosPruebasRapidas}"
                                           immediate="true"/>
                            <h:commandLink value="Registro de Toma" action="#{menuPruebasRapidasBean.irTomaPruebasRapidas}"
                                           immediate="true" rendered="#{menuPruebasRapidasBean.renderToma}"/>
                              <h:commandLink value="Resultado" action="#{menuPruebasRapidasBean.irCierrePruebasRapidas}"
                                           immediate="true" rendered="#{menuPruebasRapidasBean.renderCerrar}"/>
                        </h:panelGrid>
                    </t:panelTab>
                </s:accordionPanel>
            </t:div>
