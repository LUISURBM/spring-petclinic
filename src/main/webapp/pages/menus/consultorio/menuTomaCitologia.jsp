                ...
                <s:accordionPanel id="menuToolsAccordion" layout="accordion" style="border-bottom:White !important;">
                    <t:panelTab label="Procedimiento en Consultorio" id="divToolsAccordionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                            ...
                            <h:commandLink value="Datos Usuario" action="#{menuTomaCitologiaBean.irDatosCitologia}"
                                           immediate="true"/>
                            <h:commandLink value="Cuestionario Covid"
                                           action="#{menuTomaCitologiaBean.irCuestionarioCovidTomaCitologia}"
                                           immediate="true" rendered="#{menuTomaCitologiaBean.renderCovid}"/>
                            <h:commandLink value="Escala Valoración Caidas"
                                           action="#{menuTomaCitologiaBean.irEscalaValoracionCaidasCitologia}"
                                           immediate="true" rendered="#{menuTomaCitologiaBean.renderEscalaCaidas}"/>
                            <h:commandLink value="Toma Citologia" action="#{menuTomaCitologiaBean.irTomaCitologia}"
                                           immediate="true" rendered="#{menuTomaCitologiaBean.renderToma}"/>
                        </h:panelGrid>
                    </t:panelTab>
                </s:accordionPanel>
            </t:div>
