        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
            ...
            <t:div id="toolBarInstrumentos">
                <s:accordionPanel id="menuToolsAccordion" layout="accordion" style="border-bottom:White !important;">
                    <t:panelTab label="Informe Citopunción" id="divToolsAccordionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                                     columnClasses="nivelTresBarra">
                            <h:commandLink value="Datos Usuario" action="#{menuInformeCitopuncionBean.irDatosCitopuncion}"
                                           immediate="true"/>         
                            <h:commandLink value="Informe Citopunción" action="#{menuInformeCitopuncionBean.irInformeCitopuncion}"
                            rendered="#{menuInformeCitopuncionBean.renderInforme}" immediate="true"/>      
                                                                       
                            <h:commandLink value="Pre - visualizar informe" action="#{menuInformeCitopuncionBean.irCerrarCitopuncion}"
                            rendered="#{menuInformeCitopuncionBean.renderCerrar}" immediate="true"/>     
                    ...
                    <t:panelTab label="Resumen Historia" id="divToolsAccordionResHis">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                               ...
                               <h:commandLink value="Historia Total"
                                           action="#{menuInformeCitopuncionBean.irResumenHistoriaCitopuncion}"
                                           immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
                    <t:panelTab label="Pausar Consulta" id="divToolsAccordionPausarCon">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                             ...
                             <h:commandLink value="Pausar Consulta"
                                   action="#{menuInformeCitopuncionBean.irPausarConsultaCitopuncion}"
                                   rendered="#{menuInformeCitopuncionBean.renderPausarConsulta}" immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
                </s:accordionPanel>
            </t:div>
