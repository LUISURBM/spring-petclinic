...
<h:panelGrid columns="2" border="0" cellpadding="0" cellspacing="0" id="tableTools"
    ...
    <t:div id="sideBarContents">
        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
            ...
            <t:div id="toolBarMnuConfirmacion">
                <s:accordionPanel id="menuToolsConfirmacion" layout="accordion"
                                  style="border-bottom:White !important;">
                    <t:panelTab label="Confirmación Prestación" id="divToolsConfirmacionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                                     columnClasses="nivelTresBarra">
                            <h:commandLink value="Confirmacion de Prestación"
                                           action="#{menuHistoriaConfirmacionBean.irConfirmacionServicio}"
                                           immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
                    <t:panelTab label="Pausar Consulta" id="divToolsAccordionPausarCon">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                             ...
                             <h:commandLink value="Pausar Consulta"
                                   action="#{menuHistoriaConfirmacionBean.irPausarConsultaConfirmacion}"
                                   rendered="#{menuHistoriaConfirmacionBean.renderPausarConsulta}" immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
                </s:accordionPanel>
            </t:div>
