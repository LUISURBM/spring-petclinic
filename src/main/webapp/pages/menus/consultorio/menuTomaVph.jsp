                ...
                <s:accordionPanel id="menuToolsAccordion" layout="accordion" style="border-bottom:White !important;">
                    <t:panelTab label="Procedimiento en Consultorio" id="divToolsAccordionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                            ...
                            <h:commandLink value="Datos Usuario" action="#{menuTomaVphBean.irDatosVph}"
                                           immediate="true"/>    
                                           <h:commandLink value="Cuestionario Covid"
                                           action="#{menuTomaVphBean.irCuestionarioCovidVph}" immediate="true"
                                            rendered="#{menuTomaVphBean.renderCovid}"/>
                            <h:commandLink value="Toma Citologia" action="#{menuTomaVphBean.irTomaVph}"
                                           immediate="true"   rendered="#{menuTomaVphBean.renderToma}"/>
                        </h:panelGrid>
                    </t:panelTab>
                </s:accordionPanel>
            </t:div>
