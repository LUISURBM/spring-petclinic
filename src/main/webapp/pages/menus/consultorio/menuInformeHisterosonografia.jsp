        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
            ...
            <t:div id="toolBarInstrumentos">
                <s:accordionPanel id="menuToolsAccordion" layout="accordion" style="border-bottom:White !important;">
                    <t:panelTab label="Informe Histerosonografia" id="divToolsAccordionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                            ...
                            <h:commandLink value="Datos Usuario"
                                           action="#{menuInformeHisterosonografiaBean.irDatosHisterosonografia}"
                                           immediate="true"/>
                            <h:commandLink value="Cuestionario Covid"
                                           action="#{menuInformeHisterosonografiaBean.irCuestionarioCovidHisterosonografia}" immediate="true"
                                            rendered="#{menuInformeHisterosonografiaBean.renderCovid}"/>
                            <h:commandLink value="Informe Histerosonografia"
                                           action="#{menuInformeHisterosonografiaBean.irInformeHisterosonografia}"
                                           rendered="#{menuInformeHisterosonografiaBean.renderInforme}"
                                           immediate="true"/>
                            <h:commandLink value="Pre - visualizar informe"
                                           action="#{menuInformeHisterosonografiaBean.irCerrarHisterosonografia}"
                                           rendered="#{menuInformeHisterosonografiaBean.renderCerrar}"
                                           immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
                    <t:panelTab label="Resumen Historia" id="divToolsAccordionResHis">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                                ...
                                <h:commandLink value="Historia Total"
                                           action="#{menuInformeHisterosonografiaBean.irResumenHistoriaHisterosonografia}"
                                           immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
                    <t:panelTab label="Pausar Consulta" id="divToolsAccordionPausarCon">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                             ...
                             <h:commandLink value="Pausar Consulta"
                                   action="#{menuInformeHisterosonografiaBean.irPausarConsultaHisterosonografia}"
                                   rendered="#{menuInformeHisterosonografiaBean.renderPausarConsulta}" immediate="true"/>
                        </h:panelGrid>
                    </t:panelTab>
                </s:accordionPanel>
            </t:div>
