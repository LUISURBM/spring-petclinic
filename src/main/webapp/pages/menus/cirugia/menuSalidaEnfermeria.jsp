        ...
        <h:panelGrid columns="1" border="0" cellpadding="0" cellspacing="0"
            ...
            <t:div id="toolBarInstrumentos">
                <s:accordionPanel id="menuToolsAccordion" layout="accordion" style="border-bottom:White !important;">
                    <t:panelTab label="Dar de Alta (Enfermeria)" style="font-size:17px;" id="divToolsAccordionDir">
                        <h:panelGrid width="100%" cellpadding="0" cellspacing="0" border="0" columns="1"
                                     ...
                                     action="#{menuEnfermeriaBean.registrarNotasEnfermeria}"
                                           immediate="true" style="font-size:17px;"/>      
                                           
                            
                                           
                            <h:commandLink value="Volver Listado Enfermeria" action="#{menuEnfermeriaBean.volverListadoEnfermeria}"
                                           immediate="true" style="font-size:17px;"/> 
